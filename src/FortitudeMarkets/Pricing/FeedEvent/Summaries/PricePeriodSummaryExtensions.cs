...
public static class PricePeriodSummaryExtensions
{
    ...
    {
        if (pricePeriodSummary.PeriodStartTime.Equals(DateTime.MinValue)
         || pricePeriodSummary.PeriodEndTime < pricePeriodSummary.PeriodStartTime)
            return TimeBoundaryPeriod.Tick;
        if (pricePeriodSummary.PeriodEndTime.Equals(DateTime.MinValue)) return TimeBoundaryPeriod.Tick;
