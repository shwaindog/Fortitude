...
public class QuoteWrappingPricePeriodSummary : ReusableObject<IPricePeriodSummary>, IPricePeriodSummary, ICloneable<QuoteWrappingPricePeriodSummary>
{
    ...
    public QuoteWrappingPricePeriodSummary(IPublishableLevel1Quote level1Quote) => this.level1Quote = level1Quote;
    ...
    public IPricePeriodSummary CopyFrom(IPublishableLevel1Quote source, CopyMergeFlags copyMergeFlags = CopyMergeFlags.Default)
    {
        level1Quote = source;
        return this;
    }
    ...
    public static IPricePeriodSummary Wrap(IPublishableLevel1Quote level1Quote, IRecycler? recycler = null) =>
...
{
    public static QuoteWrappingPricePeriodSummary ToSummary(this IPublishableLevel1Quote level1Quote) => new(level1Quote);
}
