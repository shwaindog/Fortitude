...
{
    public PyramidMidPriceGenerator
    (decimal startPrice, DateTime startTime, decimal deltaPrice, TimeSpan riseTimeSpan, TimeSpan fallTimeSpan, TimeSpan runTimeSpan,
