...
public static class QuoteExtensionMethods
{
    ...
    public static string DiffQuotes(this IPublishableTickInstant? ti1, IPublishableTickInstant? ti2, bool exactValues = false)
    {
        ...
        var l1q1 = ti1 as IPublishableLevel1Quote;
        var l1q2 = ti2 as IPublishableLevel1Quote;
        ...
        else if (l1q1 != null) //no need for && l2q2 != null
        {
            ...
            sb.AddIfDifferent(l1q1, l1q2, q => q.ConflatedTicksCandle!);
            sb.AddIfDifferent(l1q1, l1q2, q => q.IsAskPriceTopChanged!);
            sb.AddIfDifferent(l1q1, l1q2, q => q.IsBidPriceTopChanged!);
        }

        var l2q1 = ti1 as IPublishableLevel2Quote;
        var l2q2 = ti2 as IPublishableLevel2Quote;
        ...
        var l3q1 = ti1 as IPublishableLevel3Quote;
        var l3q2 = ti2 as IPublishableLevel3Quote;
    ...
    private static StringBuilder AddIfDifferent<T>
        (this StringBuilder sb, T q1, T q2, Expression<Func<T, string>> property, bool makeThisCheck = true) where T : IPublishableTickInstant
    {
    ...
    private static StringBuilder AddIfDifferent<T>
        (this StringBuilder sb, T? q1, T? q2, Expression<Func<T, DateTime>> property, bool makeThisCheck = true) where T : IPublishableTickInstant
    {
        var       evaluator = property.Compile();
    ...
    private static StringBuilder AddIfDifferent<T>
        (this StringBuilder sb, T? q1, T? q2, Expression<Func<T, decimal>> property, bool makeThisCheck = true) where T : IPublishableTickInstant
    {
        var      evaluator = property.Compile();
    ...
    private static StringBuilder AddIfDifferent<T>
        (this StringBuilder sb, T? q1, T? q2, Expression<Func<T, bool>> property, bool makeThisCheck = true) where T : IPublishableTickInstant
    {
        var   evaluator = property.Compile();
    ...
    private static StringBuilder AddIfDifferent<T>
        (this StringBuilder sb, T? q1, T? q2, Expression<Func<T, ICandle>> property, bool exactValue = false)
        where T : IPublishableTickInstant
    {
        var evaluator    = property.Compile();
        var q1Value      = q1 != null ? evaluator(q1) : null;
    ...
    private static StringBuilder AddIfDifferent
        (this StringBuilder sb, IPublishableLevel3Quote? q1, IPublishableLevel3Quote? q2, Expression<Func<IPublishableLevel3Quote, uint>> property)
    {
        var   evaluator = property.Compile();
