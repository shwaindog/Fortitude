...
public enum QuoteFieldUpdatedFlags : uint
{
  ...
  , SourceSentSub2MinUpdatedFlag    = 0x00_00_08
  , SourceAskTimeDateUpdatedFlag    = 0x00_00_10
  , SourceAskTimeSub2MinUpdatedFlag = 0x00_00_20
  , SourceBidTimeDateUpdatedFlag    = 0x00_00_40
  , SourceBidTimeSub2MinUpdatedFlag = 0x00_00_80
  , ValidFromDateUpdatedFlag        = 0x00_01_00
  , ValidFromTimeSub2MinUpdatedFlag = 0x00_02_00
  , ValidToDateUpdatedFlag          = 0x00_04_00
  , ValidToSub2MinUpdatedFlag       = 0x00_08_00
...
public enum PublishableQuoteFieldUpdatedFlags : uint
{
  ...
  , SocketReceivedSub2MinUpdatedFlag      = 0x00_04
  , ProcessedDateUpdatedFlag              = 0x00_08
  , ProcessedSub2MinUpdatedFlag           = 0x00_10
  , DispatchedDateUpdatedFlag             = 0x00_20
  , DispatchedSub2MinUpdatedFlag          = 0x00_40
  , ClientReceivedDateUpdatedFlag         = 0x00_80
  , ClientReceivedSub2MinUpdatedFlag      = 0x01_00
  , AdapterReceivedTimeDateUpdatedFlag    = 0x02_00
  , AdapterReceivedTimeSub2MinUpdatedFlag = 0x04_00
  , AdapterSentTimeDateUpdatedFlag        = 0x08_00
  , AdapterSentTimeSub2MinUpdatedFlag     = 0x10_00
}
