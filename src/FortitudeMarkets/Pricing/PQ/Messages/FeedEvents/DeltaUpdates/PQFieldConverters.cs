...
public static class PQFieldConverters
{
    ...
    public static void UpdateSub2MinComponent(ref DateTime updateSub2Min, long nanoSeconds)
    {
        updateSub2Min = updateSub2Min.AddTicks(nanoSeconds / DateTimeTicksToNanoSeconds - updateSub2Min.Ticks % TicksIn2Mins);
    }
