  ...
  , IDoublyLinkedListNode<PQPublishableLevel1Quote>
{
    ...
    public override string QuoteToStringMembers =>
        ...
        $"{nameof(AdapterReceivedTime)}: {AdapterReceivedTime}, {nameof(SummaryPeriod)}: {SummaryPeriod}";
    ...
    {
        get => (UpdatedFlags & PublishableQuoteFieldUpdatedFlags.AdapterSentTimeSubHourUpdatedFlag) > 0;
        set
        {
            if (value)
                UpdatedFlags |= PublishableQuoteFieldUpdatedFlags.AdapterSentTimeSubHourUpdatedFlag;

            else if (IsAdapterSentTimeSub2MinUpdated) UpdatedFlags ^= PublishableQuoteFieldUpdatedFlags.AdapterSentTimeSubHourUpdatedFlag;
        }
    }
    ...
    {
        get => (UpdatedFlags & PublishableQuoteFieldUpdatedFlags.AdapterReceivedTimeSubHourUpdatedFlag) > 0;
        set
        {
            if (value)
                UpdatedFlags |= PublishableQuoteFieldUpdatedFlags.AdapterReceivedTimeSubHourUpdatedFlag;

            else if (IsAdapterReceivedTimeSub2MinUpdated) UpdatedFlags ^= PublishableQuoteFieldUpdatedFlags.AdapterReceivedTimeSubHourUpdatedFlag;
        }
    }
    ...
    [JsonIgnore] IPricePeriodSummary? IPublishableLevel1Quote.SummaryPeriod => SummaryPeriod;

    [JsonIgnore]
    IMutablePricePeriodSummary? IMutablePublishableLevel1Quote.SummaryPeriod
    {
        get => SummaryPeriod;
    ...
    public override bool HasUpdates
    {
        get => base.HasUpdates || (SummaryPeriod?.HasUpdates ?? false) || PQQuoteContainer.HasUpdates;
        set
        {
    ...
    public override bool AreEquivalent(IPublishableTickInstant? other, bool exactTypes = false)
    {
        ...
        var allAreSame = baseSame && adapterSentSame && adapterReceivedSame && periodSummarySame;
        return allAreSame;
    }
