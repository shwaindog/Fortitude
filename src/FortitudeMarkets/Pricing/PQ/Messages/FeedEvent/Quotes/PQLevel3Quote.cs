...
public interface IPQPublishableLevel3Quote : IPQPublishableLevel2Quote, IMutablePublishableLevel3Quote, IPQLevel3Quote, IDoublyLinkedListNode<IPQPublishableLevel3Quote>
{
    new IPQRecentlyTraded? RecentlyTraded { get; set; }
...
public class PQLevel3Quote : PQLevel2Quote, IPQLevel3Quote, ICloneable<PQLevel3Quote>
{
    ...
    public PQLevel3Quote(ISourceTickerInfo sourceTickerInfo, DateTime? sourceTime = null, bool isReplay = false
      , decimal singlePrice = 0m, DateTime? sourceBidTime = null , bool isBidPriceTopChanged = false, DateTime? sourceAskTime = null, DateTime? validFrom = null
    ...
    public override PQLevel3Quote Clone() =>
        Recycler?.Borrow<PQLevel3Quote>().CopyFrom(this, CopyMergeFlags.FullReplace) ?? new PQLevel3Quote(this);
    ...
    public override int UpdateField(PQFieldUpdate pqFieldUpdate)
    {
        ...
        if (recentlyTraded != null
         && pqFieldUpdate.Id is >= PQQuoteFields.LastTradedTickTrades and <= PQQuoteFields.LastTradedRecently)
...
public class PQPublishableLevel3Quote : PQPublishableLevel2Quote, IPQPublishableLevel3Quote, ICloneable<PQPublishableLevel3Quote>, IDoublyLinkedListNode<PQPublishableLevel3Quote>
{
    ...
    public PQPublishableLevel3Quote(ISourceTickerInfo sourceTickerInfo, DateTime? sourceTime = null, bool isReplay = false, FeedSyncStatus feedSyncStatus = FeedSyncStatus.Good
      ...
      , IOrderBook? orderBook = null, IRecentlyTraded? recentlyTraded = null, uint batchId = 0u, uint sourceQuoteRef = 0u, DateTime? valueDate = null)
        : this(new PQLevel3Quote(sourceTickerInfo, sourceTime, isReplay, singlePrice, sourceBidTime, isBidPriceTopChanged, 
                                 sourceAskTime, validFrom, validTo, isAskPriceTopChanged, executable, orderBook, recentlyTraded, batchId, sourceQuoteRef, valueDate),
               sourceTickerInfo, feedSyncStatus, clientReceivedTime, adapterReceivedTime, adapterSentTime, periodSummary)
    {
    }

    protected PQPublishableLevel3Quote(IPQTickInstant? initializedQuoteContainer, ISourceTickerInfo sourceTickerInfo
    ...
    public override PQPublishableLevel3Quote Clone() =>
        Recycler?.Borrow<PQPublishableLevel3Quote>().CopyFrom(this, CopyMergeFlags.FullReplace) ?? new PQPublishableLevel3Quote(this, PQQuoteContainer.Clone());
    ...
    IPQPublishableLevel3Quote IPQPublishableLevel3Quote.CopyFrom(IPublishableTickInstant source, CopyMergeFlags copyMergeFlags) => CopyFrom(source, copyMergeFlags);
