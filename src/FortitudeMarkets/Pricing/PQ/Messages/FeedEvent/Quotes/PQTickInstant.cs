...
public class PQTickInstant : ReusableObject<ITickInstant>, IPQTickInstant, ICloneable<IPQTickInstant>
{
        ...
        IPQPriceVolumePublicationPrecisionSettings? quotePublicationPrecisionSettings = null)
    {
        ...
        if (!updatedOnly || IsSingleValueUpdated)
            yield return new PQFieldUpdate(PQQuoteFields.SingleTickValue, SingleTickValue, quotePublicationPrecisionSettings?.PriceScalingPrecision ?? PriceScalingPrecision);
  ...
  , IDoublyLinkedListNode<PQPublishableTickInstant>
{
    ...
    {
        get => (UpdatedFlags & PublishableQuoteFieldUpdatedFlags.SocketReceivedSubHourUpdatedFlag) > 0;
        set
        {
            if (value)
                UpdatedFlags |= PublishableQuoteFieldUpdatedFlags.SocketReceivedSubHourUpdatedFlag;

            else if (IsSocketReceivedTimeSub2MinUpdated) UpdatedFlags ^= PublishableQuoteFieldUpdatedFlags.SocketReceivedSubHourUpdatedFlag;
        }
    }
    ...
    {
        get => (UpdatedFlags & PublishableQuoteFieldUpdatedFlags.ProcessedSubHourUpdatedFlag) > 0;
        set
        {
            if (value)
                UpdatedFlags |= PublishableQuoteFieldUpdatedFlags.ProcessedSubHourUpdatedFlag;

            else if (IsProcessedTimeSub2MinUpdated) UpdatedFlags ^= PublishableQuoteFieldUpdatedFlags.ProcessedSubHourUpdatedFlag;
        }
    }
    ...
    {
        get => (UpdatedFlags & PublishableQuoteFieldUpdatedFlags.DispatchedSubHourUpdatedFlag) > 0;
        set
        {
            if (value)
                UpdatedFlags |= PublishableQuoteFieldUpdatedFlags.DispatchedSubHourUpdatedFlag;

            else if (IsDispatchedTimeSub2MinUpdated) UpdatedFlags ^= PublishableQuoteFieldUpdatedFlags.DispatchedSubHourUpdatedFlag;
        }
    }
    ...
    {
        get => (UpdatedFlags & PublishableQuoteFieldUpdatedFlags.ClientReceivedSubHourUpdatedFlag) > 0;
        set
        {
            if (value)
                UpdatedFlags |= PublishableQuoteFieldUpdatedFlags.ClientReceivedSubHourUpdatedFlag;

            else if (IsClientReceivedTimeSub2MinUpdated) UpdatedFlags ^= PublishableQuoteFieldUpdatedFlags.ClientReceivedSubHourUpdatedFlag;
        }
    }
