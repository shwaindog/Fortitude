...
public class PQAnonymousOrderLayerInfo : ReusableObject<IAnonymousOrderLayerInfo>, IPQAnonymousOrderLayerInfo
{
    ...
    {
        get => (UpdatedFlags & OrderLayerInfoUpdatedFlags.CreatedTimeSubHourFlag) > 0;
        set
        {
            if (value)
                UpdatedFlags |= OrderLayerInfoUpdatedFlags.CreatedTimeSubHourFlag;

            else if (IsCreatedTimeSub2MinUpdated) UpdatedFlags ^= OrderLayerInfoUpdatedFlags.CreatedTimeSubHourFlag;
        }
    }
    ...
    {
        get => (UpdatedFlags & OrderLayerInfoUpdatedFlags.UpdatedTimeSubHourFlag) > 0;
        set
        {
            if (value)
                UpdatedFlags |= OrderLayerInfoUpdatedFlags.UpdatedTimeSubHourFlag;

            else if (IsUpdatedTimeSub2MinUpdated) UpdatedFlags ^= OrderLayerInfoUpdatedFlags.UpdatedTimeSubHourFlag;
        }
    }
