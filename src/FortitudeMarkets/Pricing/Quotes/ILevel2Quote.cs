...
{
    IOrderBookSide BidBookSide { get; }

    bool IsBidBookChanged { get; }

    IOrderBookSide AskBookSide { get; }
...
{
    new IMutableOrderBookSide BidBookSide { get; set; }
    new IMutableOrderBookSide AskBookSide { get; set; }
