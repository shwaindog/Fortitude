...
public interface ISourceTickersConfig : IInterfacesComparable<ISourceTickersConfig>
{
    ...
    const LayerFlags       DefaultLayerFlagsValue       = SourceTickerInfo.PriceVolumeFlags;
    ...
    IEnumerable<ISourceTickerInfo> PricingEnabledSourceTickerInfos(ushort sourceId, string sourceName, CountryCityCodes myLocation, bool isPricePublisher);
    IEnumerable<ISourceTickerInfo> TradingEnabledSourceTickerInfos(ushort sourceId, string sourceName, CountryCityCodes myLocation, bool isPricePublisher);
}
...
public class SourceTickersConfig : ConfigSection, ISourceTickersConfig
{
    ...
    public IEnumerable<ISourceTickerInfo> PricingEnabledSourceTickerInfos(ushort sourceId, string sourceName, CountryCityCodes myLocation, bool isAdapter)
    {
        foreach (var tickerConfig in Tickers.Values)
    ...
    public IEnumerable<ISourceTickerInfo> TradingEnabledSourceTickerInfos(ushort sourceId, string sourceName, CountryCityCodes myLocation, bool isAdapter)
    {
        foreach (var tickerConfig in Tickers.Values)
