...
public class MarketConnectionConfig : ConfigSection, IMarketConnectionConfig
{
    ...
    (ushort sourceId, string sourceName, MarketConnectionType marketConnectionType, CountryCityCodes myLocation, ISourceTickersConfig sourceTickersConfig
    ...
    {
        get => Enum.Parse<CountryCityCodes>(this[nameof(MyLocation)]!);
    ...
    public IPricingServerConfig? PricingServerConfig
    {
        get
        {
            if (GetSection(nameof(PricingServerConfig)).GetChildren().Any())
                return new PricingServerConfig(ConfigRoot, Path + ":" + nameof(PricingServerConfig));
            return null;
        }
        set =>
            _ = value != null
    ...
    public ITradingServerConfig? TradingServerConfig
    {
        get
        {
            if (GetSection(nameof(TradingServerConfig)).GetChildren().Any())
                return new TradingServerConfig(ConfigRoot, Path + ":" + nameof(TradingServerConfig));
            return null;
        }
        set
        {
    ...
    public IEnumerable<ISourceTickerInfo> AllSourceTickerInfos =>
        SourceTickerConfig?.AllSourceTickerInfos(SourceId, SourceName, MyLocation, PricingServerConfig!.IsPricePublisher) ?? [];
    ...
    public ISourceTickerInfo? GetSourceTickerInfo(string ticker) => SourceTickerConfig?.GetSourceTickerInfo(SourceId, SourceName, ticker, MyLocation
