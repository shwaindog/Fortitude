...
namespace FortitudeMarketsCore.Trading.ORX.Executions
{
    public sealed class OrxExecutionUpdate : OrxTradingMessage, IExecutionUpdate
    {
        ...
        public OrxExecutionUpdate(OrxExecution execution, ExecutionUpdateType executionUpdateType, DateTime socketReceivedTime,
        ...
        public OrxExecution Execution { get; set; }
        ...
        public IExecutionUpdate Clone()
        {
            return new OrxExecutionUpdate(this);
        }
    }
}
