...
namespace FortitudeMarketsCore.Trading.ORX.Orders.Products.General
{
    public class OrxSpotOrder : OrxProductOrder, ISpotOrder
    {
        ...
        {
            Type = toClone.Type;
            QuoteInformation = toClone.QuoteInformation != null 
                ? new OrxVenuePriceQuoteId(toClone.QuoteInformation)
                : null;
            Side = toClone.Side;
        ...
        [OrxOptionalField(22)]
        public OrxVenuePriceQuoteId QuoteInformation { get; set; }

        IVenuePriceQuoteId ISpotOrder.QuoteInformation
        {
            get => QuoteInformation;
            set => QuoteInformation = (OrxVenuePriceQuoteId)value;
        }
        ...
        public override OrxProductOrder GetPooledInstance(IRecycler recycler)
        {
            return recycler.Borrow<OrxSpotOrder>();
        }
