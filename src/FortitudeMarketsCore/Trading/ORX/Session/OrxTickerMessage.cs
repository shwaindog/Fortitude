...
namespace FortitudeMarketsCore.Trading.ORX.Session
{
    public sealed class OrxTickerMessage : OrxTradingMessage
    {
        ...
        [OrxMandatoryField(15)]
        public long MaximumSize { get; set; }
        [OrxMandatoryField(16)]
        public decimal PriceIncrement { get; set; }
        [OrxMandatoryField(17)]
        public uint Mql { get; set; }
        [OrxMandatoryField(18)]
        ...
        {
            return obj is OrxTickerMessage m && m.Exchange == Exchange && m.Ticker == Ticker;
        }
