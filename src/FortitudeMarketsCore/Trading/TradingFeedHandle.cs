...
namespace FortitudeMarketsCore.Trading
{
    public class TradingFeedHandle : ITradingFeed
    {
        ...
        private IOrder lastReceivedOrder;
        ...
        public IOrder LastReceivedOrder => lastReceivedOrder;
        ...
        public void AmendOrderRequest(IOrder order, IOrderAmend amendOrderRequest)
        {
            ...
            OnOrderAmendResponse(new OrxOrderAmendResponse((OrxOrder)order, OrderUpdateEventType.OrderAmended, TimeContext.UtcNow, AmendType.Amended, null));
