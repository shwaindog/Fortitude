...
namespace FortitudeMarketsCore.Pricing.Quotes
{
    public class Level3PriceQuote : Level2PriceQuote, IMutableLevel3Quote
    {
        ...
        {
            return new Level3PriceQuote(this);
        }
        ...
        public override bool AreEquivalent(ILevel0Quote other, bool exactTypes = false)
        {
            ...
            var lastTradesSame = exactTypes ? Equals(RecentlyTraded, otherL3.RecentlyTraded)
        ...
        {
            return ReferenceEquals(this, obj) || AreEquivalent((ILevel0Quote) obj, exactTypes: true);
        }
        ...
        {
            return $"Level3PriceQuote{{{nameof(SourceTickerQuoteInfo)}: {SourceTickerQuoteInfo}, " +
