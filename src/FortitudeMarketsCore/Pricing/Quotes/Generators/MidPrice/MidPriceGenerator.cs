...
public interface IMidPriceGenerator
{
    ...
    IEnumerable<PreviousCurrentMidPriceTime> PreviousCurrentPrices(DateTime startFromTime, TimeSpan incrementTime, int numToGenerate
...
public abstract class MidPriceGenerator : IMidPriceGenerator
{
    ...
    public IEnumerable<PreviousCurrentMidPriceTime> PreviousCurrentPrices(DateTime startFromTime, TimeSpan incrementTime, int numToGenerate
      , int startSequenceNumber = 0)
    {
