...
namespace FortitudeMarketsCore.Pricing.LastTraded
{
    public class LastPaidGivenTrade : LastTrade, IMutableLastPaidGivenTrade
    {
        ...
        {
            return new LastPaidGivenTrade(this);
        }
        ...
        {
            return ReferenceEquals(this, obj) || AreEquivalent(obj as ILastPaidGivenTrade, true);
        }
        ...
        {
            return $"LastPaidGivenTrade {{ {nameof(TradePrice)}: {TradePrice:N5}, {nameof(TradeTime)}: " +
