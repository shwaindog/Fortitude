...
namespace FortitudeMarketsCore.Pricing.PQ.LayeredBook
{
        ...
        IPQSourceQuoteRefTraderValueDatePriceVolumeLayer
    {
            ...
            : base(toClone)
        {
            ...
            if (toClone is IValueDatePriceVolumeLayer valueDatePvl)
            {
                ValueDate = valueDatePvl.ValueDate;
            }
        ...
        {
            foreach (var baseUpdates in base.GetStringUpdates(snapShotTime, updatedStyle))
            {
                yield return baseUpdates;
            }
        ...
        public override bool UpdateFieldString(PQFieldStringUpdate updates)
        {
            ...
            {
                return SourceNameIdLookup.UpdateFieldString(updates);
            }
            return false;
        }
        ...
        public override void CopyFrom(IPriceVolumeLayer source, CopyMergeFlags copyMergeFlags = CopyMergeFlags.Default)
        {
            ...
            switch (source)
            {
                case IPQSourceQuoteRefTraderValueDatePriceVolumeLayer srcQtRefTrdrVlDtPv:
                    ...
                    if (srcQtRefTrdrVlDtPv.IsValueDateUpdated)
                    {
                        ValueDate = srcQtRefTrdrVlDtPv.ValueDate;
                    }
                    if (srcQtRefTrdrVlDtPv.IsSourceQuoteReferenceUpdated)
                    {
                        SourceQuoteReference = srcQtRefTrdrVlDtPv.SourceQuoteReference;
                    }
                    if (srcQtRefTrdrVlDtPv.IsSourceNameUpdated)
                    {
                        SourceId = srcQtRefTrdrVlDtPv.SourceId;
                    }
                    if (srcQtRefTrdrVlDtPv.IsExecutableUpdated)
                    {
                        Executable = srcQtRefTrdrVlDtPv.Executable;
                    }
                ...
                case IPQSourceQuoteRefPriceVolumeLayer pqSrcQtRefPvLayer:
                    ...
                    if (pqSrcQtRefPvLayer.IsSourceNameUpdated)
                    {
                        SourceId = pqSrcQtRefPvLayer.SourceId;
                    }
                    if (pqSrcQtRefPvLayer.IsExecutableUpdated)
                    {
                ...
                case IPQSourcePriceVolumeLayer pqSourcePvLayer:
                    ...
                    if (pqSourcePvLayer.IsSourceNameUpdated)
                    {
                        SourceId = pqSourcePvLayer.SourceId;
                    }
                    if (pqSourcePvLayer.IsExecutableUpdated)
                    {
        ...
        {
            return (IPQSourceQuoteRefTraderValueDatePriceVolumeLayer)Clone();
        }
        ...
        {
            return (IPQSourceQuoteRefPriceVolumeLayer)Clone();
        }
        ...
        IPQSourcePriceVolumeLayer IPQSourcePriceVolumeLayer.Clone()
        {
            return (IPQSourcePriceVolumeLayer)Clone();
        }
        ...
        {
            return new PQSourceQuoteRefTraderValueDatePriceVolumeLayer(this);
        }
        ...
        {
            return $"PQSourceQuoteRefTraderValueDatePriceVolumeLayer {{ {nameof(Price)}: {Price:N5}, " +
