...
namespace FortitudeMarketsCore.Pricing.PQ.LayeredBook
{
    public class PQSourceQuoteRefPriceVolumeLayer : PQSourcePriceVolumeLayer, IPQSourceQuoteRefPriceVolumeLayer
    {
        ...
        {
            return new PQSourceQuoteRefPriceVolumeLayer(this);
        }
        ...
        {
            return ReferenceEquals(this, obj) || AreEquivalent((ISourcePriceVolumeLayer)obj, true);
        }
        ...
        {
            return $"PQSourceQuoteRefPriceVolumeLayer {{ {nameof(Price)}: {Price:N5}, " +
