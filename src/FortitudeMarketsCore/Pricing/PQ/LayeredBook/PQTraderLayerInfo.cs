...
namespace FortitudeMarketsCore.Pricing.PQ.LayeredBook
{
    ...
    public class PQTraderLayerInfo : IPQTraderLayerInfo
    {
        ...
        public PQTraderLayerInfo(ITraderLayerInfo toClone)
        {
            ...
            if (pqTraderLayerInfo != null)
            {
                UpdatedFlags = pqTraderLayerInfo.UpdatedFlags;
            }
        }
        ...
        public virtual void CopyFrom(ITraderLayerInfo source, CopyMergeFlags copyMergeFlags = CopyMergeFlags.Default)
        {
            ...
            else if (pqTrdrLyrInfo != null)
            {
                ...
                if (pqTrdrLyrInfo.IsTraderNameUpdated)
                {
                    TraderName = pqTrdrLyrInfo.TraderName;
                }
                if (pqTrdrLyrInfo.IsTraderVolumeUpdated)
                {
                    TraderName = pqTrdrLyrInfo.TraderName;
                }
        ...
        IMutableTraderLayerInfo IMutableTraderLayerInfo.Clone()
        {
            return (IMutableTraderLayerInfo)Clone();
        }

        IPQTraderLayerInfo IPQTraderLayerInfo.Clone()
        {
            return (IPQTraderLayerInfo)Clone();
        }

        public virtual ITraderLayerInfo Clone()
        {
            return new PQTraderLayerInfo(this);
        }
        ...
        public virtual bool AreEquivalent(ITraderLayerInfo other, bool exactTypes = false)
        {
            ...
            if (exactTypes)
            {
                var pqTraderLayerInfo = other as PQTraderLayerInfo;
        ...
        {
            return ReferenceEquals(this, obj) || AreEquivalent((ITraderLayerInfo) obj, true);
        }
        ...
        {
            return $"PQTraderLayerInfo {{ {nameof(TraderName)}: {TraderName}, " +
