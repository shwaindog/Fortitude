        ...
        where T : SocketSubscriber
    {
            ...
            IPQQuoteSerializerFactory pqQuoteSerializerFactory, string multicastInterface = null)
        {
            ...
            lock (syncLock)
            {
                ...
                socketClient.RegisterDeserializer<IPQLevel0Quote>(streamId, NoOp);
            }
            return socketClient;
        }
        ...
        public T FindSocketSubscription(IConnectionConfig configKey)
        {
            ...
            return socketSubscriptions.TryGetValue(configKey, out var findValue) ? findValue : null;
        }
        ...
        public void UnregisterSocketSubscriber(IConnectionConfig cfg, uint streamId)
        {
            lock (syncLock)
            {
                ...
                {
                    socketClient.UnregisterDeserializer<IPQLevel0Quote>(streamId, NoOp);
