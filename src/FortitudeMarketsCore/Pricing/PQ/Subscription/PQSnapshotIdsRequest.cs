...
namespace FortitudeMarketsCore.Pricing.PQ.Subscription
{
    public class PQSnapshotIdsRequest : IPQSnapshotIdsRequest
    {
        ...
        public PQSnapshotIdsRequest(uint[] requestSourceTickerIds)
        {
            RequestSourceTickerIds = requestSourceTickerIds;
        }
        ...
        {
            return (RequestSourceTickerIds != null ? RequestSourceTickerIds.GetHashCode() : 0);
        }
    }
}
