...
public sealed class PQPricingClientSnapshotConversationRequester : ConversationRequester, IPQSnapshotClientCommon
{
    ...
    public static PQPricingClientSnapshotConversationRequester BuildTcpRequester
      ...
      , IMessageDeserializationRepository sharedDeserializationRepository)
    {
        ...
        var socketSessionContext = new BusSocketSessionContext
        ...
        return new PQPricingClientSnapshotConversationRequester
            (socketSessionContext, streamControls, feedName, creatingRule, sharedDeserializationRepository);
    }
