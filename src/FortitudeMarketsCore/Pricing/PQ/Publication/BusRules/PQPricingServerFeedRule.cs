...
public class PQPricingServerFeedRule : Rule
{
    ...
    public override async ValueTask StartAsync()
    {
        ...
        await this.DeployRuleAsync(updatePublisherRule
            , new DeploymentOptions(RoutingFlags.TargetSpecific, MessageQueueType.IOOutbound, 1, outboundQueueDeploy.Name));
        ...
        await this.DeployRuleAsync(clientResponderRule
            , new DeploymentOptions(RoutingFlags.TargetSpecific, MessageQueueType.IOInbound, 1, inboundQueueDeploy.Name));
    ...
    public async ValueTask RegisterEachConfiguredTicker()
    {
        ...
        foreach (var sourceTickerQuoteInfo in allPricingConfiguredTickerQuoteInfos)
        {
            ...
            await Context.MessageBus.PublishAsync(this, publishTickerAddress, emptyQuoteEvent
                , new DispatchOptions(RoutingFlags.TargetSpecific, targetRule: updatePublisherRule));
        }
    }
}
