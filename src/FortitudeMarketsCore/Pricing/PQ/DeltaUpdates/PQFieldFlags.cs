namespace FortitudeMarketsCore.Pricing.PQ.DeltaUpdates
{
    ...
    {
        public static bool IsAsk(this PQFieldUpdate fieldUpdate)
        {
            return (fieldUpdate.Flag & IsAskSideFlag) == IsAskSideFlag;
        }
        public static bool IsBid(this PQFieldUpdate fieldUpdate)
        {
            return (fieldUpdate.Flag & IsAskSideFlag) == 0;
        }
