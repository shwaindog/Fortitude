namespace FortitudeMarketsCore.Pricing.PQ.DeltaUpdates
{
    public struct PQFieldUpdate
    {
        ...
        {
            return Id == other.Id && Flag == other.Flag && Value == other.Value;
        }
        ...
        {
            return $"PQFieldUpdate{{{nameof(Id)}: {Id}, {nameof(Flag)}: 0x{Flag:x2}, {nameof(Value)}: {Value} }}";
        }
    }
    ...
    public struct PQFieldStringUpdate
    {
        ...
        {
            return Field.Equals(other.Field) && StringUpdate.Equals(other.StringUpdate);
        }
        ...
        public override string ToString()
        {
            return $"PQFieldStringUpdate {{ {nameof(Field)}: {Field}, {nameof(StringUpdate)}: {StringUpdate} }}";
        }
    }
    ...
    public struct PQStringUpdate
    {
        ...
        {
            return DictionaryId == other.DictionaryId && Command == other.Command && string.Equals(Value, other.Value);
        }
        ...
        public override string ToString()
        {
            return $"PQStringUpdate {{ {nameof(DictionaryId)}: {DictionaryId}, {nameof(Command)}: {Command}, " +
                   $"{nameof(Value)}: {Value} }}";
        }
    }
