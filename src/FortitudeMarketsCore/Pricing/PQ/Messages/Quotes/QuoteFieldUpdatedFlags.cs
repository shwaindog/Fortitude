...
public enum QuoteFieldUpdatedFlags : uint
{
  ...
  , BidTopPriceUpdatedFlag                  = 0x0020_0000
  , AskTopPriceUpdatedFlag                  = 0x0040_0000
  , ExecutableUpdatedFlag                   = 0x0080_0000
  , BatchIdeUpdatedFlag                     = 0x0100_0000
  , SourceQuoteReferenceUpdatedFlag         = 0x0200_0000
  , ValueDateUpdatedFlag                    = 0x0400_0000
}
