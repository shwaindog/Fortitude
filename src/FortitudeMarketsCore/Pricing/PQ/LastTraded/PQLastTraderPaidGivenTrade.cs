...
namespace FortitudeMarketsCore.Pricing.PQ.LastTraded
{
    public class PQLastTraderPaidGivenTrade : PQLastPaidGivenTrade, IPQLastTraderPaidGivenTrade
    {
        ...
        {
            get => TraderNameIdLookup[traderId];
            set
            {
        ...
        {// assume the recentlytraded has already forwarded this through to the correct lasttrade
            ...
            {
                int traderCountOrId = (int)pqFieldUpdate.Value;
        ...
        public override void CopyFrom(ILastTrade source, CopyMergeFlags copyMergeFlags = CopyMergeFlags.Default)
        {
            ...
            } else if (pqltpgt != null)
            {
                ...
                if (pqltpgt.IsTraderNameUpdated)
                {
        ...
        {
            return new PQLastTraderPaidGivenTrade(this);
        }

        ILastTraderPaidGivenTrade ILastTraderPaidGivenTrade.Clone()
        {
            return (ILastTraderPaidGivenTrade)Clone();
        }

        IMutableLastTraderPaidGivenTrade IMutableLastTraderPaidGivenTrade.Clone()
        {
            return (IMutableLastTraderPaidGivenTrade)Clone();
        }

        IPQLastTraderPaidGivenTrade IPQLastTraderPaidGivenTrade.Clone()
        {
            return (IPQLastTraderPaidGivenTrade)Clone();
        }
        ...
        {
            return $"PQLastTraderPaidGivenTrade {{ {nameof(TradePrice)}: {TradePrice:N5}," +
