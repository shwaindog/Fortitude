...
namespace FortitudeMarketsCore.Pricing.PQ.Quotes
{
    public class PQLevel0Quote : IPQLevel0Quote
    {
        ...
        public PQLevel0Quote(ILevel0Quote toClone)
        {
            ...
            if (toClone is PQLevel0Quote plLevel0Quote)
            {
                UpdatedFlags = plLevel0Quote.UpdatedFlags;
            }
        }
        ...
        public bool IsSourceTimeDateUpdated
        {
            ...
            set
            {
                ...
                else if(IsSourceTimeDateUpdated)
                {
                    UpdatedFlags ^= QuoteFieldUpdatedFlags.SourceSentDateUpdatedFlag;
                }
            }
        ...
        public bool IsSourceTimeSubHourUpdated
        {
            ...
            set
            {
                ...
                else if(IsSourceTimeSubHourUpdated)
                {
                    UpdatedFlags ^= QuoteFieldUpdatedFlags.SourceSentSubSecondUpdatedFlag;
                }
            }
        ...
        public bool IsReplay
        {
            ...
            set
            {
                if ((BooleanFields & PQBooleanValues.IsReplayFlag) > 0 == value) return;
        ...
        public virtual bool HasUpdates
        {
            ...
            set
            {
                ...
                {
                    PQSourceTickerQuoteInfo.HasUpdates = value;
                }
                UpdatedFlags = (value ? UpdatedFlags.AllFlags() : 0);
            }
        }

        protected virtual bool IsBooleanFlagsChanged()
        {
            return IsReplayUpdated;
        }

        protected virtual uint GenerateBooleanFlags()
        {
            return IsReplay ? (uint)PQBooleanValues.IsReplayFlag : 0;
        }
            ...
            IPQQuotePublicationPrecisionSettings quotePublicationPrecisionSettings = null)
        {
            ...
            if (persistenceOrReplay)
            {
                ...
                yield return new PQFieldUpdate(PQFieldKeys.SocketReceivingDateTime, SocketReceivingTime.GetHoursFromUnixEpoch());
                byte fifthByte = SocketReceivingTime.GetSubHourComponent().BreakLongToByteAndUint(out var lower4Bytes);
                ...
                yield return new PQFieldUpdate(PQFieldKeys.ClientReceivedDateTime, ClientReceivedTime.GetHoursFromUnixEpoch());
            ...
            {
                byte fifthByte = sourceTime.GetSubHourComponent().BreakLongToByteAndUint(out var lower4Bytes);
        ...
        {
            return PQSourceTickerQuoteInfo != null && PQSourceTickerQuoteInfo.UpdateFieldString(updates);
        }
        ...
        public virtual void CopyFrom(ILevel0Quote source, CopyMergeFlags copyMergeFlags = CopyMergeFlags.Default)
        {
            ...
            } else
            {
                ...
                if (ipq0.IsReplayUpdated)
                {
                    IsReplay = ipq0.IsReplay;
                }
                if (ipq0.IsSinglePriceUpdated)
                {
                    SinglePrice = ipq0.SinglePrice;
                }
                if (ipq0.IsSyncStatusUpdated)
                {
                    PQSyncStatus = ipq0.PQSyncStatus;
                }
        ...
        {
            return new PQLevel0Quote(this);
        }

        ILevel0Quote ICloneable<ILevel0Quote>.Clone()
        {
            return (ILevel0Quote)Clone();
        }

        ILevel0Quote ILevel0Quote.Clone()
        {
            return (ILevel0Quote)Clone();
        }

        IMutableLevel0Quote IMutableLevel0Quote.Clone()
        {
            return (IMutableLevel0Quote)Clone();
        }

        IPQLevel0Quote IPQLevel0Quote.Clone()
        {
            return (IPQLevel0Quote)Clone();
        }
        ...
        {
            return ReferenceEquals(this, obj) || AreEquivalent((PQLevel0Quote) obj, true);
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                hashCode = (hashCode * 397) ^ SourceTickerQuoteInfo.GetHashCode();
                ...
                hashCode = (hashCode * 397) ^ (int) SourceTickerQuoteInfo?.GetHashCode();
                return hashCode;
            }
        }
    }
