    ...
    public class PQSourceTickerQuoteInfo : PQUniqueSourceTickerIdentifier, IPQSourceTickerQuoteInfo
    {
        ...
        public bool IsRoundingPrecisionUpdated
        {
            ...
            set
            {
                ...
                else if (IsRoundingPrecisionUpdated)
                {
                    UpdatedFlags ^= SourceTickerInfoUpdatedFlags.RoundingPrecision;
                }
            }
        ...
        public bool IsMinSubmitSizeUpdated
        {
            ...
            set
            {
                ...
                else if (IsMinSubmitSizeUpdated)
                {
                    UpdatedFlags ^= SourceTickerInfoUpdatedFlags.MinSubmitSize;
                }
            }
        ...
        public bool IsMaxSubmitSizeUpdated
        {
            ...
            set
            {
                ...
                else if (IsMaxSubmitSizeUpdated)
                {
                    UpdatedFlags ^= SourceTickerInfoUpdatedFlags.MaxSubmitSize;
                }
            }
        ...
        public bool IsIncrementSizeUpdated
        {
            ...
            set
            {
                ...
                else if (IsIncrementSizeUpdated)
                {
                    UpdatedFlags ^= SourceTickerInfoUpdatedFlags.IncrementSize;
                }
            }
        ...
        public bool IsMinimumQuoteLifeUpdated
        {
            ...
            set
            {
                ...
                else if (IsMinimumQuoteLifeUpdated)
                {
                    UpdatedFlags ^= SourceTickerInfoUpdatedFlags.MinimumQuoteLife;
                }
            }
        ...
        public bool IsLastTradedFlagsUpdated
        {
            ...
            set
            {
                ...
                else if (IsLastTradedFlagsUpdated)
                {
                    UpdatedFlags ^= SourceTickerInfoUpdatedFlags.LastTradedFlags;
                }
            }
        ...
        public string FormatPrice => formatPrice ?? (formatPrice = RoundingPrecision
        ...
        public override void CopyFrom(IUniqueSourceTickerIdentifier source, CopyMergeFlags copyMergeFlags = CopyMergeFlags.Default)
        {
            ...
            {
                if (pqSrcTkrQtInfo.IsRoundingPrecisionUpdated)
                {
                    RoundingPrecision = pqSrcTkrQtInfo.RoundingPrecision;
                }
                if (pqSrcTkrQtInfo.IsMinSubmitSizeUpdated)
                {
                    MinSubmitSize = pqSrcTkrQtInfo.MinSubmitSize;
                }
                if (pqSrcTkrQtInfo.IsMaxSubmitSizeUpdated)
                {
                    MaxSubmitSize = pqSrcTkrQtInfo.MaxSubmitSize;
                }
                if (pqSrcTkrQtInfo.IsIncrementSizeUpdated)
                {
                    IncrementSize = pqSrcTkrQtInfo.IncrementSize;
                }
                if (pqSrcTkrQtInfo.IsMinimumQuoteLifeUpdated)
                {
                    MinimumQuoteLife = pqSrcTkrQtInfo.MinimumQuoteLife;
                }
                if (pqSrcTkrQtInfo.IsLayerFlagsUpdated)
                {
                    LayerFlags = pqSrcTkrQtInfo.LayerFlags;
                }
                if (pqSrcTkrQtInfo.IsMaximumPublishedLayersUpdated)
                {
                    MaximumPublishedLayers = pqSrcTkrQtInfo.MaximumPublishedLayers;
                }
                if (pqSrcTkrQtInfo.IsLastTradedFlagsUpdated)
                {
                    LastTradedFlags = pqSrcTkrQtInfo.LastTradedFlags;
                }
            }
        }
        ...
        {
            return new PQSourceTickerQuoteInfo(this);
        }

        ISourceTickerQuoteInfo ISourceTickerQuoteInfo.Clone()
        {
            return (ISourceTickerQuoteInfo)Clone();
        }

        IMutableSourceTickerQuoteInfo IMutableSourceTickerQuoteInfo.Clone()
        {
            return (IMutableSourceTickerQuoteInfo)Clone();
        }
        ...
        {
            return ReferenceEquals(this, obj) || AreEquivalent((ISourceTickerQuoteInfo) obj, true);
        }
        ...
        {
            return $"PQSourceTickerQuoteInfo {{{nameof(roundingPrecision)}: {roundingPrecision}, " +
