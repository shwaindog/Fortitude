    ...
    public class PQLevel1Quote : PQLevel0Quote, IPQLevel1Quote
    {
        ...
        public PQLevel1Quote(ILevel0Quote toClone) : base(toClone)
        {
            if (toClone is ILevel1Quote l1QToClone)
            {
                ...
                else if (l1QToClone.PeriodSummary != null)
                {
                    PeriodSummary = new PQPeriodSummary(l1QToClone.PeriodSummary);
                }
            }
        }
        ...
        public bool IsSourceAskTimeDateUpdated
        {
            ...
            set
            {
                ...
                else if(IsSourceAskTimeDateUpdated)
                {
                    UpdatedFlags ^= QuoteFieldUpdatedFlags.SourceAskTimeDateUpdatedFlag;
                }
            }
        ...
        public bool IsSourceBidTimeDateUpdated
        {
            ...
            set
            {
                ...
                else if(IsSourceBidTimeDateUpdated)
                {
                    UpdatedFlags ^= QuoteFieldUpdatedFlags.SourceBidTimeDateUpdatedFlag;
                }
            }
        ...
        public override bool HasUpdates
        {
            ...
            set
            {
                ...
                {
                    PeriodSummary.HasUpdates = value;
                }
        ...
        {
            return base.IsBooleanFlagsChanged() || IsExecutableUpdated;
        }

        protected override uint GenerateBooleanFlags()
        {
            uint resultSoFar = base.GenerateBooleanFlags();
            ...
            IPQQuotePublicationPrecisionSettings quotePublicationPrecisionSettings = null)
        {
            ...
            {
                byte flag = sourceBidTime.GetSubHourComponent().BreakLongToByteAndUint(out var value);
            ...
            {
                byte flag = sourceAskTime.GetSubHourComponent().BreakLongToByteAndUint(out var value);
            ...
            {
                byte flag = adapterReceivedTime.GetSubHourComponent().BreakLongToByteAndUint(out var value);
                yield return new PQFieldUpdate(PQFieldKeys.AdapterReceivedSubHourTime, value, flag);
            }
            if (!IsReplay)
            {
                AdapterSentTime = snapShotTime;
            }
            ...
            {
                byte flag = adapterSentTime.GetSubHourComponent().BreakLongToByteAndUint(out var value);
            ...
            bool updatedOnly, IPQQuotePublicationPrecisionSettings quotePublicationPrecisionSettings = null)
        {
            ...
            {
                yield return new PQFieldUpdate(PQFieldKeys.LayerPriceOffset, BidPriceTop, PQSourceTickerQuoteInfo.PriceScalingPrecision);
            }
        ...
        public override void CopyFrom(ILevel0Quote source, CopyMergeFlags copyMergeFlags = CopyMergeFlags.Default)
        {
            ...
            PQLevel1Quote pq1 = source as PQLevel1Quote;
            ...
            } else if (pq1 != null) 
            {
                ...
                if (pq1.IsBidPriceTopUpdated)
                {
                    bidPriceTop = pq1.bidPriceTop;
                }
                if (pq1.IsAskPriceTopUpdated)
                {
                    askPriceTop = pq1.askPriceTop;
                }
                if (pq1.IsExecutableUpdated)
                {
        ...
        IPQLevel1Quote IPQLevel1Quote.Clone()
        {
            return (IPQLevel1Quote)Clone();
        }
