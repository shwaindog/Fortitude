...
public class CompositeMidMidPriceGenerator : MidPriceGenerator
{
    ...
    public CompositeMidMidPriceGenerator
    (decimal startPrice, DateTime startTime, TimeSpan runTimeSpan, int roundAtDecimalPlaces = 6
      , TimeSpan? deltaPostRunSleepTimeSpan = null, params IMidPriceGenerator[] compositeGenerators)
