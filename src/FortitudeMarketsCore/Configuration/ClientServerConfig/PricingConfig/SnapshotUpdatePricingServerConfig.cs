...
namespace FortitudeMarketsCore.Configuration.ClientServerConfig.PricingConfig
{
        ...
        ISnapshotUpdatePricingServerConfig
    {
            ...
            : base(name, marketServerType, serverConnections, availabilityTimeTable, repoUpdateStream)
        {
            ...
            this.sourceTickerPublicationConfigs = sourceTickerPublicationConfigs?.ToList();
        ...
        public new ISnapshotUpdatePricingServerConfig Clone()
        {
            return new SnapshotUpdatePricingServerConfig(this);
        }
        ...
        public bool AreEquivalent(ISnapshotUpdatePricingServerConfig other, bool exactTypes = false)
        {
            ...
            var srcTkrPubConfigsSame = itemsCountSame && 
                (other.SourceTickerPublicationConfigs != null && sourceTickerPublicationConfigs != null
                || other.SourceTickerPublicationConfigs == null && sourceTickerPublicationConfigs == null);
        ...
        {
            return ReferenceEquals(this, obj) || AreEquivalent(obj as ISnapshotUpdatePricingServerConfig, true);
        }
