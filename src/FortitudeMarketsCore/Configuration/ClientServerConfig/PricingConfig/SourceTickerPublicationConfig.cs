...
{
    public class SourceTickerPublicationConfig : SourceTickerQuoteInfo, ISourceTickerPublicationConfig
    {
        ...
        public ISnapshotUpdatePricingServerConfig MarketPriceQuoteServer { get; }

        public override object Clone()
        {
            return new SourceTickerPublicationConfig(this);
        }

        ISourceTickerPublicationConfig ISourceTickerPublicationConfig.Clone()
        {
            return (ISourceTickerPublicationConfig)Clone();
        }
        ...
        {
            return $"SourceTickerPublicationConfig {{{nameof(Id)}: {Id}, {nameof(Source)}: {Source}, " +
