...
public static class StringExtensions
{
    ...
    public static bool IsSglQtBounded(this string? input)  => input is {Length: > 1} &&  input[0] == '\'' && input[^1] == '\'';
    public static bool IsDblQtBounded(this string? input)  => input is { Length: > 1 } && input[0] == '\"' && input[^1] == '\"';
    public static bool IsSqBrktBounded(this string? input) => input is {Length: > 1 } &&  input[0] == '[' &&  input[^1] == ']';
