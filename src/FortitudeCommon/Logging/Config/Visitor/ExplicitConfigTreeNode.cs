...
//     }
//
//     public abstract IFloggerAppenderRegistry FloggerAppenderRegistry { get; }
//
...
// {
//     public ExplicitRootConfigNode(string Name, IFLoggerRootConfig DeclaredRootConfig, IFloggerAppenderRegistry FloggerAppenderRegistry)
//         : base(Name
...
//                    : new ExplicitLogEntryPoolDefinition(PoolScope.LoggersGlobal, LoggersGlobal, DefaultLogEntryCharsCapacity, DefaultLogEntryBatchSize))
//     {
//         this.DeclaredRootConfig = DeclaredRootConfig;
//         this.FloggerAppenderRegistry   = FloggerAppenderRegistry;
...
//
//     public override IFloggerAppenderRegistry FloggerAppenderRegistry { get; }
//
...
//     }
//
//     public void Deconstruct(out string Name, out IFLoggerRootConfig DeclaredRootConfig, out IFloggerAppenderRegistry floggerAppenderRegistry)
//     {
//         Name = this.Name;
//
//         DeclaredRootConfig = this.DeclaredRootConfig;
//         floggerAppenderRegistry   = this.FloggerAppenderRegistry;
//     }
// }
//
...
//                                    : LogPoolDefinition)
// {
//     private IFloggerAppenderRegistry? appenderRegistry;
//
//     public override string FullName => Visit(new BaseToLeafVisitor()).FullName;
//
//     public override IFloggerAppenderRegistry FloggerAppenderRegistry => appenderRegistry ??= RootConfigNode.FloggerAppenderRegistry;
//
