...
public interface IKeyedCollectionContinuation<out TToReturn> : ICollectionAppendContinuation<TToReturn>
{
    ...
    [MustUseReturnValue("Use FinalAppendKeyedCollection to finish and send LogEntry")]
    TToReturn AddKeyed<TKey, TValue, TKFilterBase, TVFilterBase, TKRevealBase, TVRevealBase>(KeyValuePair<TKey, TValue>[]? value
      , KeyValuePredicate<TKFilterBase, TVFilterBase> filterPredicate
      , PalantírReveal<TVRevealBase> valueStyler, PalantírReveal<TKRevealBase> keyStyler)
        where TKey : TKFilterBase?, TKRevealBase? 
        where TValue : TVFilterBase?, TVRevealBase?
    ...
    TToReturn AddKeyed<TKey, TValue, TKFilterBase, TVFilterBase>((IReadOnlyList<KeyValuePair<TKey, TValue>>?
      , KeyValuePredicate<TKFilterBase, TVFilterBase>) valueTuple) 
        where TKey : TKFilterBase? 
        where TValue : TVFilterBase?;
    ...
    [MustUseReturnValue("Use FinalAppendKeyedCollectionEnumerate to finish and send LogEntry")]
    TToReturn AddKeyedIterate<TEnumtr, TKey, TValue>(TEnumtr value
      , string? valueFormatString = null, string? keyFormatString = null)
        where TEnumtr : IEnumerator<KeyValuePair<TKey, TValue>>?;

    [MustUseReturnValue("Use FinalAppendKeyedCollectionEnumerate to finish and send LogEntry")]
    TToReturn AddKeyedIterate<TEnumtr, TKey, TValue>((TEnumtr, string?, string?) valueTuple)
        where TEnumtr : IEnumerator<KeyValuePair<TKey, TValue>>?;

    [MustUseReturnValue("Use FinalAppendKeyedCollectionEnumerate to finish and send LogEntry")]
    TToReturn AddKeyedIterate<TEnumtr, TKey, TValue>((TEnumtr, string?) valueTuple)
        where TEnumtr : IEnumerator<KeyValuePair<TKey, TValue>>?;

    [MustUseReturnValue("Use FinalAppendKeyedCollectionEnumerate to finish and send LogEntry")]
    TToReturn AddKeyedIterate<TEnumtr, TKey, TValue, TVRevealBase>(TEnumtr value
      , PalantírReveal<TVRevealBase> valueStyler, string? keyFormatString = null) 
        where TEnumtr : IEnumerator<KeyValuePair<TKey, TValue>>?
        where TValue : TVRevealBase?
        where TVRevealBase : notnull;
    ...
    [MustUseReturnValue("Use FinalAppendKeyedCollectionEnumerate to finish and send LogEntry")]
    TToReturn AddKeyedIterate<TEnumtr, TKey, TValue, TVRevealBase>(
    ...
    [MustUseReturnValue("Use FinalAppendKeyedCollectionEnumerate to finish and send LogEntry")]
    TToReturn AddKeyedIterate<TEnumtr, TKey, TValue, TKRevealBase, TVRevealBase>(TEnumtr value
      , PalantírReveal<TVRevealBase> valueStyler, PalantírReveal<TKRevealBase> keyStyler)
        where TEnumtr : IEnumerator<KeyValuePair<TKey, TValue>>?
        where TKey : TKRevealBase? 
        where TValue : TVRevealBase?
    ...
    [MustUseReturnValue("Use FinalAppendKeyedCollectionEnumerate to finish and send LogEntry")]
    TToReturn AddKeyedIterate<TEnumtr, TKey, TValue, TKRevealBase, TVRevealBase>(
