...
public class KeyedCollectionContinuation<TToReturn, TCallerType> : CollectionAppendContinuation<TToReturn, TCallerType>, IKeyedCollectionContinuation<TToReturn>
