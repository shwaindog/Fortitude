...
public abstract partial class FLogEntryMessageBuilder
{
    ...
    protected IStyledTypeStringAppender? AppendValueCollectionEnumerate<TToStyle, TStylerType>
        (IStyledTypeStringAppender? toAppendTo, IEnumerable<TToStyle>? value, CustomTypeStyler<TStylerType> customTypeStyler)
        where TToStyle : TStylerType
    {
        toAppendTo?.StartSimpleCollectionType("")
    ...
    protected static IStyledTypeStringAppender? AppendObjectCollection<T>((IReadOnlyList<T>?, string?) valueTuple
    ...
    protected static IStyledTypeStringAppender? AppendObjectCollectionEnumerate<T>((IEnumerable<T>?, string?) valueTuple
      , IStyledTypeStringAppender? appender)
        where T : class
    {
        var (value, formatString) = valueTuple;
