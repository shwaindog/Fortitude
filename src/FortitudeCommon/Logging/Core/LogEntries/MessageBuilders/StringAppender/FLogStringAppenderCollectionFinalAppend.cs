...
public partial class FLogStringAppender
{
    ...
    public void FinalAppendObjectCollection<T>(T[]? value, OrderedCollectionPredicate<T> filter, string? formatString = null)
        where T : class =>
        AppendFilteredObjectCollection(MessageStsa, value, filter, formatString).ToAppender(this).CallOnComplete();


    public void FinalAppendObjectCollection<T>((T[]?, OrderedCollectionPredicate<T>, string?) valueTuple) where T : class =>
        AppendFilteredObjectCollection(valueTuple, MessageStsa).ToAppender(this).CallOnComplete();


    public void FinalAppendObjectCollection<T>((T[]?, OrderedCollectionPredicate<T>) valueTuple) where T : class =>
        AppendFilteredObjectCollection(valueTuple, MessageStsa).ToAppender(this).CallOnComplete();


    public void FinalAppendObjectCollection<T>(IReadOnlyList<T>? value, OrderedCollectionPredicate<T> filter
      , string? formatString = null) where T : class =>
        AppendFilteredObjectCollection(MessageStsa, value, filter, formatString).ToAppender(this).CallOnComplete();


    public void FinalAppendObjectCollection<T>(
