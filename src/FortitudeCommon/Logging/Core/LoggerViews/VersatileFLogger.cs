...
public class VersatileFLogger(IFLogger logger) : TerseFLogger(logger), IVersatileFLogger
{
    ...
    public IFLogFirstFormatterParameterEntry? AtLevelFormat(FLogLevel level, [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string formatString
      , LoggerActivationFlags activationFlags = LoggerActivationFlags.MergeWithLoggerConfigProfile, StringBuildingStyle style = StringBuildingStyle.Default
    ...
    public void AtLevel<T>(FLogLevel level, T toLog, LoggerActivationFlags activationFlags = LoggerActivationFlags.MergeWithLoggerConfigProfile
      , StringBuildingStyle style = StringBuildingStyle.Default, string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
    ...
    public IFLogStringAppender? TraceAppend<T>(T firstAppend, LoggerActivationFlags activationFlags = LoggerActivationFlags.MergeWithLoggerConfigProfile
      , StringBuildingStyle style = StringBuildingStyle.Default, string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
    ...
    public void Trace<T>(T toLog, LoggerActivationFlags activationFlags = LoggerActivationFlags.MergeWithLoggerConfigProfile
    ...
    public IFLogStringAppender? DebugAppend<T>(T firstAppend, LoggerActivationFlags activationFlags = LoggerActivationFlags.MergeWithLoggerConfigProfile
      , StringBuildingStyle style = StringBuildingStyle.Default
      , string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
    ...
    public void Debug<T>(T toLog, LoggerActivationFlags activationFlags = LoggerActivationFlags.MergeWithLoggerConfigProfile
      , StringBuildingStyle style = StringBuildingStyle.Default
      , string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
    ...
    public IFLogStringAppender? InfoAppend<T>(T firstAppend, LoggerActivationFlags activationFlags = LoggerActivationFlags.MergeWithLoggerConfigProfile
      , StringBuildingStyle style = StringBuildingStyle.Default, string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
    ...
    public void Info<T>(T toLog, LoggerActivationFlags activationFlags = LoggerActivationFlags.MergeWithLoggerConfigProfile
      , StringBuildingStyle style = StringBuildingStyle.Default
      , string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
    ...
    public IFLogStringAppender? WarnAppend<T>(T firstAppend, LoggerActivationFlags activationFlags = LoggerActivationFlags.MergeWithLoggerConfigProfile
      , StringBuildingStyle style = StringBuildingStyle.Default
      , string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
    ...
    public void Warn<T>(T toLog, LoggerActivationFlags activationFlags = LoggerActivationFlags.MergeWithLoggerConfigProfile
      , StringBuildingStyle style = StringBuildingStyle.Default
      , string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
    ...
    public IFLogStringAppender? ErrorAppend<T>(T firstAppend, LoggerActivationFlags activationFlags = LoggerActivationFlags.MergeWithLoggerConfigProfile
      , StringBuildingStyle style = StringBuildingStyle.Default
      , string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
    ...
    public void Error<T>(T toLog, LoggerActivationFlags activationFlags = LoggerActivationFlags.MergeWithLoggerConfigProfile
      , StringBuildingStyle style = StringBuildingStyle.Default
      , string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
