...
public class VersatileFLogger(IFLogger logger) : TerseFLogger(logger), IVersatileFLogger
{
    ...
    public IFLogStringAppender? AtLevelAppend<T>(FLogLevel level, T firstAppend
      , LoggerActivationFlags activationFlags = LoggerActivationFlags.Disabled
    ...
    public void Trace<T>(T toLog, LoggerActivationFlags activationFlags = LoggerActivationFlags.Disabled
    ...
    public IFLogStringAppender? DebugAppend<T>(T firstAppend, LoggerActivationFlags activationFlags = LoggerActivationFlags.Disabled
      , StringBuildingStyle style = StringBuildingStyle.Default
      , string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
    ...
    public void Debug<T>(T toLog, LoggerActivationFlags activationFlags = LoggerActivationFlags.Disabled
      , StringBuildingStyle style = StringBuildingStyle.Default
      , string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
    ...
    public void Info<T>(T toLog, LoggerActivationFlags activationFlags = LoggerActivationFlags.Disabled
      , StringBuildingStyle style = StringBuildingStyle.Default
      , string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
    ...
    public IFLogStringAppender? WarnAppend<T>(T firstAppend, LoggerActivationFlags activationFlags = LoggerActivationFlags.Disabled
      , StringBuildingStyle style = StringBuildingStyle.Default
      , string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
    ...
    public void Warn<T>(T toLog, LoggerActivationFlags activationFlags = LoggerActivationFlags.Disabled
      , StringBuildingStyle style = StringBuildingStyle.Default
      , string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
    ...
    public IFLogStringAppender? ErrorAppend<T>(T firstAppend, LoggerActivationFlags activationFlags = LoggerActivationFlags.Disabled
      , StringBuildingStyle style = StringBuildingStyle.Default
      , string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
    ...
    public void Error<T>(T toLog, LoggerActivationFlags activationFlags = LoggerActivationFlags.Disabled
      , StringBuildingStyle style = StringBuildingStyle.Default
      , string memberName = "", string sourceFilePath = "", int sourceLineNumber = 0) =>
