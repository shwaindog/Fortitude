...
namespace FortitudeCommon.Monitoring.Logging.Diagnostics.Performance
{
    public class PerfLoggerPool : IPerfLoggerPool
    {
        ...
        private static readonly List<DiagnosticFileWatcher> FileWatchers = new List<DiagnosticFileWatcher>();
        ...
        static PerfLoggerPool()
        {
            ...
            try
            {
                ...
                var currentAssemblyPath = Assembly.GetExecutingAssembly().GetName().CodeBase;
        ...
        public PerfLoggerPool(Func<IPerfLogger> newObjFunc, string fullName)
        {
            ...
            try
            {
                ...
                HierarchialLoggingConfigurator<PerfLoggerPool>.Register(this);
            ...
            Tu moreOptionalData, Tv evenMoreOptionalData)
        {
            ...
            if (Enabled)
            {
                traceLogger.StopTiming(optionalData, moreOptionalData, evenMoreOptionalData);
            }
            ...
            Tu moreOptionalData)
        {
            ...
            if (Enabled)
            {
                traceLogger.StopTiming(optionalData, moreOptionalData);
            }
            latencyTraceLoggerPool.Return(traceLogger);
        }
        ...
        public void StopTrace<T1>(IPerfLogger traceLogger, T1 optionalData)
        {
            ...
            if (Enabled)
            {
                traceLogger.StopTiming(optionalData);
            }
            latencyTraceLoggerPool.Return(traceLogger);
        }
