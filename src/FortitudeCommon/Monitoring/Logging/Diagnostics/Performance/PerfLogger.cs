...
namespace FortitudeCommon.Monitoring.Logging.Diagnostics.Performance
{
    public class PerfLogger : IPerfLogger
    {
        ...
        public PerfLogger(string name, TimeSpan timeoutTimeSpan, string prefixName)
        {
            ...
            HierarchialLoggingConfigurator<ILatencyLogger>.Register(latencyLogger);
            HierarchialLoggingConfigurator<ITraceLogger>.Register(traceLogger);
            HierarchialLoggingConfigurator<ICallStatsLogger>.Register(callStatsLogger);
        ...
        {
            get { return latencyLogger.LatencyLoggingLevel; }
            set { latencyLogger.LatencyLoggingLevel = value; }
        }

        public bool Enabled
        {
            get { return traceLogger.Enabled || latencyLogger.Enabled; }
            set
            {
            }
        }
        ...
        public void Add<TU>(string identifier, TU subject)
        {
            ...
            {
                traceLogger.Add(identifier, subject);
            }
        }
        ...
        {
            get { return latencyLogger.StartTime; }
        }

        public DateTime StopTime
        {
            get { return latencyLogger.StopTime; }
        }

        public CallStat LastCallStat
        {
            get { return latencyLogger.LastCallStat; }
        }

        public TimeSpan MaxAcceptablePeriod
        {
            get { return latencyLogger.MaxAcceptablePeriod; }
        ...
        {
            get { return traceLogger.WriteTrace; }
            set { traceLogger.WriteTrace = value; }
        }

        public bool DefaultWriteTrace
        {
            get { return traceLogger.DefaultWriteTrace; }
        ...
        public void StopTiming<T1, TU>(T1 optionalData, TU moreOptionalData)
        {
            if (latencyLogger.Enabled)
            {
                latencyLogger.StopTiming(optionalData, moreOptionalData, traceLogger);
            }
            TraceFinished();
            LogCallStats();
        }
        ...
        {
            return traceLogger.TraceFinished();
        }

        public int BatchSize
        {
            get { return callStatsLogger.BatchSize; }
