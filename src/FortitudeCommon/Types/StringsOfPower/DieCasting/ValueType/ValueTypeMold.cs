...
public class ValueTypeMold<TMold> : KnownTypeMolder<TMold> where TMold : TypeMolder
{
    ...
    public TMold AsValueOrNull<TFmt>(ReadOnlySpan<char> nonJsonfieldName, TFmt? value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FormatFlags formatFlags = AsValueContent) where TFmt : class, ISpanFormattable =>
    ...
    public TMold RevealAsValueOrDefault<TCloaked, TCloakedBase>(TCloaked? value, PalantírReveal<TCloakedBase> palantírReveal
      , ReadOnlySpan<char> defaultValue, string? formatString = null, FormatFlags formatFlags = AsValueContent) 
      where TCloaked : TCloakedBase
      where TCloakedBase : notnull =>
    ...
    public TMold RevealAsValueOrNull<TBearer>(ReadOnlySpan<char> nonJsonfieldName, TBearer? value
      , string? formatString = null, FormatFlags formatFlags = AsValueContent) where TBearer : struct, IStringBearer =>
        Stb.FieldValueOrNullNext(nonJsonfieldName, value, formatFlags, formatString ?? "");
    ...
    public TMold AsValueOrZero(Span<char> value, FormatFlags formatFlags = AsValueContent) =>
    ...
    public TMold AsValueOrZero(ReadOnlySpan<char> value, FormatFlags formatFlags = AsValueContent) =>
        Stb.FieldValueOrDefaultNext("", value, "0", "", formatFlags);
    ...
    public TMold AsValue(Span<char> value, FormatFlags formatFlags = AsValueContent) =>
        Stb.FieldValueOrDefaultNext("", value, "0", "", formatFlags);

    public TMold AsValue(ReadOnlySpan<char> value, FormatFlags formatFlags = AsValueContent) =>
        Stb.FieldValueOrDefaultNext("", value, "0", "", formatFlags);

    public TMold AsValue(string value, FormatFlags formatFlags = AsValueContent) =>
        Stb.FieldValueOrDefaultNext("", value, "0", "", formatFlags);
    ...
    public TMold AsStringOrNull<TFmt>(ReadOnlySpan<char> nonJsonfieldName, TFmt? value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FormatFlags formatFlags = EncodeAll) where TFmt : class, ISpanFormattable =>
        Stb.FieldStringOrNullNext(nonJsonfieldName, value, formatString ?? "", formatFlags);
    ...
    public TMold AsStringOrNull(Span<char> value, FormatFlags formatFlags = EncodeAll) =>
    ...
    public TMold AsStringOrNull(ReadOnlySpan<char> value, FormatFlags formatFlags = EncodeAll) =>
        Stb.FieldStringOrNullNext("", value, "", formatFlags);

    public TMold AsString(Span<char> value, FormatFlags formatFlags = EncodeAll) =>
        Stb.FieldStringOrDefaultNext("", value, "", "", formatFlags);

    public TMold AsString(ReadOnlySpan<char> value, FormatFlags formatFlags = EncodeAll) =>
        Stb.FieldStringOrDefaultNext("", value, "", "", formatFlags);

    public TMold AsString(string value, FormatFlags formatFlags = EncodeAll) =>
        Stb.FieldStringOrDefaultNext("", value, "", "", formatFlags);
