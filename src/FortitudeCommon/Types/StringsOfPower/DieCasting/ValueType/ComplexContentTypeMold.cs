...
{
    private TypeFieldCollection.SelectTypeCollectionField<ComplexContentTypeMold>? logOnlyInternalCollectionField;
    private TypeFields.SelectTypeField<ComplexContentTypeMold>?  logOnlyInternalField;
    ...
    public TypeFields.SelectTypeField<ComplexContentTypeMold> LogOnlyField =>
        logOnlyInternalField ??=
            PortableState.Master.Recycler
                         .Borrow<TypeFields.SelectTypeField<ComplexContentTypeMold>>().Initialize(MoldStateField);

    public TypeFieldCollection.SelectTypeCollectionField<ComplexContentTypeMold> LogOnlyCollectionField =>
        logOnlyInternalCollectionField ??=
            PortableState.Master.Recycler
                         .Borrow<TypeFieldCollection.SelectTypeCollectionField<ComplexContentTypeMold>>().Initialize(MoldStateField);
