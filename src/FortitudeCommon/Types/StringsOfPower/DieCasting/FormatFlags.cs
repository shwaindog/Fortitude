...
public static class FieldContentHandlingExtensions
{
    ...
    public static bool HasContentAllowComplexType(this FormatFlags flags)                => (flags & ContentAllowComplexType) > 0;
    public static bool DoesNotHaveContentAllowComplexType(this FormatFlags flags)        => (flags & ContentAllowComplexType) == 0;
