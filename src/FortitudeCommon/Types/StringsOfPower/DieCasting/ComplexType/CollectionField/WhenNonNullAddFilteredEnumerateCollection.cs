...
{
    public TExt WhenNonNullAddFilteredEnumerateBool<TEnumbl>(string fieldName, TEnumbl? value, OrderedCollectionPredicate<bool> filterPredicate
    ...
    public TExt WhenNonNullAddFilteredEnumerateNullableBool<TEnumbl>(string fieldName, TEnumbl?value, OrderedCollectionPredicate<bool?> filterPredicate
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FormatFlags formatFlags = DefaultCallerTypeFlags)
      where TEnumbl : IEnumerable<bool?>?  =>
    ...
    public TExt WhenNonNullAddFilteredEnumerate<TEnumbl, TFmtBase>
    ...
    public TExt WhenNonNullRevealFilteredEnumerate<TEnumbl, TFilterBase, TRevealBase>
    ...
    public TExt WhenNonNullRevealFilteredEnumerate<TEnumbl, TBearerBase>(string fieldName
      , TEnumbl? value
    ...
    public TExt WhenNonNullAddFilteredEnumerateString<TEnumbl>
    ...
    public TExt WhenNonNullAddFilteredEnumerateCharSeq<TEnumbl, TCharSeqBase>
    ...
    public TExt WhenNonNullAddFilteredEnumerateCharSeq<TEnumbl, TCharSeq, TCharSeqBase>
    (string fieldName, TEnumbl? value, OrderedCollectionPredicate<TCharSeqBase> filterPredicate
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FormatFlags formatFlags = DefaultCallerTypeFlags) 
    ...
    public TExt WhenNonNullAddFilteredEnumerateStringBuilder<TEnumbl>
    ...
    public TExt WhenNonNullAddFilteredEnumerateMatch<TEnumbl, TAnyBase>
    ...
    public TExt WhenNonNullAddFilteredEnumerateMatch<TEnumbl, TAny, TAnyBase>
    (string fieldName, TEnumbl? value, OrderedCollectionPredicate<TAnyBase> filterPredicate
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FormatFlags formatFlags = DefaultCallerTypeFlags)
    ...
    [CallsObjectToString]
    public TExt WhenNonNullAddFilteredEnumerateObject<TEnumbl>
