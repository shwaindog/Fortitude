...
public partial class SelectTypeKeyValueCollectionField<TExt> where TExt : TypeMolder
{
    ...
    (string fieldName, IReadOnlyDictionary<TKey, TValue>? value
      ...
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? keyFormatString = null)
        ...
        !stb.SkipFields && value != null
            ? AlwaysAddFiltered(fieldName, value, filterPredicate, valueStyler, keyFormatString)
            : stb.StyleTypeBuilder;
    ...
    (string fieldName, IReadOnlyDictionary<TKey, TValue>? value
      ...
      , StringBearerRevealState<TVBase2> valueStyler
      , StringBearerRevealState<TKBase2> keyStyler)
        where TKey : TKBase1, TKBase2 where TValue : TVBase1, TVBase2 =>
        !stb.SkipFields && value != null
            ? AlwaysAddFiltered(fieldName, value, filterPredicate, valueStyler, keyStyler)
            : stb.StyleTypeBuilder;
