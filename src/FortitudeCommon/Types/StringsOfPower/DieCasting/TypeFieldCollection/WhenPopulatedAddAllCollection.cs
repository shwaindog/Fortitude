...
public partial class SelectTypeCollectionField<TExt> where TExt : TypeMolder
{
    ...
    public TExt WhenPopulatedAddAllMatchNullable<TAny>(ReadOnlySpan<char> fieldName, Span<TAny?> value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) =>
        !stb.SkipFields && value is { Length: > 0 } ? AlwaysAddAllMatch(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt WhenPopulatedAddAll(string fieldName, IReadOnlyList<bool>? value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) =>
        !stb.SkipFields && value is { Count: > 0 } ? AlwaysAddAll(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt WhenPopulatedRevealAll<TCloaked, TCloakedBase>
        (string fieldName, IReadOnlyList<TCloaked?>? value, PalantírReveal<TCloakedBase> palantírReveal
          , FieldContentHandling formatFlags = DefaultCallerTypeFlags) where TCloaked : TCloakedBase =>
        !stb.SkipFields && value is { Count: > 0 } ? AlwaysRevealAll(fieldName, value, palantírReveal, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt WhenPopulatedRevealAll<TBearer>(string fieldName, IReadOnlyList<TBearer?>? value
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags)
        ...
        !stb.SkipFields && value is { Count: > 0 } ? AlwaysRevealAll(fieldName, value, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt WhenPopulatedAddAllCharSeq<TCharSeq>(string fieldName, IReadOnlyList<TCharSeq?>? value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) where TCharSeq : ICharSequence =>
        !stb.SkipFields && value is { Count: > 0 } ? AlwaysAddAllCharSeq(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt WhenPopulatedAddAllMatch<TAny>(string fieldName, IReadOnlyList<TAny?>? value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) =>
        !stb.SkipFields && value is { Count: > 0 } ? AlwaysAddAllMatch(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt WhenPopulatedAddAllEnumerate(string fieldName, IEnumerable<bool>? value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) =>
        !stb.SkipFields && (value?.Any() ?? false) ? AlwaysAddAllEnumerate(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt WhenPopulatedRevealAllEnumerate<TCloaked, TCloakedBase>
        (string fieldName, IEnumerable<TCloaked?>? value, PalantírReveal<TCloakedBase> palantírReveal
          , FieldContentHandling formatFlags = DefaultCallerTypeFlags) where TCloaked : TCloakedBase =>
        !stb.SkipFields && (value?.Any() ?? false) ? AlwaysRevealAllEnumerate(fieldName, value, palantírReveal, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt WhenPopulatedRevealAllEnumerate<TBearer>(string fieldName, IEnumerable<TBearer?>? value
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags)
        where TBearer : IStringBearer =>
        !stb.SkipFields && (value?.Any() ?? false) ? AlwaysRevealAllEnumerate(fieldName, value, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt WhenPopulatedAddAllCharSeqEnumerate<TCharSeq>(string fieldName, IEnumerable<TCharSeq?>? value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) where TCharSeq : ICharSequence =>
        !stb.SkipFields && (value?.Any() ?? false) ? AlwaysAddAllCharSeqEnumerate(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt WhenPopulatedAddAllMatchEnumerate<TAny>(string fieldName, IEnumerable<TAny?>? value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) =>
        !stb.SkipFields && (value?.Any() ?? false) ? AlwaysAddAllMatchEnumerate(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;
