...
public partial class SelectTypeCollectionField<TExt> where TExt : TypeMolder
{
    public TExt WhenNonNullAddAll(ReadOnlySpan<char> fieldName, Span<bool> value
      ...
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) =>
        !stb.SkipFields && value is { Length: > 0 } ? AlwaysAddAll(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt WhenNonNullAddAllNullable<TFmt>(ReadOnlySpan<char> fieldName, Span<TFmt?> value
      ...
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) where TFmt : class, ISpanFormattable =>
        !stb.SkipFields & value is { Length: > 0 } ? AlwaysAddAllNullable(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt WhenNonNullRevealAllNullable<TBearer>(ReadOnlySpan<char> fieldName, Span<TBearer?> value
    ...
    public TExt WhenNonNullAddAllCharSeq<TCharSeq>(ReadOnlySpan<char> fieldName, Span<TCharSeq> value
      ...
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) where TCharSeq : ICharSequence =>
        !stb.SkipFields && value is { Length: > 0 } ? AlwaysAddAllCharSeq(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;

    public TExt WhenNonNullAddAllCharSeqNullable<TCharSeq>(ReadOnlySpan<char> fieldName, Span<TCharSeq?> value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) where TCharSeq : ICharSequence =>
        !stb.SkipFields && value is { Length: > 0 } ? AlwaysAddAllCharSeqNullable(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt WhenNonNullAddAllMatch<TAny>(ReadOnlySpan<char> fieldName, Span<TAny> value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) =>
        !stb.SkipFields && value is { Length: > 0 } ? AlwaysAddAllMatch(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt WhenNonNullRevealAllNullable<TBearer>(ReadOnlySpan<char> fieldName, ReadOnlySpan<TBearer?> value
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) where TBearer : class, IStringBearer =>
        !stb.SkipFields & value is { Length: > 0 } ? AlwaysRevealAllNullable(fieldName, value, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt  WhenNonNullAddAll(string fieldName, bool[]? value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) => 
        !stb.SkipFields && value != null ? AlwaysAddAll(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt  WhenNonNullRevealAll<TBearer>(string fieldName, TBearer?[]? value
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags)
        ...
        !stb.SkipFields && value != null ? AlwaysRevealAll(fieldName, value, formatFlags) : stb.StyleTypeBuilder;
    ...
    (string fieldName, TCharSeq?[]? value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) where TCharSeq : ICharSequence =>
        !stb.SkipFields && value != null ? AlwaysAddAllCharSeq(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;
    ...
    (string fieldName, TAny?[]? value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) =>
        !stb.SkipFields && value != null ? AlwaysAddAllMatch(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;
    ...
    public TExt WhenNonNullAddAllObject(string fieldName, IReadOnlyList<object?>? value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) => WhenNonNullAddAllMatch(fieldName, value, formatString, formatFlags);
    ...
    public TExt  WhenNonNullRevealAllEnumerate<TCloaked>
        (string fieldName, IEnumerable<TCloaked?>? value, PalantírReveal<TCloaked> palantírReveal
        , FieldContentHandling formatFlags = DefaultCallerTypeFlags) where TCloaked : struct =>
        !stb.SkipFields && value != null ? AlwaysRevealAllEnumerate(fieldName, value, palantírReveal, formatFlags) : stb.StyleTypeBuilder;

    public TExt  WhenNonNullRevealAllEnumerate<TBearer>(string fieldName, IEnumerable<TBearer?>? value
    , FieldContentHandling formatFlags = DefaultCallerTypeFlags)
        where TBearer : IStringBearer  => 
        !stb.SkipFields && value != null ? AlwaysRevealAllEnumerate(fieldName, value, formatFlags) : stb.StyleTypeBuilder;
    ...
    (string fieldName, IEnumerable<TCharSeq?>? value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) where TCharSeq : ICharSequence =>
        !stb.SkipFields && value != null ? AlwaysAddAllCharSeqEnumerate(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;
    ...
    (string fieldName, IEnumerable<TAny?>? value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null
      , FieldContentHandling formatFlags = DefaultCallerTypeFlags) =>
        !stb.SkipFields && value != null ? AlwaysAddAllMatchEnumerate(fieldName, value, formatString, formatFlags) : stb.StyleTypeBuilder;
