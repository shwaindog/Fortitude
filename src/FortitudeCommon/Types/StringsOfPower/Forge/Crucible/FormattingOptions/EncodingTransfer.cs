...
public interface IEncodingTransfer
{
    ...
    int Transfer(ICustomStringFormatter stringFormatter, ReadOnlySpan<char> source, int sourceFrom, IStringBuilder destSb, int destStartIndex = int.MaxValue
      , int maxTransferCount = int.MaxValue);
    ...
    int Transfer(ICustomStringFormatter stringFormatter, StringBuilder source, Span<char> destSpan, int destStartIndex, int maxTransferCount = int.MaxValue);

    int Transfer(ICustomStringFormatter stringFormatter, StringBuilder source, int sourceFrom, IStringBuilder destSbb, int destStartIndex = int.MaxValue
      , int maxTransferCount = int.MaxValue);
    ...
    int Transfer(ICustomStringFormatter stringFormatter, ICharSequence source, Span<char> destSpan, int destStartIndex, int maxTransferCount = int.MaxValue);
