...
public static class SimpleOrderedCollectionGenericAddAllInvoker
{
    ...
    private const string AddAllStyledMethodName                = $"{nameof(SimpleOrderedCollectionBuilder.AddAllStyled)}";
    private const string AddAllStyledEnumerateMethodName       = $"{nameof(SimpleOrderedCollectionBuilder.AddAllStyledEnumerate)}";
    private const string AddAllMatchMethodName                 = $"{nameof(SimpleOrderedCollectionBuilder.AddAllMatch)}";
    private const string AddAllMatchEnumerateMethodName        = $"{nameof(SimpleOrderedCollectionBuilder.AddAllMatchEnumerate)}";
    ...
    private static readonly Type SimpleOrderedCollectionBuilderType = typeof(SimpleOrderedCollectionBuilder);

    private static readonly Type BoolType                 = typeof(bool);
    private static readonly Type StringType               = typeof(string);
    private static readonly Type CharSequenceType         = typeof(ICharSequence);
    private static readonly Type StyledToStringObjectType = typeof(IStyledToStringObject);
    private static readonly Type StringBuilderType        = typeof(StringBuilder);
    private static readonly Type Func4TypesType           = typeof(Func<,,,>);
    ...
    static SimpleOrderedCollectionGenericAddAllInvoker()
    {
        ...
        StyledToStringObjArrayAddAll       = GetStyledArrayAddAllMethodInfo(pubMethods);
        ...
        StyledToStringObjReadOnlyListAddAll       = GetStyledReadOnlyListAddAllMethodInfo(pubMethods);
        ...
        StyledToStringObjEnumerableAddAll       = GetStyledEnumerableAddAllMethodInfo(pubMethods);
        ...
        StyledToStringObjEnumeratorAddAll       = GetStyledEnumeratorAddAllMethodInfo(pubMethods);
    ...
    public static void CallAddAll<TOrdColl, TItem>(SimpleOrderedCollectionBuilder builder, TOrdColl keyColl, string? valueFormatString = null)
    ...
    public static void CallAddAllEnumerator<TKeyColl, TItem>(
        SimpleOrderedCollectionBuilder builder, TKeyColl keyColl, string? valueFormatString = null)
    ...
    private static SimpleOrderedCollectionBuilder NoOpNotASupportedOrderedCollection<T>(SimpleOrderedCollectionBuilder toReturn, T _, string? _1
      , string? _2)
    {
    ...
    private static MethodInfo GetStyledArrayAddAllMethodInfo(MethodInfo[] allPubMethods)
    {
        MethodInfo? foundMatch = null;
        for (var i = 0; i < allPubMethods.Length; i++)
        {
            ...
            if (genericParams.Length != 1) continue;
            var genericParam = genericParams[0];
            if (!genericParam.Derives(StyledToStringObjectType)) continue;
            var methodParams = mi.GetParameters();
            if (methodParams.Length != 1) continue;
            var methParam1Type = methodParams[0].ParameterType;
            if (!methParam1Type.IsArrayOf(genericParam)) continue;
    ...
    private static MethodInfo GetStyledReadOnlyListAddAllMethodInfo(MethodInfo[] allPubMethods)
    {
        MethodInfo? foundMatch = null;
        for (var i = 0; i < allPubMethods.Length; i++)
        {
    ...
    private static MethodInfo GetStyledEnumerableAddAllMethodInfo(MethodInfo[] allPubMethods)
    {
        MethodInfo? foundMatch = null;
        for (var i = 0; i < allPubMethods.Length; i++)
        {
    ...
    private static MethodInfo GetStyledEnumeratorAddAllMethodInfo(MethodInfo[] allPubMethods)
    {
        MethodInfo? foundMatch = null;
        for (var i = 0; i < allPubMethods.Length; i++)
        {
    ...
    public static Delegate CreateInvokeMethod(Type keyedCollType)
    {
        ...
        if (selectedMethodInfo == null)
        {
            ...
            var noOpInvokerType = Func4TypesType.MakeGenericType
                (SimpleOrderedCollectionBuilderType, keyedCollType, StringType, SimpleOrderedCollectionBuilderType);
    ...
    public static Delegate GetAddAllInvoker(Type keyValueCollectionBuilder, Type collectionToAdd, MethodInfo methodToCall, Type invokerFunc)
    {
        var helperMethod =
            new DynamicMethod($"{keyValueCollectionBuilder.Name}_{collectionToAdd.Name}_AddAll", keyValueCollectionBuilder,
                              [keyValueCollectionBuilder, collectionToAdd, StringType], keyValueCollectionBuilder.Module, true);
    ...
    public static Func<SimpleOrderedCollectionBuilder, TOrdColl, string?, SimpleOrderedCollectionBuilder>
        GetNonVirtualDispatchStyledToString<TOrdColl>(
            MethodInfo methodToCall)
    {
        var methodInvoker
            = (Func<SimpleOrderedCollectionBuilder, TOrdColl, string?, SimpleOrderedCollectionBuilder>)
            GetAddAllInvoker(SimpleOrderedCollectionBuilderType, typeof(TOrdColl), methodToCall
                           , typeof(Func<SimpleOrderedCollectionBuilder, TOrdColl, string?, SimpleOrderedCollectionBuilder>));
        return methodInvoker;
    }
}
