...
public partial class SelectTypeField<TExt> where TExt : StyledTypeBuilder
{
    ...
    (string fieldName, bool value, bool defaultValue = false
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null) =>
        !stb.SkipBody && value != defaultValue ? AlwaysAdd(fieldName, value) : stb.StyleTypeBuilder;
    ...
    (string fieldName, TToStyle value
      , CustomTypeStyler<TStylerType> customTypeStyler, TToStyle? defaultValue = default) where TToStyle : TStylerType =>
        !stb.SkipBody && !Equals(value, defaultValue) ? AlwaysAdd(fieldName, value, customTypeStyler) : stb.StyleTypeBuilder;

    public TExt WhenNonDefaultAdd
    (string fieldName, ReadOnlySpan<char> value
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null) =>
        !stb.SkipBody && value.Length > 0 ? AlwaysAdd(fieldName, value, formatString) : stb.StyleTypeBuilder;

    public TExt WhenNonDefaultAdd
    (string fieldName, string value, string defaultValue = ""
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? formatString = null) =>
        !stb.SkipBody && value != defaultValue ? AlwaysAdd(fieldName, value, formatString) : stb.StyleTypeBuilder;
    ...
    public TExt WhenNonDefaultAdd(string fieldName, string value, int startIndex, int length = int.MaxValue, string? formatString = null) =>
        !stb.SkipBody && length > 0 ? AlwaysAdd(fieldName, value, startIndex, length, formatString) : stb.StyleTypeBuilder;

    public TExt WhenNonDefaultAdd(string fieldName, char[] value) =>
        !stb.SkipBody && value.Length > 0 ? AlwaysAdd(fieldName, value) : stb.StyleTypeBuilder;
    ...
    public TExt WhenNonDefaultAdd(string fieldName, ICharSequence value, string defaultValue = "") =>
        !stb.SkipBody && !value.Equals(defaultValue) ? AlwaysAdd(fieldName, value) : stb.StyleTypeBuilder;
    ...
    public TExt WhenNonDefaultAdd(string fieldName, ICharSequence value, int startIndex, int count = int.MaxValue, string? formatString = null
      , string defaultValue = "") =>
        !stb.SkipBody && !value.Equals(defaultValue) ? AlwaysAdd(fieldName, value, startIndex, count, formatString) : stb.StyleTypeBuilder;
    ...
    public TExt WhenNonDefaultAddMatch<T>(string fieldName, T? value, T? defaultValue = default, string? formatString = null)  =>
        !stb.SkipBody && !(value?.Equals(defaultValue) ?? defaultValue?.Equals(value) ?? true) ? AlwaysAddMatch(fieldName, value, formatString) : stb.StyleTypeBuilder;

    [CallsObjectToString]
    public TExt WhenNonDefaultAddObject(string fieldName, object? value, object? defaultValue = null, string? formatString = null) =>
        !stb.SkipBody && !(value?.Equals(defaultValue) ?? defaultValue?.Equals(value) ?? true) ? AlwaysAddObject(fieldName, value, formatString) : stb.StyleTypeBuilder;
