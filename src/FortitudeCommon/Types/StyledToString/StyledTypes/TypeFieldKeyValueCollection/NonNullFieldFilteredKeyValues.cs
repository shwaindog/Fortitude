...
public partial class SelectTypeKeyValueCollectionField<TExt> where TExt : StyledTypeBuilder
{
    ...
    (string fieldName, IEnumerable<KeyValuePair<TKey, TValue>>? value
      ...
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? keyFormatString = null) 
        where TValue : struct =>
        value != null ?  AlwaysAddFilteredEnumerate(fieldName, value, filterPredicate, valueStructStyler, keyFormatString) : stb.StyleTypeBuilder;
    ...
    (string fieldName, IEnumerable<KeyValuePair<TKey, TValue>>? value
      ...
      , StructStyler<TKey> keyStructStyler) 
        where TKey : struct where TValue : struct =>
        value != null ?  AlwaysAddFilteredEnumerate(fieldName, value, filterPredicate, valueStructStyler, keyStructStyler) : stb.StyleTypeBuilder;
