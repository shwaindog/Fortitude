...
public partial class SelectTypeKeyValueCollectionField<TExt> where TExt : StyledTypeBuilder
{
    ...
    public TExt AddWhenNonNullApplyFilter<TKey, TValue>
    (string fieldName, ConcurrentDictionary<TKey, TValue>? value
      , KeyValuePredicate<TKey, TValue> filterPredicate
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? valueFormatString = null
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? keyFormatString = null)
        where TKey : notnull =>
        value != null ?  AddAlwaysApplyFilter(fieldName, value, filterPredicate, valueFormatString, keyFormatString) : stb.StyleTypeBuilder;
    ...
    (string fieldName, ConcurrentDictionary<TKey, TValue>? value
      ...
      , [StringSyntax(StringSyntaxAttribute.CompositeFormat)] string? keyFormatString = null)
        ...
        value != null ?  AddAlwaysApplyFilter(fieldName, value, filterPredicate, valueStructStyler, keyFormatString) : stb.StyleTypeBuilder;
    ...
    (string fieldName, ConcurrentDictionary<TKey, TValue>? value
      ...
      , StructStyler<TKey> keyStructStyler)
        ...
        value != null ?  AddAlwaysApplyFilter(fieldName, value, filterPredicate, valueStructStyler, keyStructStyler) : stb.StyleTypeBuilder;
