...
public static class KeyedCollectionGenericAddAllInvoker
{
    ...
    private const string AddAllMethodName = $"{nameof(KeyValueCollectionBuilder.AddAll)}";

    private const string AddAllEnumerateMethodName = $"{nameof(KeyValueCollectionBuilder.AddAllEnumerate)}";
    ...
    private static readonly Type KeyValueCollectionBuilderType = typeof(KeyValueCollectionBuilder);
    ...
    public static void CallAddAll<TKeyColl, TKey, TValue>(KeyValueCollectionBuilder builder, TKeyColl keyColl, string? valueFormatString = null)
        where TKeyColl : IEnumerable<KeyValuePair<TKey, TValue>>
    {
        var keyedCollType = keyColl!.GetType();
        var callBaseToString = (Func<KeyValueCollectionBuilder, TKeyColl, string?, string?, KeyValueCollectionBuilder>)
            KeyedCollAddAllInvokers.GetOrAdd(keyedCollType, CreateInvokeMethod);

        callBaseToString(builder, keyColl, valueFormatString, null);
    }

    public static void CallAddAllEnumerate<TKeyColl, TKey, TValue>(KeyValueCollectionBuilder builder, TKeyColl keyColl, string? valueFormatString = null)
    ...
    public static void CallAddAll<TKeyColl>(KeyValueCollectionBuilder builder, TKeyColl keyColl, string? valueFormatString = null)
    {
        var keyedCollType = keyColl!.GetType();
    ...
    private static KeyValueCollectionBuilder NoOpNotASupportedKeyedCollection<T>(KeyValueCollectionBuilder toReturn, T _ , string? _1, string? _2)
    {
    ...
    public static Func<KeyValueCollectionBuilder, T, string?, string?, KeyValueCollectionBuilder> GetNonVirtualDispatchStyledToString<T>(
        MethodInfo methodToCall)
    {
        var methodInvoker
            = (Func<KeyValueCollectionBuilder, T, string?, string?, KeyValueCollectionBuilder>)
            GetAddAllInvoker(KeyValueCollectionBuilderType, typeof(T), methodToCall
                           , typeof(Func<KeyValueCollectionBuilder, T, string?, string?, KeyValueCollectionBuilder>));
        return methodInvoker;
    }
}
