...
namespace FortitudeIO.Topics.TopicRepository
{
    ...
    {
        private IRequestResponseResponderConversation requestResponseResponderConversation;
        private ConversationPulbisherAdapter conversationPulbisherAdapter;
        ...
        private class ConversationPulbisherAdapter : IConversationPublisher
        {
            ...
            public ConversationPulbisherAdapter(IRequestResponseResponderConversation requestResponseResponderConversation)
            {
                this.requestResponseResponderConversation = requestResponseResponderConversation;
            }
