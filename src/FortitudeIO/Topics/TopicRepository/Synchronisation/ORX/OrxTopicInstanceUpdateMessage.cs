...
namespace FortitudeIO.Topics.TopicRepository.ORX.Resolver
{
    public class OrxTopicInstanceUpdateMessage : OrxAuthenticatedMessage, ITopicInstanceUpdateMessage
    {
        ...
        public TopicUpdateType TopicUpdateType { get; set; }
        
        [OrxMandatoryField(11)]
        public EventType UpdateType { get; set; }

        [OrxMandatoryField(12)]
        public uint PostUpdateRegistryHash { get; set; }

        [OrxMandatoryField(13)]
        public uint HashingType { get; set; }

        [OrxMandatoryField(14)]
        public List<OrxTopicClientConnectionDetails> TopicsAffected { get; set; }
