...
namespace FortitudeIO.Protocols.Authentication
{
    ...
    public abstract class AuthenticatedMessage : VersionedMessage, IAuthenticatedMessage
    {
        ...
        protected AuthenticatedMessage(byte version, IMutableString senderName = null, DateTime? sendTime = null, IUserData userData = null, IMutableString info = null)
            : base(version)
        {
        ...
        {
            return base.Equals(other) && Equals(SenderName, other.SenderName) && 
