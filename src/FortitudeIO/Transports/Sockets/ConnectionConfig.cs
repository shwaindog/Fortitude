...
namespace FortitudeIO.Transports.Sockets
{
    ...
    {
        private ISubject<IConnectionUpdate> updateSubject;
        ...
        public ConnectionConfig(string connectionName, string hostname, int port, ConnectionDirectionType connectionDirectionType, 
        ...
        public IConnectionConfig Clone()
        {
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                hashCode = (hashCode * 397) ^ (fallbackConnectionConfig != null ? fallbackConnectionConfig.GetHashCode() : 0);
