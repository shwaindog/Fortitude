...
namespace FortitudeIO.Transports.NewSocketAPI.SocketFactory
{
    ...
    public class SocketConnectionConfig : ISocketReceiverConfig
    {
        public SocketConnectionConfig(string instanceName,
            ...
            MutableString socketDescription = null, int sendBufferSize = 0, int receiveBufferSize = 0, 
            MutableString hostname = null, IPAddress subnetMask = null, bool portIsDynamic = false, 
        ...
        {
            return $"SocketConnectionConfig ({nameof(SocketDescription)}: " +
