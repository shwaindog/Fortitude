...
namespace FortitudeMarketsApi.Monitoring.Logging
{
    public class NewOrderLog
    {
        ...
        public override string ToString()
        {
            ...
            if (displaySize > 0)
            {
                sb.Append("(").Append(displaySize).Append(")");
            }
            return sb.ToString();
        }
    }
    ...
    {
        private readonly ISpotOrder order;
        public AbortedOrderLog(ISpotOrder order)
        {
            this.order = order;
        }
    ...
    public class ExecutionLog
    {
        ...
        public ExecutionLog(IExecution execution)
        {
    ...
    {
        private readonly string id;
        public CancelOrderLog(IOrder order)
        {
            id = order.OrderId.VenueClientOrderId?.ToString();
        }
    ...
    {
        private readonly string id;
        public SuspendOrderLog(IOrder order)
        {
            id = order.OrderId.VenueClientOrderId?.ToString();
        }
    ...
    {
        private readonly string id;
        public ResumeOrderLog(IOrder order)
        {
            id = order.OrderId.VenueClientOrderId?.ToString();
        }
