...
namespace FortitudeMarketsApi.Pricing
{
    public static class QuoteExtensionMethods
    {
        ...
        public static string DiffQuotes(this ILevel0Quote q1, ILevel0Quote q2, bool exactValues = false)
        {
            ...
            ILevel1Quote l1q1 = q1 as ILevel1Quote;
            ILevel1Quote l1q2 = q2 as ILevel1Quote;
            ...
            ILevel2Quote l2q1 = q1 as ILevel2Quote;
            ILevel2Quote l2q2 = q2 as ILevel2Quote;
            ...
            ILevel3Quote l3q1 = q1 as ILevel3Quote;
            ILevel3Quote l3q2 = q2 as ILevel3Quote;
            ...
            Expression<Func<T, string>> property, bool makeThisCheck = true) where T : ILevel0Quote
        {
            ...
            string q1Value = evaluator(q1);
            string q2Value = evaluator(q2);
            if (makeThisCheck && q1Value != q2Value)
            {
                var propertyName = property.GetPropertyName();
                sb.AppendFormat($"{propertyName,PropertyNamePadding}:q1={(q1Value != null ? "\"" : "")}" +
                                $"{q1Value ?? "null"}{(q1Value != null ? "\"" : "")}\n")
                   .Insert(sb.Length, " ", secondLinePadding).AppendFormat($"q2={(q2Value != null ? "\"" : "")}" +
        ...
        {
            var evaluator = property.Compile();
            DateTime q1Value = evaluator(q1);
            DateTime q2Value = evaluator(q2);
            if (makeThisCheck && q1Value != q2Value)
            {
                var propertyName = property.GetPropertyName();
                sb.AppendFormat($"{propertyName,PropertyNamePadding}:q1={q1Value:O}\n")
                    .Insert(sb.Length, " ", secondLinePadding)
                    .AppendFormat($"q2={q2Value:O}\n");
            }
            return sb;
        }
        ...
        {
            var evaluator = property.Compile();
            decimal q1Value = evaluator(q1);
            decimal q2Value = evaluator(q2);
            if (makeThisCheck && q1Value != q2Value)
            {
                var propertyName = property.GetPropertyName();
                sb.AppendFormat($"{propertyName,PropertyNamePadding}:q1={q1Value:N5}\n")
                     .Insert(sb.Length, " ", secondLinePadding).AppendFormat($"q2={q2Value:N5}\n");
            }
            return sb;
        }
        ...
        {
            var evaluator = property.Compile();
            bool q1Value = evaluator(q1);
            bool q2Value = evaluator(q2);
            if (makeThisCheck && q1Value != q2Value)
            {
                var propertyName = property.GetPropertyName();
                sb.AppendFormat($"{propertyName,PropertyNamePadding}:q1={q1Value}\n")
                   .Insert(sb.Length, " ", secondLinePadding).AppendFormat($" q2={q2Value}\n");
            }
            return sb;
        }
            ...
            Expression<Func<T, ISourceTickerQuoteInfo>> property, bool exactValue = false) where T : ILevel0Quote
        {
            ...
            {
                sb.AppendFormat($"{propertyName,PropertyNamePadding}:q1={(q1Value != null ? "not null" : "null")}\n")
                   .Insert(sb.Length, " ", secondLinePadding)
                   .AppendFormat($"q2={(q2Value != null ? "not null" : "null")}\n");
            }
            bool areSame = false;
            if (q1Value != null && q1Value is IInterfacesComparable<IUniqueSourceTickerIdentifier> compareableQ1)
            {
                areSame = compareableQ1.AreEquivalent(q2Value, exactValue);
            } else if (q2Value is IInterfacesComparable<IUniqueSourceTickerIdentifier> compareableQ2)
            {
                areSame = compareableQ2.AreEquivalent(q1Value, exactValue);
            }
            if (!areSame)
            {
                sb.AppendFormat($"{propertyName,PropertyNamePadding}:q1=").Append(q1Value).Append("\n")
            ...
            Expression<Func<T, IPeriodSummary>> property, bool exactValue = false) where T : ILevel0Quote
        {
            ...
            bool areSame = false;
            if (q1Value != null && q1Value is IInterfacesComparable<IPeriodSummary> compareableQ1)
            {
                areSame = compareableQ1.AreEquivalent(q2Value, exactValue);
            }
            else if (q2Value is IInterfacesComparable<IPeriodSummary> compareableQ2)
            {
                areSame = compareableQ2.AreEquivalent(q1Value, exactValue);
            }
            if (!areSame)
            ...
            IPriceVolumeLayer l1, IPriceVolumeLayer l2)
        {
            if ((l1 == null && l2 != null) || (l1 != null && l2 == null) 
                || (l1 != null && !l1.Equals(l2) || !l2.Equals(l1)))
            {
                sb.AppendFormat($"{propertyName,PropertyNamePadding+ secondLineIndexAdditionalPadding}[{level,2}]:l1=")
        ...
        {
            if ((lt1 == null && lt2 != null) || (lt1 != null && lt2 == null) || (lt2 != null && (!lt1.Equals(lt2) 
                || !lt2.Equals(lt1))))
            {
                sb.AppendFormat($"{propertyName,PropertyNamePadding + secondLineIndexAdditionalPadding}[{level,2}]:" +
                                $"lt1={lt1?.ToString() ?? "null"}\n")
                     .Insert(sb.Length, " ", secondLinePadding).AppendFormat($"lt2={lt2?.ToString() ?? "null"}\n");
            }
            return sb;
        }
        ...
        {
            var evaluator = property.Compile();
            uint q1Value = evaluator(q1);
            uint q2Value = evaluator(q2);
            if (q1Value != q2Value)
            {
                var propertyName = property.GetPropertyName();
                sb.AppendFormat($"{propertyName,PropertyNamePadding}:q1={q1Value}\n")
