...
public static class RuleExtensions
{
    ...
    public static async ValueTask<ISubscription> RegisterListenerAsync<TPayload>(this IListeningRule rule, string publishAddress
        , Action<IBusMessage<TPayload>> handler)
    {
    ...
    public static async ValueTask<ISubscription> RegisterRequestListenerAsync<TPayload, TResponse>(this IListeningRule rule, string publishAddress
        , Func<IBusRespondingMessage<TPayload, TResponse>, ValueTask<TResponse>> handler)
    {
    ...
    public static async ValueTask<ISubscription> AddListenSubscribeInterceptor(this IRule sender, IListenSubscribeInterceptor interceptor
