...
public readonly struct DispatchOptions
{
    ...
    public DispatchOptions(RoutingFlags routingFlags
        ...
        , MessageQueueType targetMessageQueueType = MessageQueueType.All, IRule? targetRule = null, int timeoutMs = 60_000)
    {
    ...
    public bool Equals(DispatchOptions other) =>
        TargetMessageQueueType == other.TargetMessageQueueType && RoutingFlags == other.RoutingFlags &&
