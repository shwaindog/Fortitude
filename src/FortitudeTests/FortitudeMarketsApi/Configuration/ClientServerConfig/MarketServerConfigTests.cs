...
namespace FortitudeTests.FortitudeMarketsApi.Configuration.ClientServerConfig
{
    ...
    { 
        ...
        {
            public DummyMarketServerConfigClass(string name, MarketServerType marketServerType, IEnumerable<IConnectionConfig> serverConnections, 
                ITimeTable availabilityTimeTable, IObservable<IMarketServerConfigUpdate<IDummyMarketServerConfig>> repoUpdateStream = null) 
            ...
            public new IDummyMarketServerConfig Clone()
            {
                return new DummyMarketServerConfigClass(this);
            }
        ...
        public static IList<IDummyMarketServerConfig> ListOfSampleServerConfigs => new List<IDummyMarketServerConfig>
        {
        ...
        public static void UpdateServerConfigWithValues<T>(IMarketServerConfig<T> updateConfig, string name, MarketServerType marketServerType,
        ...
        public void InitializedServerConfig_NewConfigSameIdPushedThroughUpdateStream_UpdatesAllValues()
        {
            ...
            ISubject<IMarketServerConfigUpdate<IDummyMarketServerConfig>> updatePump = new Subject<IMarketServerConfigUpdate<IDummyMarketServerConfig>>();
            var updateAbleServerConfig = new DummyMarketServerConfigClass("OriginalServerName", MarketServerType.ConfigServer	,
            ...
            Assert.IsTrue(new[] { firstNewServerConnection, secondNewServerConnection }.SequenceEqual(updateAbleServerConfig.ServerConnections));
            ConnectionConfigTests.AssertIsExpected(updateAbleServerConfig.ServerConnections.First(),
                firstNewServerConnection.ConnectionName, firstNewServerConnection.Hostname, firstNewServerConnection.Port, firstNewServerConnection.ConnectionDirectionType,
            ...
            ConnectionConfigTests.AssertIsExpected(updateAbleServerConfig.ServerConnections.Last(),
                secondNewServerConnection.ConnectionName, secondNewServerConnection.Hostname, secondNewServerConnection.Port, secondNewServerConnection.ConnectionDirectionType,
