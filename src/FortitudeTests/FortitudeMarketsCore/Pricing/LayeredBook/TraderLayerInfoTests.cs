...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.LayeredBook
{
    ...
    {
        private TraderLayerInfo emptyTli;
        private TraderLayerInfo populatedTli;
            ...
            ILevel2Quote changingQuote = null)
        {
            ...
            if (originalTraderPriceVolumeLayer != null) Assert.IsFalse(
            ...
            if (originalTraderPriceVolumeLayer != null) Assert.IsTrue(
                originalTraderPriceVolumeLayer.AreEquivalent(changingTraderPriceVolumeLayer, exactComparison));
