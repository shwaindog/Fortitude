...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.LayeredBook
{
    ...
    {
        private SourceQuoteRefTraderValueDatePriceVolumeLayer emptyPvl;
        private SourceQuoteRefTraderValueDatePriceVolumeLayer populatedPvl;
        ...
        public void EmptyLayer_Mutate_UpdatesFields()
        {
            ...
            DateTime expectedValueDate = new DateTime(2018, 2, 10, 18, 0, 0);
            ...
            ILevel2Quote changingQuote = null)
        {
            ...
            if (originalOrderBook != null) Assert.IsFalse(
            ...
            if (originalOrderBook != null) Assert.IsFalse(
                originalOrderBook.AreEquivalent(changingOrderBook, exactComparison));
            if (originalQuote != null) Assert.IsFalse(
