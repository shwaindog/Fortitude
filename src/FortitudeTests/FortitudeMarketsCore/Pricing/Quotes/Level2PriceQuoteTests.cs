...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.Quotes
{
    ...
    public class Level2PriceQuoteTests
    {
        ...
        private Level2PriceQuote simpleEmptyLevel2Quote;
        private Level2PriceQuote simpleFullyPopulatedLevel2Quote;
        private Level2PriceQuote sourceNameEmptyLevel2Quote;
        private Level2PriceQuote sourceNameFullyPopulatedLevel2Quote;
        private Level2PriceQuote sourceQuoteRefEmptyLevel2Quote;
        private Level2PriceQuote sourceQuoteRefFullyPopulatedLevel2Quote;
        private Level2PriceQuote traderDetailsEmptyLevel2Quote;
        private Level2PriceQuote traderDetailsFullyPopulatedLevel2Quote;
        private Level2PriceQuote valueDateEmptyLevel2Quote;
        private Level2PriceQuote valueDateFullyPopulatedLevel2Quote;
        private Level2PriceQuote everyLayerEmptyLevel2Quote;
        private Level2PriceQuote everyLayerFullyPopulatedLevel2Quote;

        private IList<Level2PriceQuote> allFullyPopulatedQuotes;
        private IList<Level2PriceQuote> allEmptyQuotes;
        ...
        public void PopulatedQuote_GetHashCode_NotEqualToZero()
        {
            foreach (var populatedQuote in allFullyPopulatedQuotes)
            {
                Assert.AreNotEqual(0, populatedQuote.GetHashCode());
            }
        }
            ...
            IMutableLevel2Quote commonCompareQuote, IMutableLevel2Quote changingQuote)
        {
            ...
            OrderBookTests.AssertAreEquivalentMeetsExpectedExactComparisonType(exactComparison,
                commonCompareQuote.BidBook as OrderBook, changingQuote.BidBook as OrderBook,
                commonCompareQuote, changingQuote);

            OrderBookTests.AssertAreEquivalentMeetsExpectedExactComparisonType(exactComparison,
                commonCompareQuote.AskBook as OrderBook, changingQuote.AskBook as OrderBook,
                commonCompareQuote, changingQuote);
        }
