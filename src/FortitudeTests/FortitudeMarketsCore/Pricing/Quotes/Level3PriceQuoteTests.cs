...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.Quotes
{
    ...
    public class Level3PriceQuoteTests
    {
        ...
        private Level3PriceQuote noRecentlyTradedEmptyQuote;
        private Level3PriceQuote noRecentlyTradedFullyPopulatedQuote;
        private Level3PriceQuote simpleRecentlyTradedEmptyQuote;
        private Level3PriceQuote simpleRecentlyTradedFullyPopulatedQuote;
        private Level3PriceQuote paidGivenVolumeRecentlyTradedEmptyQuote;
        private Level3PriceQuote paidGivenVolumeRecentlyTradedFullyPopulatedQuote;
        private Level3PriceQuote traderPaidGivenVolumeRecentlyTradedEmptyQuote;
        private Level3PriceQuote traderPaidGivenVolumeRecentlyTradedFullyPopulatedQuote;

        private IList<Level3PriceQuote> allFullyPopulatedQuotes;
        private IList<Level3PriceQuote> allEmptyQuotes;
        ...
        public void NonRecentlyTraded_New_ConvertsToRecentlyTraded()
        {
            ...
            var convertedRecentlyTraded = new PQRecentlyTraded(new PQSourceTickerQuoteInfo(simpleRecentlyTradedSrcTkrQtInfo))
            {
                [0] = new PQLastTrade(12345m, new DateTime(2018, 3, 3, 10, 53, 41))
            };
            var expectedRecentlyTraded = new RecentlyTraded((IRecentlyTraded)convertedRecentlyTraded);
            var expectedBatchId = 234567u;
            var expectedSourceQuoteRef = 678123u;
            var expectedValueDate = new DateTime(2018, 3, 3, 10, 57, 23);
        ...
        public void PopulatedQuote_Mutate_UpdatesFields()
        {
            ...
            foreach (var emptyQuote in allEmptyQuotes)
            {
                ...
                if (expectedRecentlyTraded != null)
                {
                    expectedRecentlyTraded[0].TradePrice = 12345m;
                }
