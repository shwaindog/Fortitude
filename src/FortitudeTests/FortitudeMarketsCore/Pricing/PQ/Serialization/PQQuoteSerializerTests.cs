...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.Serialization
{
    ...
    {
        private ISourceTickerClientAndPublicationConfig level0QuoteInfo;
        private ISourceTickerClientAndPublicationConfig level1QuoteInfo;
        private ISourceTickerClientAndPublicationConfig valueDateQuoteInfo;
        private ISourceTickerClientAndPublicationConfig everyLayerQuoteInfo;
        private ISourceTickerClientAndPublicationConfig simpleNoRecentlyTradedQuoteInfo;
        private ISourceTickerClientAndPublicationConfig srcNmLstTrdQuoteInfo;
        private ISourceTickerClientAndPublicationConfig srcQtRfPdGvnVlmQuoteInfo;
        private ISourceTickerClientAndPublicationConfig trdrLyrTrdrPdGvnVlmDtlsQuoteInfo;
        private PQQuoteSerializer updateQuoteSerializer;
        private PQQuoteSerializer snapshotQuoteSerializer;
        private PQLevel0Quote level0Quote;
        private PQLevel1Quote level1Quote;
        private PQLevel2Quote valueDateL2Quote;
        private PQLevel2Quote everyLayerL2Quote;
        private PQLevel3Quote simpleNoRecentlyTradedL3Quote;
        private PQLevel3Quote srcNmSmplRctlyTrdedL3Quote;
        private PQLevel3Quote srcQtRefPdGvnVlmRcntlyTrdedL3Quote;
        private PQLevel3Quote trdrPdGvnVlmRcntlyTrdedL3Quote;
        ...
        private IReadOnlyList<IPQLevel0Quote> differingQuotes;
        ...
        private PQClientDecoder pqClientDecoder;
        private IMap<uint, IBinaryDeserializer> binaryDeserializers;
        ...
        public void SetUp()
        {
            ...
            srcNmLstTrdQuoteInfo = new SourceTickerClientAndPublicationConfig(4, 
                ...
                LastTradedFlags.LastTradedTime, null, retryWaitMs, allowCatchup);
            ...
            differingQuotes = new List<IPQLevel0Quote>
            {
                ...
                srcNmSmplRctlyTrdedL3Quote, srcQtRefPdGvnVlmRcntlyTrdedL3Quote,
                trdrPdGvnVlmRcntlyTrdedL3Quote
            };
            ...
            {
                { level0QuoteInfo.Id, new PQQuoteDeserializer<IPQLevel0Quote>(level0QuoteInfo) },
                { level1QuoteInfo.Id, new PQQuoteDeserializer<IPQLevel1Quote>(level1QuoteInfo) },
                { valueDateQuoteInfo.Id, new PQQuoteDeserializer<IPQLevel2Quote>(valueDateQuoteInfo) },
                { everyLayerQuoteInfo.Id, new PQQuoteDeserializer<IPQLevel2Quote>(everyLayerQuoteInfo) },
                {
                    simpleNoRecentlyTradedQuoteInfo.Id,
                    new PQQuoteDeserializer<IPQLevel3Quote>(simpleNoRecentlyTradedQuoteInfo) 
                },
                { srcNmLstTrdQuoteInfo.Id, new PQQuoteDeserializer<IPQLevel3Quote>(srcNmLstTrdQuoteInfo) },
                { srcQtRfPdGvnVlmQuoteInfo.Id, new PQQuoteDeserializer<IPQLevel3Quote>(srcQtRfPdGvnVlmQuoteInfo) },
                {
                    trdrLyrTrdrPdGvnVlmDtlsQuoteInfo.Id,
                    new PQQuoteDeserializer<IPQLevel3Quote>(trdrLyrTrdrPdGvnVlmDtlsQuoteInfo) 
                }
            };
        ...
        public void UpdateSerializerSaveToBuffer_Deserializer_CreatesEqualObjects()
        {
            foreach (var pqQuote in differingQuotes)
            {
                ...
                {
                    case IPQQuoteDeserializer<IPQLevel0Quote> pq0BinaryDeserializer:
                        clientSideQuote = pq0BinaryDeserializer.PublishedQuote;
                        break;
                    case IPQQuoteDeserializer<IPQLevel1Quote> pq1BinaryDeserializer:
                        clientSideQuote = pq1BinaryDeserializer.PublishedQuote;
                        break;
                    case IPQQuoteDeserializer<IPQLevel2Quote> pq2BinaryDeserializer:
                        clientSideQuote = pq2BinaryDeserializer.PublishedQuote;
                        break;
                    case IPQQuoteDeserializer<IPQLevel3Quote> pq3BinaryDeserializer:
            ...
            IPQLevel0Quote originalQuote)
        {
            fixed (byte* bufferPtr = readWriteBuffer.Buffer)
            {
                ...
                foreach (var stringUpdate in expectedStringUpdates)
                {
                    ...
                    var command = (flag & PQFieldFlags.IsUpdate) == PQFieldFlags.IsUpdate
                        ? CrudCommand.Update
                        : ((flag & PQFieldFlags.IsDelete) == PQFieldFlags.IsDelete
                            ? CrudCommand.None
                            : CrudCommand.Insert);
