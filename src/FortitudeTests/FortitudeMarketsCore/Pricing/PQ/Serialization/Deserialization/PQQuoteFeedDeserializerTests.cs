...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.Serialization.Deserialization
{
    ...
    {
        private PQQuoteFeedDeserializer<IPQLevel0Quote> pqLevel0QuoteDeserializer;
        private PQQuoteFeedDeserializer<IPQLevel1Quote> pqLevel1QuoteDeserializer;
        private PQQuoteFeedDeserializer<IPQLevel2Quote> pqLevel2QuoteDeserializer;
        private PQQuoteFeedDeserializer<IPQLevel3Quote> pqLevel3QuoteDeserializer;
        ...
        public void SetUp()
        {
            sourceTickerQuoteInfo = BuildSourceTickerQuoteInfo(unchecked((uint)(ushort.MaxValue << 16)), null);
        ...
        {
            return new SourceTickerClientAndPublicationConfig(sourceTickerId, "TestSource", ticker, 20, 
        ...
        private void SendsSequenceIdFromTo(int startId, int batchSize, bool expected)
        {
            ...
            foreach (var quoteBatch in quoteBatches)
            {
        ...
        private void FreshSerializerDeserializeGetsExpected(PQFeedType feedType)
        {
            ...
            var deserializeInputList = quoteDeserializerSequencedTestDataBuilder.BuildSerializeContextForQuotes(expectedQuotes, feedType, 0);
