...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.Serialization.Deserialization.SyncState
{
    ...
    public class DeserializeStateTransitionFactoryTests
    {
        ...
        private Mock<IPQQuoteDeserializer<IPQLevel0Quote>> deserialzer;

        private InitializationState<IPQLevel0Quote> initializationState;
        private DeserializeStateTransitionFactory<IPQLevel0Quote> deserializeStateTransitionFactory;

        [TestInitialize]
        public void SetUp()
        {
            deserialzer = new Mock<IPQQuoteDeserializer<IPQLevel0Quote>>();
            initializationState = new InitializationState<IPQLevel0Quote>(deserialzer.Object);
            deserializeStateTransitionFactory = new DeserializeStateTransitionFactory<IPQLevel0Quote>();
        }
