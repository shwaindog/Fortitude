...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.Serialization.Deserialization
{
    ...
    {
        private Mock<IMutableSourceTickerQuoteInfo> moqUniqueSrcTkrId;
        private Mock<IPQDeserializer> moqQuoteDeserializer;
        private DummyPQQuoateDeserializerBase<IPQLevel0Quote> dummyLevel0QuoteDeserializer;
        private DummyPQQuoateDeserializerBase<IPQLevel1Quote> dummyLevel1QuoteDeserializer;
        private DummyPQQuoateDeserializerBase<IPQLevel2Quote> dummyLevel2QuoteDeserializer;
        private DummyPQQuoateDeserializerBase<IPQLevel3Quote> dummyLevel3QuoteDeserializer;
        private IDisposable subscribedL0Observer;
        private IDisposable subscribedL1Observer;
        private IDisposable subscribedL2Observer;
        private IDisposable subscribedL3Observer;
        private Mock<IList<IObserver<IPQLevel0Quote>>> moqLevel0Subscribers;
        private Mock<IList<IObserver<IPQLevel1Quote>>> moqLevel1Subscribers;
        private Mock<IList<IObserver<IPQLevel2Quote>>> moqLevel2Subscribers;
        private Mock<IList<IObserver<IPQLevel3Quote>>> moqLevel3Subscribers;
        private Mock<IObserver<IPQLevel0Quote>> moqL0QObserver;
        private Mock<IObserver<IPQLevel1Quote>> moqL1QObserver;
        private Mock<IObserver<IPQLevel2Quote>> moqL2QObserver;
        private Mock<IObserver<IPQLevel3Quote>> moqL3QObserver;
        ...
        private Mock<ISyncLock> moqSyncLock;
        private Mock<IPerfLoggerPool> moqPerfLoggerPool;
        ...
        public void SetUp()
        {
            ...
            dispatchContext = new DispatchContext
            {
                ...
                DeserializerTimestamp = new DateTime(2017, 07, 01, 19, 03, 52),
        ...
        public void RegisteredCallback_InvokeOnReceivedUpdate_CallsCallback()
        {
            ...
            dummyLevel0QuoteDeserializer.ReceivedUpdate += deserializer => 
            {
                haveCalledPQLevel0QuoteCallback = true;
            };
            dummyLevel1QuoteDeserializer.ReceivedUpdate += deserializer => 
            {
                haveCalledPQLevel1QuoteCallback = true;
            };
            dummyLevel2QuoteDeserializer.ReceivedUpdate += deserializer => 
            {
                haveCalledPQLevel2QuoteCallback = true;
            };
            dummyLevel3QuoteDeserializer.ReceivedUpdate += deserializer => 
            {
                haveCalledPQLevel3QuoteCallback = true;
            };
        ...
        public void RegisteredCallback_InvokeOnSyncOk_CallsCallback()
        {
            ...
            var haveCalledPQLevel2QuoteCallback = false;
            var haveCalledPQLevel3QuoteCallback = false;
            dummyLevel0QuoteDeserializer.SyncOk += deserializer => 
            {
                haveCalledPQLevel0QuoteCallback = true;
            };
            dummyLevel1QuoteDeserializer.SyncOk += deserializer => 
            {
                haveCalledPQLevel1QuoteCallback = true;
            };
            dummyLevel2QuoteDeserializer.SyncOk += deserializer => 
            {
                haveCalledPQLevel2QuoteCallback = true;
            };
            dummyLevel3QuoteDeserializer.SyncOk += deserializer => 
            {
                haveCalledPQLevel3QuoteCallback = true;
            };
        ...
        public void RegisteredCallback_InvokeOnOutOfSync_CallsCallback()
        {
            ...
            var haveCalledPQLevel2QuoteCallback = false;
            var haveCalledPQLevel3QuoteCallback = false;
            dummyLevel0QuoteDeserializer.OutOfSync += deserializer => 
            {
                haveCalledPQLevel0QuoteCallback = true;
            };
            dummyLevel1QuoteDeserializer.OutOfSync += deserializer => 
            {
                haveCalledPQLevel1QuoteCallback = true;
            };
            dummyLevel2QuoteDeserializer.OutOfSync += deserializer => 
            {
                haveCalledPQLevel2QuoteCallback = true;
            };
            dummyLevel3QuoteDeserializer.OutOfSync += deserializer => 
            {
                haveCalledPQLevel3QuoteCallback = true;
            };
        ...
        public void EmptyQuoteLvl0Quote_UpdateQuote_SetsDispatcherContextDetails()
        {
            ...
            {
                SinglePrice = 0.78568m,
                SourceTime = new DateTime(2017, 07, 01, 19, 35, 00),
                IsReplay = true
            };
            ...
            Assert.AreEqual(dispatchContext.ReceivingTimestamp, actualL0Quote.SocketReceivingTime);
            Assert.AreEqual(dispatchContext.DeserializerTimestamp, actualL0Quote.ProcessedTime);
        ...
        public void EmptyQuoteLvl1Quote_UpdateQuote_SetsDispatcherContextDetails()
        {
            var expectedL1Quote = new PQLevel1Quote(sourceTickerQuoteInfo)
            {
                ...
                AdapterSentTime = new DateTime(2017, 07, 01, 19, 27, 39),
                BidPriceTop = 0.79324m,
                AskPriceTop = 0.79326m
            };
        ...
        public void EmptyQuoteLvl2Quote_UpdateQuote_SetsDispatcherContextDetails()
        {
            ...
            {
                expectedL2Quote.BidBook[i].Price = 0.791905m - 0.00001m * i;
                expectedL2Quote.BidBook[i].Volume = 30000 + 10000 * i;
                expectedL2Quote.AskBook[i].Price = 0.791906m + 0.00001m * i;
                expectedL2Quote.AskBook[i].Volume = 30000 + 10000 * i;
            }
            ...
            var expectedSequenceId = 102u;
            dispatchContext.MessageSize = amountWritten - MessageHeaderByteSize;
            dummyLevel0QuoteDeserializer.InvokeUpdateQuote(dispatchContext, actualL2Quote, expectedSequenceId);

            for (int i = 0; i < numLayers; i++)
            {
                Assert.AreEqual(expectedL2Quote.BidBook[i].Price, actualL2Quote.BidBook[i].Price);
                Assert.AreEqual(expectedL2Quote.BidBook[i].Volume, actualL2Quote.BidBook[i].Volume);
                Assert.AreEqual(expectedL2Quote.AskBook[i].Price, actualL2Quote.AskBook[i].Price);
                Assert.AreEqual(expectedL2Quote.AskBook[i].Volume, actualL2Quote.AskBook[i].Volume);
            }
        }
        ...
        public void EmptyQuoteLvl3Quote_UpdateQuote_SetsDispatcherContextDetails()
        {
            ...
            bool toggleGivenBool = false;
            bool togglePaidBool = true;
            for (int i = 0; i < deepestPossibleLayerIndex; i++)
            {
            ...
            var expectedSequenceId = 102u;
            dispatchContext.MessageSize = amountWritten - MessageHeaderByteSize;
            dummyLevel0QuoteDeserializer.InvokeUpdateQuote(dispatchContext, actualL3Quote, expectedSequenceId);

            for (int i = 0; i < deepestPossibleLayerIndex && i < PQFieldKeys.SingleByteFieldIdMaxPossibleLastTrades; i++)
            {
        ...
        public void SubscribedTickerQuoteHasChanges_PushQuoteToSubscribers_LatencyTraceSyncLocksUpdatedQuote()
        {
            ...
            try
            {
                ...
                moqUniqueSrcTkrId.As<ISourceTickerQuoteInfo>().Verify(usti => usti.Ticker, Times.Exactly(4));
                moqUniqueSrcTkrId.As<ISourceTickerQuoteInfo>().Verify(usti => usti.Source, Times.Exactly(4));
                ...
                moqPerfLogger.Verify(ltcsl => ltcsl.Enabled, Times.Exactly(8));
                moqUniqueSrcTkrId.As<ISourceTickerQuoteInfo>().Verify(usti => usti.Ticker, Times.Exactly(8));
                moqUniqueSrcTkrId.As<ISourceTickerQuoteInfo>().Verify(usti => usti.Source, Times.Exactly(8));
                moqPerfLogger.Verify(ltcsl => ltcsl.Add("Ticker", expectedTicker), Times.Exactly(4));
                moqPerfLogger.Verify(ltcsl => ltcsl.Add("Source", expectedSource), Times.Exactly(4));
        ...
        private class DummyPQQuoateDeserializerBase<T> : PQDeserializerBase<T> where T : class, IPQLevel0Quote
        {
            ...
            public void InvokeUpdateQuote(DispatchContext dispatchContext, T ent, uint sequenceId)
            {
                UpdateQuote(dispatchContext, ent, sequenceId);
            }
