...
public class WeeklyLevel2QuoteTimeSeriesFileTests
{
    ...
    private IReaderFileSession<DailyToOneHourPQLevel2QuoteSubBuckets<ILevel2Quote>, ILevel2Quote>? level2SessionReader;
    private IWriterFileSession<DailyToOneHourPQLevel2QuoteSubBuckets<ILevel2Quote>, ILevel2Quote>  level2SessionWriter = null!;
    ...
    public void Setup()
    {
        ...
        level2SrcTkrQtInfo =
            new SourceTickerQuoteInfo
                (19, "WeeklyLevel2QuoteTimeSeriesFileTests", 79, "PersistTest",
    ...
    private void CreateLevel2File(FileFlags fileFlags = FileFlags.WriterOpened | FileFlags.HasInternalIndexInHeader)
    {
        ...
        var createTestCreateFileParameters =
            new CreateFileParameters
                (testFileNameResolver, "TestInstrumentName", "TestSourceName",
                 TimeSeriesPeriod.OneWeek, DateTime.UtcNow.Date, TimeSeriesEntryType.Price, 7,
                 fileFlags, 6, category: "TestInstrumentCategory");
        var createPriceQuoteFile = new PriceQuoteCreateFileParameters(level2SrcTkrQtInfo, createTestCreateFileParameters);
    ...
    [TestMethod]
    public void CreateNewPriceQuote_TwoSmallPeriods_OriginalValuesAreReturned()
    {
        CreateLevel2File();
    ...
    [TestMethod]
    public void CreateNewPQPriceQuote_TwoSmallPeriods_OriginalValuesAreReturned()
    {
        CreateLevel2File();
    ...
    [TestMethod]
    public void CreateNewPriceQuote_TwoSmallCompressedPeriods_OriginalValuesAreReturned()
    {
    ...
    [TestMethod]
    public void CreateNewPQPriceQuote_TwoSmallCompressedPeriods_OriginalValuesAreReturned()
    {
        CreateLevel2File(FileFlags.WriteDataCompressed);
        CreateNewTyped_TwoSmallPeriods_OriginalValuesAreReturned(pqLevel2QuoteGenerator, asPQLevel2QuoteFactory);
    }
        ...
        where TEntry : class, IMutableLevel2Quote, ILevel2Quote
    {
        var toPersistAndCheck
            = GenerateRepeatableL1QuoteStructs<ILevel2Quote, TEntry>
    ...
    {
        var toPersistAndCheck =
            GenerateForEachDayAndHourOfCurrentWeek<ILevel2Quote, TEntry>
    ...
    public void CreateNewFile_SetLargeStringsWhichAreTruncated_CloseReopenSafelyReturnsTruncatedStrings()
    {
        ...
        Assert.AreEqual(typeof(DailyToOneHourPQLevel2QuoteSubBuckets<ILevel2Quote>), header.BucketType);
    ...
    {
        CreateLevel2File();
        Assert.AreEqual(TimeSeriesEntryType.Price, level2OneWeekFile.TimeSeriesEntryType);
        var singleQuoteMiddleOfWeek
            = GenerateRepeatableL1QuoteStructs<ILevel2Quote, Level2PriceQuote>
