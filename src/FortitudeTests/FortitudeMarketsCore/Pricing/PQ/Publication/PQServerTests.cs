...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.Publication
{
    ...
    public class PQServerTests
    {
        ...
        private Mock<IPQServerHeartBeatSender> moqHeartBeatSender;
        private Mock<IPQSnapshotServer> moqSnapshotService;
        private Mock<IPQSnapshotStreamSubscriber> moqSnapshotStreamSubscriber;
        private Mock<IPQUpdateServer> moqUpdateService;
        private Mock<ISocketSubscriber> moqUpdateStreamSubscriber;
        ...
        private Mock<ISocketDispatcherListener> moqSocketDispatcherListener;
        private Mock<ISocketDispatcherSender> moqSocketDispatcherSender;
        private Mock<ISocketDispatcher> moqSocketDispatcher;
        private SourceTickerPublicationConfigRepository sourceTickerPublicationConfigs;
        private SourceTickerPublicationConfig sourceTickerQuoteInfo1;
        private SourceTickerPublicationConfig sourceTickerQuoteInfo2;
        private SourceTickerPublicationConfig sourceTickerQuoteInfo3;
        ...
        public void Setup(LayerFlags layerDetails, LastTradedFlags lastTradedFlags = LastTradedFlags.None)
        {
            sourceTickerQuoteInfo1 =
                new SourceTickerPublicationConfig(
                    ...
                    ExchangeName, TestTicker1, 20, 0.00001m, 0.1m, 100, 0.1m, 250, layerDetails, lastTradedFlags, null);
            sourceTickerQuoteInfo2 =
                new SourceTickerPublicationConfig(
                    UniqueSourceTickerIdentifier.GenerateUniqueSourceTickerId(ExchangeId, TickerId2),
                    ExchangeName, TestTicker2, 20, 0.00001m, 0.1m, 100, 0.1m, 250, layerDetails, lastTradedFlags, null);
            sourceTickerQuoteInfo3 =
                new SourceTickerPublicationConfig(
                    UniqueSourceTickerIdentifier.GenerateUniqueSourceTickerId(ExchangeId, TickerId3),
                    ExchangeName, TestTicker3, 20, 0.00001m, 0.1m, 100, 0.1m, 250, layerDetails, lastTradedFlags, null);
            ...
            moqSnapshotStreamSubscriber.SetupProperty(
        ...
        public void AlreadyStartedPQServer_StartServices_IgnoresRequest()
        {
            ...
            moqSnapshotStreamSubscriber.VerifySet(
        ...
        public void RegisteredPQServer_Publish_ProtectsUpdatesToQuoteBehindQuoteSyncLock()
        {
            ...
            {
                SourceTickerQuoteInfo = sourceTickerQuoteInfo1,
                HasUpdates = true
            };
        ...
        public void StartedRegisteredPQServer_SnapshotRequestReceived_SendsSnapshotsForEachIdRequested()
        {
            ...
            moqSnapshotStreamSubscriber.Verify();
            moqSnapshotStreamSubscriber.Object.OnSnapshotRequest(moqSocketSessionConnection.Object,
