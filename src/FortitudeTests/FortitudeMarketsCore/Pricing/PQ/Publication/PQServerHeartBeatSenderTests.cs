...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.Publication
{
    ...
    public class PQServerHeartBeatSenderTests
    {
        ...
        private Mock<IOSParallelController> moqOsParallelController;
        private Mock<IOSThread> moqOsThread;
        private Mock<IPQUpdateServer> moqUpdateServer;
        private Mock<ISyncLock> moqSyncLock;
        private Mock<IDoublyLinkedList<IPQLevel0Quote>> moqQuotesList;
        private PQServerHeartBeatSender pqServerHeartBeatSender;
        private PQLevel0QuoteTests.DummyPQLevel0Quote level0Quote1;
        private PQLevel0QuoteTests.DummyPQLevel0Quote level0Quote2;
        private PQLevel0QuoteTests.DummyPQLevel0Quote level0Quote3;
        ...
        public void SetUp()
        {
            ...
            {
                UpdateServer = moqUpdateServer.Object,
                ServerLinkedLock = moqSyncLock.Object,
