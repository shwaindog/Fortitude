...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.Quotes
{
    ...
    public class PQLevel1QuoteTests
    {
        ...
        private PQLevel1Quote emptyQuote;
        private PQLevel1Quote fullyPopulatedPqLevel1Quote;
        ...
        public void EmptyQuote_SourceAskTimeChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            ...
            PQFieldUpdate expectedSubHour = new PQFieldUpdate(PQFieldKeys.SourceAskSubHourTime, subHourComponent, 15);
        ...
        public void EmptyQuote_SourceBidTimeChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            ...
            PQFieldUpdate expectedSubHour = new PQFieldUpdate(PQFieldKeys.SourceBidSubHourTime, subHourComponent, 15);
        ...
        public void EmptyQuote_AdapterSentTimeChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            ...
            PQFieldUpdate expectedSubHour = new PQFieldUpdate(PQFieldKeys.AdapterSentSubHourTime, lowerBytes, 
                subHourComponent);
        ...
        public void EmptyQuote_AdapterReceivedTimeChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            ...
            PQFieldUpdate expectedSubHour = new PQFieldUpdate(PQFieldKeys.AdapterReceivedSubHourTime, subHourComponent, 15);
        ...
        public void EmptyQuote_BidPriceTopChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.BidAskTopOfBookPrice, expectedBidPriceTop, 1);
        ...
        public void EmptyQuote_AskPriceTopChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            var sourceUpdates = emptyQuote.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates).ToList();
            Assert.AreEqual(3, sourceUpdates.Count);
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.BidAskTopOfBookPrice, expectedAskPriceTop,
        ...
        public void EmptyQuote_ExecutableChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            var sourceUpdates = emptyQuote.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates).ToList();
            Assert.AreEqual(3, sourceUpdates.Count);
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.QuoteBooleanFlags, 0);
            Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
            ...
            PQLevel1Quote l1Q, uint expectedBooleanFlags = 3)
        {
            ...
            byte flag = l1Q.SourceBidTime.GetSubHourComponent().BreakLongToByteAndUint(out var value);
        ...
        internal class DummyLevel1Quote : PQLevel0QuoteTests.DummyPQLevel0Quote, IPQLevel1Quote
        {
            ...
            {
                get => PeriodSummary;
                set => PeriodSummary = (IPQPeriodSummary) value;
            }
            ...
            IMutableLevel1Quote IMutableLevel1Quote.Clone() { return (IMutableLevel1Quote)Clone(); }
            IPQLevel1Quote IPQLevel1Quote.Clone() { return null; }
            ILevel1Quote ILevel1Quote.Clone() { return this; }
            ILevel1Quote ICloneable<ILevel1Quote>.Clone() { return this; }
