...
using FortitudeTests.FortitudeMarketsCore.Pricing.PQ.LayeredBook;
...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.Quotes
{
    ...
    {
        private ISourceTickerQuoteInfo simpleSourceTickerQuoteInfo;
        private ISourceTickerQuoteInfo sourceNameSourceTickerQuoteInfo;
        private ISourceTickerQuoteInfo sourceQuoteRefSourceTickerQuoteInfo;
        private ISourceTickerQuoteInfo traderDetailsSourceTickerQuoteInfo;
        private ISourceTickerQuoteInfo valueDateSourceTickerQuoteInfo;
        private ISourceTickerQuoteInfo everyLayerSourceTickerQuoteInfo;
        private PQLevel2Quote simpleEmptyLevel2Quote;
        private PQLevel2Quote simpleFullyPopulatedLevel2Quote;
        private PQLevel2Quote sourceNameEmptyLevel2Quote;
        private PQLevel2Quote sourceNameFullyPopulatedLevel2Quote;
        private PQLevel2Quote sourceQuoteRefEmptyLevel2Quote;
        private PQLevel2Quote sourceQuoteRefFullyPopulatedLevel2Quote;
        private PQLevel2Quote traderDetailsEmptyLevel2Quote;
        private PQLevel2Quote traderDetailsFullyPopulatedLevel2Quote;
        private PQLevel2Quote valueDateEmptyLevel2Quote;
        private PQLevel2Quote valueDateFullyPopulatedLevel2Quote;
        private PQLevel2Quote everyLayerEmptyLevel2Quote;
        private PQLevel2Quote everyLayerFullyPopulatedLevel2Quote;

        private IList<PQLevel2Quote> allFullyPopulatedQuotes;
        private IList<PQLevel2Quote> allEmptyQuotes;
        ...
        public void SetUp()
        {
            ...
            simpleSourceTickerQuoteInfo = new SourceTickerClientAndPublicationConfig(uint.MaxValue, "TestSource",
                ...
                LastTradedFlags.LastTradedVolume | LastTradedFlags.LastTradedTime, null, retryWaitMs, allowCatchup);
            sourceNameSourceTickerQuoteInfo = new SourceTickerClientAndPublicationConfig(uint.MaxValue, "TestSource",
                "TestTicker", 20, 0.00001m, 30000m, 50000000m, 1000m, 1,
                LayerFlags.Volume | LayerFlags.Price | LayerFlags.SourceName, LastTradedFlags.PaidOrGiven | 
                LastTradedFlags.TraderName | LastTradedFlags.LastTradedVolume | LastTradedFlags.LastTradedTime, null, 
                retryWaitMs, allowCatchup);
            sourceQuoteRefSourceTickerQuoteInfo = new SourceTickerClientAndPublicationConfig(uint.MaxValue, 
                ...
                LastTradedFlags.TraderName | LastTradedFlags.LastTradedVolume | LastTradedFlags.LastTradedTime, null, 
                retryWaitMs, allowCatchup);
            traderDetailsSourceTickerQuoteInfo = new SourceTickerClientAndPublicationConfig(uint.MaxValue, 
                "TestSource", "TestTicker", 20, 0.00001m, 30000m, 50000000m, 1000m, 1,
                LayerFlags.Volume | LayerFlags.Price | LayerFlags.TraderName | LayerFlags.TraderSize | 
                LayerFlags.TraderCount, LastTradedFlags.PaidOrGiven | LastTradedFlags.TraderName | 
                LastTradedFlags.LastTradedVolume | LastTradedFlags.LastTradedTime, null, retryWaitMs, allowCatchup);
            valueDateSourceTickerQuoteInfo = new SourceTickerClientAndPublicationConfig(uint.MaxValue, "TestSource",
                "TestTicker", 20, 0.00001m, 30000m, 50000000m, 1000m, 1,
                LayerFlags.Volume | LayerFlags.Price | LayerFlags.ValueDate, LastTradedFlags.PaidOrGiven |
                LastTradedFlags.TraderName | LastTradedFlags.LastTradedVolume | LastTradedFlags.LastTradedTime, null, 
                retryWaitMs, allowCatchup);
            everyLayerSourceTickerQuoteInfo = new SourceTickerClientAndPublicationConfig(uint.MaxValue, "TestSource",
                "TestTicker", 20, 0.00001m, 30000m, 50000000m, 1000m, 1,
            ...
            {
                simpleEmptyLevel2Quote, sourceNameEmptyLevel2Quote,
                sourceQuoteRefEmptyLevel2Quote, traderDetailsEmptyLevel2Quote,
                valueDateEmptyLevel2Quote, everyLayerEmptyLevel2Quote
            };
        ...
        {
            var tooLargeMaxDepth = new SourceTickerClientAndPublicationConfig(uint.MaxValue, "TestSource",
        ...
        public void AllLevel2QuoteTypes_LayerPriceChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            foreach (var emptyQuote in allEmptyQuotes)
            {
                foreach (var priceVolumeLayer in emptyQuote.AskBook.AllLayers.Concat(emptyQuote.BidBook))
                {
                    ...
                    bool isBid = emptyQuote.BidBook.AllLayers.Any(pvl => ReferenceEquals(pvl, priceVolumeLayer));
                    int indexFromTop = (isBid ? emptyQuote.BidBook : emptyQuote.AskBook).AllLayers
        ...
        public void AllLevel2QuoteTypes_LayerSourceChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            foreach (var emptyQuote in allEmptyQuotes)
            {
                                                            ...
                                                            .OfType<IPQSourcePriceVolumeLayer>())
                {
                    nameCounter++;
                    testDateTime = testDateTime.AddHours(1).AddMinutes(1);
                    bool isBid = emptyQuote.BidBook.AllLayers.Any(pvl => ReferenceEquals(pvl, sourcePriceVolumeLayer));
                    int indexFromTop = (isBid ? emptyQuote.BidBook : emptyQuote.AskBook).AllLayers
                    ...
                    var foundLayer = (IPQSourcePriceVolumeLayer)(isBid 
                        ? newEmpty.BidBook 
                        : newEmpty.AskBook)[indexFromTop];
        ...
        public void AllLevel2QuoteTypes_LayerExecutableChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            foreach (var emptyQuote in allEmptyQuotes)
            {
                ...
                {
                    testDateTime = testDateTime.AddHours(1).AddMinutes(1);
                    bool isBid = emptyQuote.BidBook.AllLayers.Any(pvl => ReferenceEquals(pvl, srcPriceVolumeLayer));
                    int indexFromTop = (isBid ? emptyQuote.BidBook : emptyQuote.AskBook).AllLayers
                        .Select((pvl, i) => new { i, pvl }).Where(indexPvl =>
        ...
        public void AllLevel2QuoteTypes_LayerSourceQuoteRefChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            foreach (var emptyQuote in allEmptyQuotes)
            {
                ...
                {
                    testDateTime = testDateTime.AddHours(1).AddMinutes(1);
                    bool isBid = emptyQuote.BidBook.AllLayers.Any(pvl => ReferenceEquals(pvl, 
        ...
        public void AllLevel2QuoteTypes_LayerValueDateChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            foreach (var emptyQuote in allEmptyQuotes)
            {
                ...
                {
                    testDateTime = testDateTime.AddHours(1).AddMinutes(1);
                    bool isBid = emptyQuote.BidBook.AllLayers
        ...
        public void AllLevel2QuoteTypes_LayerTraderCountChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            foreach (var emptyQuote in allEmptyQuotes)
            {
                ...
                {
                    bool isBid = emptyQuote.BidBook.AllLayers.Any(pvl => ReferenceEquals(pvl, traderPriceVolumeLayer));
                    int indexFromTop = (isBid ? emptyQuote.BidBook : emptyQuote.AskBook).AllLayers
                        .Select((pvl, i) => new { i, pvl }).Where(indexPvl =>
        ...
        {
            for (int i = 0; i < PQFieldKeys.SingleByteFieldIdMaxBookDepth; i++)
            {
            ...
            PQLevel2Quote original, PQLevel2Quote changingLevel2Quote)
        {
            ...
            PQOrderBookTests.AssertAreEquivalentMeetsExpectedExactComparisonType(exactComparison, 
                original.BidBook as PQOrderBook, changingLevel2Quote.BidBook as PQOrderBook, 
                original, changingLevel2Quote);

            PQOrderBookTests.AssertAreEquivalentMeetsExpectedExactComparisonType(exactComparison,
                original.AskBook as PQOrderBook, changingLevel2Quote.AskBook as PQOrderBook,
                original, changingLevel2Quote);
        }
        ...
        private void AssertLayerTypeIsExpected(Type expectedType, params PQLevel2Quote[] quotesToCheck)
        {
            ...
            {
                for (int i = 0; i < level2Quote.SourceTickerQuoteInfo.MaximumPublishedLayers; i++)
                {
