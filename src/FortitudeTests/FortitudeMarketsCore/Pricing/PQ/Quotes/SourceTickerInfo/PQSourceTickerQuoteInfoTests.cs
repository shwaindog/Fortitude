...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.Quotes.SourceTickerInfo
{
    ...
    {
        private PQSourceTickerQuoteInfo fullyPopulatedSrcTkrQtInfo;
        private PQSourceTickerQuoteInfo emptySrcTkrQtInfo;
        ...
        public void SetUp()
        {
            fullyPopulatedSrcTkrQtInfo = new PQSourceTickerQuoteInfo(new SourceTickerClientAndPublicationConfig(
            ...
            emptySrcTkrQtInfo = new PQSourceTickerQuoteInfo(new SourceTickerQuoteInfo(0, null, null, 0, 0m, 0m, 
        ...
        public void EmptyQuoteInfo_RoundingPrecisionChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            ...
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.RoundingPrecision, roundingNoDecimal, 
                decimalPlaces);
        ...
        public void EmptyQuoteInfo_MinSubmitSizeChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            ...
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.MinSubmitSize, roundingNoDecimal,
                decimalPlaces);
            Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
        ...
        public void EmptyQuoteInfo_MaxSubmitSizeChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            ...
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.MaxSubmitSize, roundingNoDecimal,
                decimalPlaces);
            Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
        ...
        public void EmptyQuoteInfo_IncrementSizeChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            ...
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.IncrementSize, roundingNoDecimal,
                decimalPlaces);
            Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
        ...
        public void EmptyQuoteInfo_MinimumQuoteLifeChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            ...
            var sourceUpdates = emptySrcTkrQtInfo.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates).ToList();
            Assert.AreEqual(1, sourceUpdates.Count);
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.MinimumQuoteLife, expectedMinimumQuoteLife);
            Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
        ...
        public void EmptyQuoteInfo_LayerFlagsChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            ...
            var sourceUpdates = emptySrcTkrQtInfo.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates).ToList();
            Assert.AreEqual(1, sourceUpdates.Count);
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.LayerFlags, (uint)expectedLayerFlags);
            Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
        ...
        public void EmptyQuoteInfo_MaximumPublishedLayersChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            ...
            var sourceUpdates = emptySrcTkrQtInfo.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates).ToList();
            Assert.AreEqual(1, sourceUpdates.Count);
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.MaximumPublishedLayers, 
        ...
        public void EmptyQuoteInfo_LastTradedFlagsChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            ...
            var sourceUpdates = emptySrcTkrQtInfo.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates).ToList();
            Assert.AreEqual(1, sourceUpdates.Count);
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.LastTradedFlags, (uint)expectedLastTradedFlags);
            Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
        ...
        public void PopulatedQuote_GetDeltaUpdatesUpdateThenUpdateFieldNewQuote_CopiesAllFieldsToNewQuote()
        {
            ...
            var pqFieldUpdates = fullyPopulatedSrcTkrQtInfo.GetDeltaUpdateFields(
                new DateTime(2017, 11, 04, 16, 33, 59), UpdateStyle.Updates).ToList();
            var newEmpty = new PQSourceTickerQuoteInfo(new SourceTickerQuoteInfo(0, null, null));
        ...
        {
            PQUniqueSourceTickerIdentifierTests.AssertSourceTickerInfoContainsAllFields(checkFieldUpdates, srcTkrInfo);
