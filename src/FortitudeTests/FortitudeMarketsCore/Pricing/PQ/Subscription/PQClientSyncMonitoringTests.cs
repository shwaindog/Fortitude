...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.Subscription
{
    ...
    {
        private PQClientSyncMonitoring pqClientSyncMonitoring;
        private Func<string, ISnapshotUpdatePricingServerConfig> getSourceServerConfigFunc;
        private Action<IConnectionConfig, List<IUniqueSourceTickerIdentifier>> snapShotRequestActionFunc;
        private Mock<IOSParallelControllerFactory> moqParallelControllerFactory;
        private Mock<IIntraOSThreadSignal> moqStopSignal;
        private Mock<IOSParallelController> moqParallelController;
        private Mock<IDoublyLinkedList<IPQDeserializer>> moqSyncOk;
        private Mock<IDoublyLinkedList<IPQDeserializer>> moqSyncKo;
        private Mock<IOSThread> moqOsThread;
        private Mock<IUniqueSourceTickerIdentifier> moqFirstQuoteDeserializerIdentifier;
        private Mock<IUniqueSourceTickerIdentifier> moqSecondQuoteDeserializerIdentifier;
        private Mock<IPQDeserializer> moqFirstQuoteDeserializer;
        private Mock<IPQDeserializer> moqSecondQuoteDeserializer;
        ...
        private Mock<ISequencer> moqSequencer;
        private Mock<ITimeContext> moqTimeContext;
        private Mock<IFLogger> moqLogger;
        private DateTime baseTime;
        private string lastSourceName;
        private IConnectionConfig lastConnectionConfig;
        private List<IUniqueSourceTickerIdentifier> historyOfCalledSourceTickerIds;
        private List<IUniqueSourceTickerIdentifier> lastUniqueSourceTickerIdentifiers;
        private ThreadStart monitorAction;
        private long sequencerSequence;
        private bool inSequencerSerialize;
        private string nonExistentSource = "TestNonExistentSource";
        ...
        public void SetUp()
        {
            ...
            getSourceServerConfigFunc = srcName =>
            {
                ...
                return srcName != nonExistentSource ? moqSnapshotUpdatePricingServerConfig.Object : null;
            };

            historyOfCalledSourceTickerIds = new List<IUniqueSourceTickerIdentifier>();
        ...
        public void OneIterationTakesTooLong_MonitorDeserializersForSnapshotResync_LogsWarningThatTasksAreSlow()
        {
            ...
            moqSyncOk.SetupSequence(sok => sok.Head).Returns(moqFirstQuoteDeserializer.Object).Returns((IPQDeserializer)null)
                .Returns(moqFirstQuoteDeserializer.Object).Returns((IPQDeserializer)null);
            var count = 0;
            moqSnapshotUpdatePricingServerConfig.SetupGet(supsc => supsc.SnapshotConnectionConfig)
                .Returns(moqServerConnectionConfig.Object).Callback(() =>
            {
        ...
        private void PrepareMonitorDeserializersForSnapshotResyncMoqs()
        {
            ...
            moqSecondQuoteDeserializerIdentifier = new Mock<IUniqueSourceTickerIdentifier>();
            moqSecondQuoteDeserializer.SetupGet(qu => qu.Identifier)
                .Returns(moqSecondQuoteDeserializerIdentifier.Object);
