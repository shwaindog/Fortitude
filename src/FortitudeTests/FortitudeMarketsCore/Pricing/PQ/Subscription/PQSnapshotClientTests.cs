...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.Subscription
{
    ...
    {
        private PQSnapshotClient pqSnapshotClient;
        ...
        private Mock<ITimerCallbackSubscription> moqTimerCallbackSubscription;
        ...
        private Mock<IBinaryStreamPublisher> moqStreamToPublisher;
        private Mock<IFLoggerFactory> moqFloggerFactory;
        private Mock<IIntraOSThreadSignal> moqIntraOsThreadSignal;
        private TimeContextTests.StubTimeContext stubContext;
        ...
        private Mock<IBinaryDeserializer> moqDecoderDeserializer;
        private string expectedHost;
        private int expectedPort;
        private byte[] expectedIpAddress;

        private IList<IUniqueSourceTickerIdentifier> sendSrcTkrIds;
        ...
        public void ConnectedPQSnapshotClient_GetDecoderOnResponse_ResetsDisconnectionTimer()
        {
            ...
            IBinaryDeserializer result = moqDecoderDeserializer.Object;
