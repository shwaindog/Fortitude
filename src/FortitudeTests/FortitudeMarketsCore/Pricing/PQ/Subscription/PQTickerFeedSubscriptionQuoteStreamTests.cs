...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.Subscription
{
    ...
    public class PQTickerFeedSubscriptionQuoteStreamTests
    {
        ...
        private PQTickerFeedSubscriptionQuoteStream<IPQLevel0Quote> pqTickerFeedSubscription;

        private List<IPQLevel0Quote> list1ReceivedQuotes;
        private List<IPQLevel0Quote> list2ReceivedQuotes;
        private IPQLevel0Quote publishingQuote;
        private Mock<IPQLevel0Quote> initializingQuote;
        private Mock<ISyncLock> intializingQuoteSyncLock;
        ...
        public void SetUp()
        {
            feedConfig = new SnapshotUpdatePricingServerConfig("TestServerConfig", MarketServerType.MarketData,
                new[]{new ConnectionConfig("testConnectionName", "testhost", 9090,
                    ConnectionDirectionType.Both, null, 4000)}, null, 1234, null, true, true);
        ...
        {
            bool hasCalledCleanupAction = false;
        ...
        public void AddingNewObserver_Subscribe_ProtectsObserverCollectionInQuoteSyncLock()
        {
            ...
            bool hasRunCallback = false;
            Mock<IObserver<IPQLevel0Quote>> subscribedObserverMock = new Mock<IObserver<IPQLevel0Quote>>();
            Mock<IList<IObserver<IPQLevel0Quote>>> observerCollectionMock = new Mock<IList<IObserver<IPQLevel0Quote>>>();
