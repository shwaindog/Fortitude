...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.Subscription
{
    ...
    public class PQClientDecoderTests
    {
        ...
        private Mock<IMap<uint, IBinaryDeserializer>> moqDeserializersMap;
        private SourceTickerQuoteInfo sourceTickerQuoteInfo;
        private Mock<IBinaryDeserializer> moqBinaryDeserializer;
        ...
        public void SetUp()
        {
            ...
            IBinaryDeserializer binUnserialzierObj = moqBinaryDeserializer.Object;
