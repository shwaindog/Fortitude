...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.LastTraded
{
    ...
    {
        private PQLastPaidGivenTrade emptyLt;
        private PQLastPaidGivenTrade populatedLt;
        ...
        public void EmptyLt_TradeVolumeChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.LastTradeVolumeOffset,
                expectedVolume, 6);
            ...
            IPQLastPaidGivenTrade lt)
        {
            ...
            var expectedFlag = lt.WasGiven ? PQFieldFlags.IsGivenFlag : (byte)0;
            expectedFlag |= lt.WasPaid ? PQFieldFlags.IsPaidFlag : (byte)0;
