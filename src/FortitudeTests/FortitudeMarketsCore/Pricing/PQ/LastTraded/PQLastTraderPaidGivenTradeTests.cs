...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.LastTraded
{
    ...
    public class PQLastTraderPaidGivenTradeTests
    {
        ...
        private PQLastTraderPaidGivenTrade emptyLt;
        private PQLastTraderPaidGivenTrade populatedLt;
        ...
        public void EmptyLt_TraderNameChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.LastTraderIdOffset,
                emptyLt.TraderId);
            ...
            string nextExpectedTraderName = "AnotherTraderName";
            ...
            var expectedStringUpdates = new PQFieldStringUpdate
            {
                ...
                StringUpdate = new PQStringUpdate
                {
                    ...
                    DictionaryId = emptyLt.TraderNameIdLookup[emptyLt.TraderName],
            ...
            PQLevel3Quote originalQuote = null, PQLevel3Quote changingQuote = null)
        {
            ...
            PQLastPaidGivenTradeTests.AssertAreEquivalentMeetsExpectedExactComparisonType(exactComparison, original,
                changingLastTraderPaidGivenTrade, originalRecentlyTraded, changingRecentlyTraded, originalQuote, changingQuote);
