...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.LastTraded.LastTradeEntrySelector
{
    ...
    public class PQLastTradeEntrySelectorTests
    {
        ...
        readonly IPQNameIdLookupGenerator tradeNnameIdGenerator = new PQNameIdLookupGenerator(
            PQFieldKeys.LastTraderDictionaryUpsertCommand, PQFieldFlags.TraderNameIdLookupSubDictionaryKey);

        readonly PQLastTradeEntrySelector entrySelector = new PQLastTradeEntrySelector();
        ...
        private string expectedTradeName;

        LastTrade simpleLastTrade;
        LastPaidGivenTrade paidGivenLastTrade;
        LastTraderPaidGivenTrade traderPaidGivenLastTrade;

        PQLastTrade pqSimpleLastTrade;
        PQLastPaidGivenTrade pqPaidGivenLastTrade;
        PQLastTraderPaidGivenTrade pqTraderPaidGivenLastTrade;
