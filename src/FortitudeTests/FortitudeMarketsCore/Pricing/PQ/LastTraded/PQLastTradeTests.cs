...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.LastTraded
{
    ...
    {
        private PQLastTrade emptyLt;
        private PQLastTrade populatedLt;
        ...
        public void EmptyLt_TradePriceChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.LastTradePriceOffset,
                expectedPrice, 1);
        ...
        public void EmptyLt_TradeTimeChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            DateTime expectedDateTime = new DateTime(2018, 1, 6, 16, 34, 35);
            ...
            PQFieldUpdate expectedHoursFieldUpdate = new PQFieldUpdate(PQFieldKeys.LastTradeTimeHourOffset,
            ...
            PQFieldUpdate expectedSubHoursFieldUpdate = new PQFieldUpdate(PQFieldKeys.LastTradeTimeSubHourOffset,
                subHoursBase, flag);
            ...
            Assert.IsFalse(emptyLt.IsTradeTimeSubHourUpdated);
            Assert.IsTrue(emptyLt.HasUpdates);
            Assert.AreEqual(1, emptyLt.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates).Count());
            ...
            DateTime nextExpectedPrice = new DateTime(2018, 1, 6, 15, 35, 35);
        ...
        public static void AssertAreEquivalentMeetsExpectedExactComparisonType(bool exactComparison, PQLastTrade original, 
            PQLastTrade changingLastTrade, PQRecentlyTraded originalRecentlyTraded = null, PQRecentlyTraded changingRecentlyTraded = null, 
            PQLevel3Quote originalQuote = null, PQLevel3Quote changingQuote = null)
        {
            ...
            {
                Assert.AreEqual(!exactComparison, changingLastTrade.AreEquivalent(new LastTrade(original), exactComparison));
            }

            changingLastTrade.TradePrice = 12.34567m;
            Assert.IsFalse(original.AreEquivalent(changingLastTrade, exactComparison));
            if (originalRecentlyTraded != null) Assert.IsFalse(
            ...
            if (originalRecentlyTraded != null) Assert.IsTrue(
                originalRecentlyTraded.AreEquivalent(changingRecentlyTraded, exactComparison));
            ...
            if (originalRecentlyTraded != null) Assert.AreEqual(!exactComparison,
                originalRecentlyTraded.AreEquivalent(changingRecentlyTraded, exactComparison));
