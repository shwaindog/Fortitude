...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.LastTraded
{
    ...
    public class PQRecentlyTradedTests
    {
        ...
        private PQRecentlyTraded simpleRecentlyTradedFullyPopulatedQuote;
        private PQRecentlyTraded paidGivenVolumeRecentlyTradedFullyPopulatedQuote;
        private PQRecentlyTraded traderPaidGivenVolumeRecentlyTradedFullyPopulatedQuote;

        private IList<PQRecentlyTraded> allFullyPopulatedRecentlyTraded;
        
        private IList<IPQLastTrade> simpleEntries;
        private IList<IPQLastPaidGivenTrade> lastPaidGivenEntries;
        private IList<IPQLastTraderPaidGivenTrade> lastTraderPaidGivenEntries;
        
        private List<IReadOnlyList<IPQLastTrade>> allPopulatedEntries;
        ...
        {
            for (int i = 0; i < upgradedRecentlyTraded.Capacity; i++)
            {
        ...
        {
            if (copySourceType == typeof(PQLastTrade))
            {
                return true;
            }
            ...
            PQLevel3Quote changingQuote = null)
        {
            ...
            for (int i = 0; i < original.Count; i++)
            {
                ...
                PQLastTradeTests.AssertAreEquivalentMeetsExpectedExactComparisonType(
                    ...
                    changingEntry as PQLastTrade, original,
