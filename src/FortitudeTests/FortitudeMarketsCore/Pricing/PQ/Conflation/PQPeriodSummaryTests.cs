...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.Conflation
{
    ...
    {
        private PQPeriodSummary emptySummary;
        private PQPeriodSummary fullyPopulatedPeriodSummary;
        ...
        private PQSourceTickerQuoteInfo pricePrecisionSettings;
        ...
        public void EmptySummary_StartTimeChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            ...
            Assert.AreEqual(0, emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates,
            ...
            var sourceAskUpdates = emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates,
            ...
            PQFieldUpdate expectedSubHour = new PQFieldUpdate(PQFieldKeys.PeriodStartSubHourTime, lowerFourBytes, fifthByte);
            ...
            Assert.IsFalse(emptySummary.IsStartTimeDateUpdated);
            Assert.IsTrue(emptySummary.HasUpdates);
            sourceAskUpdates = emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates,
                                                                 pricePrecisionSettings).ToList();
            ...
            Assert.IsFalse(emptySummary.IsStartTimeSubHourUpdated);
            Assert.IsFalse(emptySummary.HasUpdates);
            Assert.IsTrue(emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates).IsNullOrEmpty());

            sourceAskUpdates = (from update in emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.FullSnapshot,
        ...
        public void EmptySummary_EndTimeChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            ...
            PQFieldUpdate expectedSubHour = new PQFieldUpdate(PQFieldKeys.PeriodEndSubHourTime, lowerFourBytes, fifthByte);
            Assert.AreEqual(expectedHour, sourceAskUpdates[0]);
            Assert.AreEqual(expectedSubHour, sourceAskUpdates[1]);
        ...
        public void EmptySummary_StartBidPriceChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            var sourceUpdates = emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates,
                pricePrecisionSettings).ToList();
            Assert.AreEqual(1, sourceUpdates.Count);
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.PeriodStartPrice, expectedStartBidPrice, 1);
            Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);

            emptySummary.IsStartBidPriceUpdated = false;
            Assert.IsFalse(emptySummary.IsStartBidPriceUpdated);
            Assert.IsFalse(emptySummary.HasUpdates);
            Assert.IsTrue(emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates,
                pricePrecisionSettings).IsNullOrEmpty());

            sourceUpdates = (from update in emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.FullSnapshot,
                    pricePrecisionSettings)
        ...
        public void EmptySummary_StartAskPriceChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            var sourceUpdates = emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates,
                pricePrecisionSettings).ToList();
            Assert.AreEqual(1, sourceUpdates.Count);
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.PeriodStartPrice, expectedStartAskPrice,
        ...
        public void EmptySummary_HighestBidPriceChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            var sourceUpdates = emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates,
                pricePrecisionSettings).ToList();
            Assert.AreEqual(1, sourceUpdates.Count);
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.PeriodHighestPrice, expectedHighestBidPrice, 1);
            Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
        ...
        public void EmptySummary_HighestAskPriceChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            var sourceUpdates = emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates,
                pricePrecisionSettings).ToList();
            Assert.AreEqual(1, sourceUpdates.Count);
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.PeriodHighestPrice, expectedHighestAskPrice,
                1 | PQFieldFlags.IsAskSideFlag);
            Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
        ...
        public void EmptySummary_LowestBidPriceChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            var sourceUpdates = emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates,
                pricePrecisionSettings).ToList();
            Assert.AreEqual(1, sourceUpdates.Count);
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.PeriodLowestPrice, expectedLowestBidPrice, 1);
            Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
        ...
        public void EmptySummary_LowestAskPriceChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            var sourceUpdates = emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates,
                pricePrecisionSettings).ToList();
            Assert.AreEqual(1, sourceUpdates.Count);
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.PeriodLowestPrice, expectedLowestAskPrice,
                1 | PQFieldFlags.IsAskSideFlag);
            Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
        ...
        public void EmptySummary_EndBidPriceChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            var sourceUpdates = emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates,
                pricePrecisionSettings).ToList();
            Assert.AreEqual(1, sourceUpdates.Count);
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.PeriodEndPrice, expectedEndBidPrice, 1);
            Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
        ...
        public void EmptySummary_TickCountChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            var sourceUpdates = emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates,
                pricePrecisionSettings).ToList();
            Assert.AreEqual(1, sourceUpdates.Count);
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.PeriodTickCount, expectedTickCount);
            Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
        ...
        public void EmptySummary_EndAskPriceChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            var sourceUpdates = emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates,
                pricePrecisionSettings).ToList();
            Assert.AreEqual(1, sourceUpdates.Count);
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.PeriodEndPrice, expectedEndAskPrice,
                1 | PQFieldFlags.IsAskSideFlag);
            Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
        ...
        public void EmptySummary_PeriodVolumeChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
        {
            ...
            var periodVolumeUpdates = emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates,
                                                                     pricePrecisionSettings).ToList();
            Assert.AreEqual(2, periodVolumeUpdates.Count);
            uint lowerBytes = (uint)emptySummary.PeriodVolume;
            uint upperBytes = (uint)(emptySummary.PeriodVolume >> 32);
            PQFieldUpdate expectedLowerBytes = new PQFieldUpdate(PQFieldKeys.PeriodVolumeLowerBytes, lowerBytes);
            PQFieldUpdate expectedUpperBytes = new PQFieldUpdate(PQFieldKeys.PeriodVolumeUpperBytes, upperBytes);
            ...
            Assert.IsFalse(emptySummary.IsPeriodVolumeLowerBytesUpdated);
            Assert.IsTrue(emptySummary.HasUpdates);
            periodVolumeUpdates = emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.Updates,
                                                                 pricePrecisionSettings).ToList();
            ...
            periodVolumeUpdates = (from update in emptySummary.GetDeltaUpdateFields(testDateTime, UpdateStyle.FullSnapshot,
                                                                                  pricePrecisionSettings)
        ...
        public void PopulatedPeriodSummaryWithAllUpdates_GetDeltaUpdateFieldsAsUpdate_ReturnsAllLevel0Fields()
        {
            var pqFieldUpdates = fullyPopulatedPeriodSummary.GetDeltaUpdateFields(
                new DateTime(2017, 11, 04, 16, 33, 59), UpdateStyle.Updates, pricePrecisionSettings).ToList();
        ...
        public void PopulatedPeriodSummaryWithNoUpdates_GetDeltaUpdateFieldsAsSnapshot_ReturnsAllLevel0Fields()
        {
            ...
            var pqFieldUpdates = fullyPopulatedPeriodSummary.GetDeltaUpdateFields(
                new DateTime(2017, 11, 04, 16, 33, 59), UpdateStyle.FullSnapshot, pricePrecisionSettings).ToList();
            AssertPeriodSummaryContainsAllFields(pqFieldUpdates, fullyPopulatedPeriodSummary);
        }
        ...
        {
            var pqFieldUpdates = fullyPopulatedPeriodSummary.GetDeltaUpdateFields(
                new DateTime(2017, 11, 04, 16, 33, 59), UpdateStyle.Updates | UpdateStyle.Replay, pricePrecisionSettings)
                .ToList();
            var newEmpty = new PQPeriodSummary();
        ...
        public static void AssertAreEquivalentMeetsExpectedExactComparisonType(bool exactComparison, PQPeriodSummary original,
                                                                    ...
                                                                    IPQPeriodSummary periodSummary)
        {
            ...
            byte fifthByte = periodSummary.StartTime.GetSubHourComponent().BreakLongToByteAndUint(out var lowerFourBytes);
            ...
            uint lowerBytesPeriodVolume = (uint)periodSummary.PeriodVolume;
            ...
            uint upperBytesPeriodVolume = (uint)(periodSummary.PeriodVolume >> 32);
