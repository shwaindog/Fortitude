...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.LayeredBook
{
    ...
    {
        private PQPriceVolumeLayer emptyPvl;
        private PQPriceVolumeLayer populatedPvl;
        ...
        public void EmptyPvl_PriceChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.LayerPriceOffset, 
                expectedPrice, 1);
        ...
        public void EmptyPvl_VolumeChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
        {
            ...
            PQFieldUpdate expectedFieldUpdate = new PQFieldUpdate(PQFieldKeys.LayerVolumeOffset,
                expectedVolume, 6);
            Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
