...
namespace FortitudeTests.FortitudeMarketsCore.Pricing.PQ.LayeredBook
{
    ...
    public class PQSourceQuoteRefPriceVolumeLayerTests
    {
        ...
        private PQSourceQuoteRefPriceVolumeLayer emptyPvl;
        private PQSourceQuoteRefPriceVolumeLayer populatedPvl;
            ...
            ILevel2Quote changingQuote = null)
        {
            ...
            changingPriceVolumeLayer.IsSourceQuoteReferenceUpdated = !changingPriceVolumeLayer.IsSourceQuoteReferenceUpdated;
