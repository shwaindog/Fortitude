...
public class OrxOrderIdTests
{
    ...
    public void NewOrxClient_Serialize_DeserializesProperly()
    {
        ...
        readSocketBufferContext.MessageSize = orxOrxOrderIdSerializer.Serialize(originalOrderId,
        ...
        var deserializedOrxClientOrderId = orxOrderIdDeserializer.Deserialize(readSocketBufferContext);
