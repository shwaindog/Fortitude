...
namespace FortitudeTests.FortitudeMarketsCore.Trading.ORX.Venues
{
    ...
    public class OrxVenueOrdersTests
    {
        ...
        public void NewVenueOrders_Serialize_DeserializesProperly()
        {
            ...
            {
                FirstVenueOrders = BuildVenueOrders(),
                SecondVenueOrders = BuildVenueOrders(),
                ThirdVenueOrders = BuildVenueOrders(),
                FourthVenueOrders = BuildVenueOrders(),
            };
        ...
        {
            return new OrxVenueOrders(new List<OrxVenueOrder>
            {
                new OrxVenueOrder(
        ...
        {
            [OrxMandatoryField(0)]
            public OrxVenueOrders FirstVenueOrders { get; set; }
            [OrxMandatoryField(1)]
            public OrxVenueOrders SecondVenueOrders { get; set; }
            [OrxOptionalField(1)]
            public OrxVenueOrders ThirdVenueOrders { get; set; }
            [OrxOptionalField(2)]
            public OrxVenueOrders FourthVenueOrders { get; set; }
        }
    }
}