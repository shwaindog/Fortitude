...
namespace FortitudeTests.FortitudeCommon.DataStructures.Maps.IdMap
{
    ...
    {
        private IIdLookup<DateTime> populatedDateLookup;
        private IIdLookup<DateTime> emptyLookup;
        private Dictionary<int, DateTime> populatedLookupInitialValuesDict;
        ...
        public void Setup()
        {
            ...
            {
                {1, new DateTime(2018, 02, 03, 12, 58, 11)},
                {2, new DateTime(2018, 02, 02, 12, 58, 11)},
        ...
        public void EmptyLookup_New_ContainsNoData()
        {
            ...
            Assert.AreEqual(0, emptyLookup.GetId(DateTime.Now));
            Assert.AreEqual(0, emptyLookup[DateTime.Now]);
            Assert.AreEqual(default(DateTime), emptyLookup.GetValue(1));
            Assert.AreEqual(default(DateTime), emptyLookup[1]);
        }
        ...
        public void OneDiffValue_AreEquivalent_ReturnsExpected()
        {
            var clonedInitialDictionary =
                ...
                {
                    [3] = new DateTime(2018, 02, 03, 14, 09, 33)
                };
