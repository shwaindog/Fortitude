...
{
    private INameIdLookupGenerator emptyNameIdLookupGenerator = new NameIdLookupGenerator();
    private Dictionary<int, string> initialValues = new();
    private INameIdLookupGenerator populatedIdLookupGenerator = new NameIdLookupGenerator();
    ...
    {
        var pqIdLookupGenerator = new NameIdLookupGeneratorDummy(populatedIdLookupGenerator);

        Assert.IsFalse(populatedIdLookupGenerator.AreEquivalent(pqIdLookupGenerator, true));
    }

    private class NameIdLookupGeneratorDummy : NameIdLookupGenerator
    {
        public NameIdLookupGeneratorDummy() { }
        public NameIdLookupGeneratorDummy(INameIdLookup toClone) : base(toClone) { }
        public NameIdLookupGeneratorDummy(IDictionary<int, string> copyDict) : base(copyDict) { }
    }
}
