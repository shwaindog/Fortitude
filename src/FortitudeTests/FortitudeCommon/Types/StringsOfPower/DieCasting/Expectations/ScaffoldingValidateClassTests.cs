...
{
    private readonly IReadOnlyList<ScaffoldingPartEntry> scafReg = ScaffoldingRegistry.AllScaffoldingTypes;
    ...
    public void AllComplexTypeSingleValueFieldAcceptsCharsScaffoldingImplementISupportsSettingValueFromString()
    {
        var allComplexSingleFieldsThatAcceptChars =
            scafReg.IsAComplexType().ProcessesSingleValue().AcceptsChars().NotHasAcceptsAny().ToList();
