...
public static class StringBearerTestData
{
    ...
    public static PositionUpdatingList<ISingleFieldExpectation> AllStringBearerExpectations => allStringBearerExpectations ??=
      ...
      , new StringBearerExpect<FieldNullableSpanFormattableAlwaysAddStructStringBearer<DateTime>>
           ...
           , new FieldNullableSpanFormattableAlwaysAddStructStringBearer<DateTime>
             ...
             })
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsStringOut | DefaultBecomesFallbackValue | DefaultBecomesNull 
                       , CompactLog | Pretty ) , "\"FieldNullableSpanFormattableAlwaysAddStringBearer<DateTime>(2/2/2020 12:00:00 AM)\"" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultBecomesFallbackValue | DefaultBecomesNull) 
                  , "FieldNullableSpanFormattableAlwaysAddStringBearer\\u003cDateTime\\u003e(2/2/2020 12:00:00 AM)" }
                // uses Default value which is re-encoded escaping \u003c to \\u003c etc...
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultBecomesFallbackString) 
                  , "FieldNullableSpanFormattableAlwaysAddStringBearer\\\\u003cDateTime\\\\u003e(2/2/2020 12:00:00 AM)" }
      ...
      , new StringBearerExpect<FieldNullableSpanFormattableAlwaysAddStringBearer<TimeSpan>>
            ...
            {
                { new EK(IsContentType | CallsViaMatch | DefaultBecomesNull) , "null" }
              , { new EK(IsContentType | CallsViaMatch | DefaultBecomesFallbackValue) , "null" }
              , { new EK(IsContentType | CallsViaMatch), "null" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut | DefaultBecomesEmpty) , "" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut | DefaultBecomesZero) , "0" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsStringOut | DefaultBecomesEmpty) , "\"\"" }
      ...
      , new StringBearerExpect<FieldSpanFormattableAlwaysAddStringBearer<IPAddress>>
            (null, "", true, new FieldSpanFormattableAlwaysAddStringBearer<IPAddress>())
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsStringOut | DefaultBecomesEmpty) , "\"\"" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsStringOut | DefaultBecomesZero) , "\"0\"" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut | DefaultBecomesFallbackValue | DefaultBecomesFallbackString
                       , CompactLog | Pretty )
                  , "FieldSpanFormattableAlwaysAddStringBearer<IPAddress>()" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsStringOut | DefaultBecomesFallbackValue  | DefaultBecomesFallbackString
                       , CompactLog | Pretty ) , "\"FieldSpanFormattableAlwaysAddStringBearer<IPAddress>()\"" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultBecomesFallbackValue) 
                  , "FieldSpanFormattableAlwaysAddStringBearer\\u003cIPAddress\\u003e()" }
                // uses Default value which is re-encoded escaping \u003c to \\u003c etc...
