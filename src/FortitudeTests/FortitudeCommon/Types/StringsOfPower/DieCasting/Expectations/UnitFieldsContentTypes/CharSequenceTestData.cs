    ...
    public static PositionUpdatingList<IStringLikeExpectation> AllCharSequenceExpectations => allCharSequenceExpectations ??=
        new PositionUpdatingList<IStringLikeExpectation>(typeof(CharSequenceTestData))
        {
          ...
          , new StringLikeExpect<MutableString, MutableString>
                (new MutableString(""), "", true, new MutableString("0"), formatFlags: AsCollection)
            {
              ...
              , { new EK(IsContentType | CallsViaMatch | DefaultTreatedAsStringOut), "\"\"" }
               ,
                {
                    new EK(IsContentType | AcceptsChars | AcceptsCharSequence | DefaultTreatedAsValueOut | DefaultBecomesZero
                         | DefaultBecomesFallbackValue)
                  , "0"
                }
               ,
                {
                    new EK(IsContentType | AcceptsChars | AcceptsCharSequence | DefaultTreatedAsValueOut | DefaultTreatedAsStringOut
                         | EmptyBecomesNull | DefaultBecomesNull)
                  , "null"
                }
               ,
                {
                    new EK(IsContentType | AcceptsChars | AcceptsCharSequence | DefaultTreatedAsStringOut | DefaultBecomesZero
                         | DefaultBecomesFallbackValue)
                  , "\"0\""
                }
               ,
                {
                    new EK(IsContentType | AcceptsChars | AcceptsCharSequence | DefaultTreatedAsStringOut | DefaultBecomesEmpty)
                  , "\"\""
                }
              , { new EK(IsContentType | AcceptsChars | DefaultTreatedAsValueOut), "" }
               ,
          ...
          , new StringLikeExpect<MutableString, MutableString>
                (new MutableString("It"), "\"{0}\"", false, new MutableString(), 3, 2, AsCollection)
            {
              ...
              , { new EK(IsContentType | CallsViaMatch | DefaultBecomesFallbackValue), "\"\\u0022\\u0022\"" }
               ,
                {
                    new EK(IsContentType | AcceptsChars | AcceptsCharSequence | DefaultBecomesZero
                         , Log | Compact | Pretty)
                  , "\"0\""
                }
              , { new EK(IsContentType | AcceptsChars | AcceptsCharSequence | DefaultTreatedAsValueOut | DefaultBecomesZero), "\"0\"" }
               ,
                {
                    new EK(IsContentType | AcceptsChars | AcceptsCharSequence | DefaultBecomesZero)
                  , "\"\\u00220\\u0022\""
                }
              , { new EK(IsContentType | AcceptsChars | AcceptsCharSequence, Log | Compact | Pretty), "\"\"" }
              , { new EK(IsContentType | AcceptsChars | AcceptsCharSequence | DefaultTreatedAsValueOut), "\"\"" }
               ,
                {
                    new EK(IsContentType | AcceptsChars | AcceptsCharSequence)
                  , "\"\\u0022\\u0022\""
                }
               ,
                {
          ...
          , new StringLikeExpect<MutableString>(new MutableString("with"), "\"{0[8..10]}\"", formatFlags: AsCollection)
            {
                { new EK(IsContentType | AcceptsChars | CallsViaMatch | CallsAsSpan, Log | Compact | Pretty), "\"\"" }
              , { new EK(IsContentType | AcceptsChars | CallsViaMatch | DefaultBecomesFallbackValue | DefaultTreatedAsValueOut), "\"\"" }
              , { new EK(IsContentType | AcceptsChars | CallsViaMatch | DefaultBecomesFallbackValue), "\"\\u0022\\u0022\"" }
              , { new EK(IsContentType | AcceptsChars | AcceptsCharSequence | CallsAsSpan, Log | Compact | Pretty), "\"\"" }
              , { new EK(IsContentType | AcceptsChars | AcceptsCharSequence | CallsAsSpan | DefaultTreatedAsValueOut), "\"\"" }
               ,
                {
                    new EK(IsContentType | AcceptsChars | AcceptsCharSequence | CallsAsSpan), """""
                                                                                           "\u0022\u0022"
                                                                                           """""
                }
               ,
          ...
          , new StringLikeExpect<MutableString>
               ...
               , fromIndex: 9, length: 41, formatFlags: AsCollection)
                {
                    {
                        new EK(IsContentType | AcceptsCharSequence | DefaultTreatedAsValueOut, Log | Compact | Pretty)
                      , "***\"nine strings were gifted to the race of\"###"
                    }
                   ,
                    {
                        new EK(IsContentType | AcceptsCharSequence | DefaultTreatedAsStringOut, Log | Compact | Pretty)
                      , "\"***\"nine strings were gifted to the race of\"###\""
                    }
                   ,
                    {
                        new EK(IsContentType | AcceptsCharSequence | DefaultTreatedAsValueOut, Json | Compact | Pretty)
                      , "***\\u0022nine strings were gifted to the race of\\u0022###"
                    }
                   ,
                    {
                        new EK(IsContentType | AcceptsCharSequence)
                      , "\"***\\u0022nine strings were gifted to the race of\\u0022###\""
                    }
                   ,
                    {
          ...
          , new StringLikeExpect<CharArrayStringBuilder>
               ...
               , "{0,0/ /\n/[1..^1]}", formatFlags: AsCollection)
                {
                    {
                        new EK(IsContentType | AcceptsChars | AcceptsStringBuilder | CallsAsSpan | DefaultTreatedAsValueOut
                             , Log | Compact | Pretty)
                      , "within\nthese\nstrings\nwas\nbound\nthe\nflexibility,\nmutability\nand\nthe\noperators\nto\ngovern\neach"
                    }
                   ,
                    {
                        new EK(IsContentType | AcceptsChars | AcceptsStringBuilder | CallsAsSpan | DefaultTreatedAsStringOut
                             , Log | Compact | Pretty)
                      , "\"within\nthese\nstrings\nwas\nbound\nthe\nflexibility,\nmutability\nand\nthe\noperators\nto\ngovern\neach\""
                    }
                   ,
                   ...
                   ,
                    {
                        new EK(IsContentType | AcceptsChars | AcceptsStringBuilder | CallsAsSpan)
                      , """
                        "within\u000athese\u000astrings\u000awas\u000abound\u000athe\u000aflexibility,\u000amutability\u000aand\u000athe
                        \u000aoperators\u000ato\u000agovern\u000aeach"
                        """.RemoveLineEndings()
          ...
          , new StringLikeExpect<MutableString>
               ...
               , formatFlags: AsCollection)
                {
                    { new EK(IsContentType | AcceptsChars | AcceptsCharSequence | DefaultTreatedAsValueOut), " for another string was made." }
                  , { new EK(IsContentType | AcceptsChars | AcceptsCharSequence | DefaultTreatedAsStringOut), "\" for another string was made.\"" }
                   ,
                    {
                        new EK(AcceptsChars | AcceptsCharSequence | AlwaysWrites | NonDefaultWrites | NonNullWrites |
                               NonNullAndPopulatedWrites, Log | Compact | Pretty)
