...
public static class SpanFormattableTestData
{
    ...
    [
      ...
      , new FieldExpect<byte>(255)
        {
            {
                new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites | NonNullWrites | NonNullAndPopulatedWrites), "255"
            }
        }
      , new FieldExpect<byte>(128, "C2")
        {
            {
                new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites | NonNullWrites | NonNullAndPopulatedWrites), "$128.00"
            }
        }
      ...
      , new FieldExpect<char?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<char?>('A')
      ...
      , new FieldExpect<short?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<short?>(32000, "N2")
      ...
      , new FieldExpect<ushort?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<ushort?>(32000, "N2")
      ...
      , new FieldExpect<ushort?>(32, "C8", true, 32)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonNullWrites), "$32.00000000" }
        }
      , new FieldExpect<ushort?>(ushort.MaxValue, "'{0:B16}'")
        {
            {
      ...
      , new FieldExpect<ushort?>(55, "\"{0,20}\"")
        ...
        // Half
      , new FieldExpect<Half>(Half.Zero) { { new EK(AcceptsSpanFormattable | AlwaysWrites | NonNullWrites), "0" } }
      ...
      , new FieldExpect<Half>(Half.One, "", true, Half.One)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonNullWrites), "1" }
        }
      ...
      , new FieldExpect<Half?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<Half?>(Half.MinValue / (Half)2.0, "R")
      ...
      , new FieldExpect<int?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<int?>(32000, "0x{0:X}")
      ...
      , new FieldExpect<uint?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<uint?>(32000, "0x{0:X}")
      ...
      , new FieldExpect<float?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<float?>(1 - float.MinValue, "R")
      ...
      , new FieldExpect<long?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<long?>(32000, "0x{0:X}")
      ...
      , new FieldExpect<ulong?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<ulong?>(32000, "0x{0:X}")
      ...
      , new FieldExpect<double?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<double?>(1 - double.MinValue, "R")
      ...
      , new FieldExpect<decimal?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<decimal?>(decimal.MinValue, "R")
      ...
      , new FieldExpect<Int128?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<Int128?>(32000, "0x{0:X}")
      ...
      , new FieldExpect<UInt128?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<UInt128?>(32000, "0x{0:X}")
      ...
      , new FieldExpect<BigInteger?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<BigInteger?>(32000, "0x{0:X}")
      ...
      , new FieldExpect<Complex?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<Complex?>(32000, "{0:N0}")
      ...
      , new FieldExpect<DateTime?>(DateTime.MinValue, "O")
        {
           ...
           ,
            {
                new EK(AcceptsSpanFormattable | AlwaysWrites | NonNullWrites, Json | Compact | Pretty), "\"0001-01-01T00:00:00.0000000\""
            }
        }
      , new FieldExpect<DateTime?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<DateTime?>(new DateTime(2000, 1, 1, 1, 1, 1).AddTicks(1111111), "o")
      ...
      , new FieldExpect<DateTime?>(new DateTime(2009, 11, 12, 19, 49, 0), "\"{0,-30:O}\"")
        ...
        // TimeSpan
      , new FieldExpect<TimeSpan>(TimeSpan.Zero, "g")
        {
      ...
      , new FieldExpect<TimeSpan?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<TimeSpan?>(new TimeSpan(1, 1, 1, 1, 111, 111), "c")
      ...
      , new FieldExpect<DateOnly?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<DateOnly?>(new DateOnly(2000, 1, 1), "o")
      ...
      , new FieldExpect<TimeOnly>(new TimeOnly(22, 22, 22, 222, 222), "O", true
        ...
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonNullWrites
                     , Log | Compact | Pretty), "22:22:22.2222220" 
            } 
            ,
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonNullWrites
                     , Json | Compact | Pretty), "\"22:22:22.2222220\"" 
            } 
      ...
      , new FieldExpect<TimeOnly?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<TimeOnly?>(new TimeOnly(1, 1, 1, 111, 111), "o")
      ...
      , new FieldExpect<Rune?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<Rune?>(Rune.GetRuneAt("𝄞", 0))
      ...
      , new FieldExpect<Guid?>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null" }
        }
      , new FieldExpect<Guid?>(Guid.ParseExact("BEEFCA4E-BEEF-CA4E-BEEF-C0FFEEBABE51", "D"))
      ...
      , new FieldExpect<IPNetwork?>(null, "null", true)
        {
            {
                new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites), "null"
            }
      ...
      , new FieldExpect<Version>(null, "null", true)
        {
      ...
      , new FieldExpect<IPAddress>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites), "null" }
        }
      ...
      , new FieldExpect<Uri>(null, "null", true)
        {
            { new EK(AcceptsSpanFormattable | AlwaysWrites), "null" }
        }
      ...
      , new
            FieldExpect<Uri>(new Uri("https://github.com/shwaindog/Fortitude/tree/main/src/FortitudeTests/FortitudeCommon/Types/StringsOfPower/DieCasting/TestData")
                           , "{0[..38]}")
            {
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonEmptyWrites | NonNullWrites | NonNullAndPopulatedWrites
