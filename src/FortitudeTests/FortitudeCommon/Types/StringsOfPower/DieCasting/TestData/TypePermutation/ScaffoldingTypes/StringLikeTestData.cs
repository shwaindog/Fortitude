    ...
    [
      ...
      , new FieldExpect<CharArrayStringBuilder>
                  ...
                  "languages with."), "{0,/,/!/[1..3]}", fromIndex: 16, length: 100)
            {
               ...
               ,
                {
                    new EK(AcceptsChars | AcceptsCharSequence | CallsAsReadOnlySpan | CallsAsSpan | AlwaysWrites | NonEmptyWrites | NonNullWrites |
                           NonNullAndPopulatedWrites, Json | Pretty)
                  , """
                    [
                        " ",
      ...
      , new FieldExpect<StringBuilder>(null, "", true, new StringBuilder())
        {
            { new EK(AcceptsChars | AcceptsStringBuilder | AlwaysWrites | NonEmptyWrites), "null" }
        }
