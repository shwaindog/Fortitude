    ...
    public static PositionUpdatingList<IKeyedCollectionExpect> AllUnfilteredSimpleDictExpectations =>
        allUnfilteredSimpleKeyedCollectionExpectations ??=
            new PositionUpdatingList<IKeyedCollectionExpect>(typeof(SimpleDictTestData))
            {
                      ...
                      , """
                        {
                          ...
                          SimpleAsValueSpanFormattableWithFieldSimpleValueTypeStructStringBearer<decimal>= SimpleTypeAsValueSpanFormattableStruct: 27.183: FieldSpanFormattableAlwaysAddStructStringBearer<Uri> {
                             ComplexTypeFieldAlwaysAddSpanFormattableFromStruct: 27.183:                         null,
                          null:                         null
                        }
                        """.Dos2Unix()
                    }
                      ...
                      , """
                        {
                          ...
                          SimpleAsValueSpanFormattableWithFieldSimpleValueTypeStringBearer<decimal>= SimpleTypeAsValueSpanFormattable: 27.183: FieldSpanFormattableAlwaysAddStringBearer<Uri> {
                             ComplexTypeFieldAlwaysAddSpanFormattable: http://fourth-value.com/ 
                          }
                        }
                        """.Dos2Unix()
              ...
              , new DictionaryExpect<NoDefaultULongNoFlagsEnum, WithDefaultULongWithFlagsEnum>(EnumULongNdNfDateTimeMap.ToList(), "")
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new DictionaryExpect<NoDefaultULongNoFlagsEnum?, WithDefaultULongWithFlagsEnum?>(NullEnumULongNdNfNullStringMap, "")
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
