    ...
    public static PositionUpdatingList<IKeyedCollectionExpect> AllPredicateFilteredSimpleDictExpectations =>
        allPredicateFilteredSimpleKeyedCollectionExpectations ??=
            new PositionUpdatingList<IKeyedCollectionExpect>(typeof(SimpleDictTestData))
            {
                ...
                new DictionaryExpect<bool, int>([], () => TestDictionaries.BoolIntMap_First_1, name: "Empty_Filtered")
                {
              ...
              , new DictionaryExpect<bool, int>(null, () => TestDictionaries.BoolIntMap_First_1)
                {
                    { new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AlwaysWrites), "{}" }
                  , { new EK(AcceptsTypeAllButNullableStruct | AlwaysWrites), "null" }
                  , { new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AlwaysWrites), "{}" }
                }
              , new DictionaryExpect<bool, int>(TestDictionaries.BoolIntMap.ToList(), "0x{0}", "{0[..1]}"
              ...
              , new DictionaryExpect<bool, int>(TestDictionaries.BoolIntMap.ToList(), "\"{0}\"", "\"{0}\""
                                                   , () => TestDictionaries.BoolIntMap_Second_1)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , "{ \"false\": \"0\" }"
              ...
              , new DictionaryExpect<double, ICharSequence>(TestDictionaries.DoubleCharSequenceMap.ToList()
              ...
              , new DictionaryExpect<double, ICharSequence>(TestDictionaries.DoubleCharSequenceMap.ToList(), "", "{0,17}"
