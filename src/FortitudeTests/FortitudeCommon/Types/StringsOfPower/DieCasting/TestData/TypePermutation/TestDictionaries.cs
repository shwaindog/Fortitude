...
public class TestDictionaries
{
    ...
    public static readonly bool?[] NullBoolNullIntMap = [true, null, false, true, false, null, false, true, true, null, false, true, null, null];
    ...
    public static readonly List<KeyValuePair<double?, ICharSequence?>> NullDoubleNullCharSequence = new()
    {
      ...
      , new KeyValuePair<double?, ICharSequence?>(Math.PI, new MutableString("Eating the crust edges of one pie means you have eaten the length of two pi"))
      ...
      , new KeyValuePair<double?, ICharSequence?>(null, new CharArrayStringBuilder("\"Your contract is null AND void\", apparently not the same thing or why say both."))
    ...
    public static readonly List<KeyValuePair<NoDefaultLongNoFlagsEnum?, string?>> NullEnumLongNdNfNullStringMap = new()
    {
      ...
      , new KeyValuePair<NoDefaultLongNoFlagsEnum?, string?>(null
                                                           , "\"Your contract is null AND void\", apparently not the same thing or why say both.")
    ...
    {
        new KeyValuePair<NoDefaultULongNoFlagsEnum?, DateTime?>(NoDefaultULongNoFlagsEnum.NDUNFE_4, new DateTime(4444, 4, 4, 4, 4, 4))
      ...
      , new KeyValuePair<NoDefaultULongNoFlagsEnum?, DateTime?>(NoDefaultULongNoFlagsEnum.NDUNFE_13, new DateTime(2025, 11, 27, 8, 57, 22))
    ...
    public static readonly List<KeyValuePair<WithDefaultLongNoFlagsEnum?, StringBuilder?>> NullEnumULongWdNfNullStringBuilderMap = new()
    {
      ...
      , new KeyValuePair<WithDefaultLongNoFlagsEnum?, StringBuilder?>(null, new StringBuilder("\"Your contract is null AND void\", apparently not the same thing or why say both."))
    ...
    public static readonly List<KeyValuePair<WithDefaultULongNoFlagsEnum?, Version?>> NullEnumULongWdNfNullStringMap = new()
    {
      ...
      , new KeyValuePair<WithDefaultULongNoFlagsEnum?, Version?>(WithDefaultULongNoFlagsEnum.WDUNFE_4, new Version(34, 34, 34, 34))
    ...
    public static readonly List<KeyValuePair<NoDefaultLongWithFlagsEnum?, char[]?>> NullEnumLongNdWfNullStringMap = new()
    {
      ...
      , new KeyValuePair<NoDefaultLongWithFlagsEnum?, char[]?>(NoDefaultLongWithFlagsEnum.NDLWFE_1.First8MinusFlag2Mask()
                                                             , "NDLWFE_First8MinusFlag2Mask".ToCharArray())
      , new KeyValuePair<NoDefaultLongWithFlagsEnum?, char[]?>(NoDefaultLongWithFlagsEnum.NDLWFE_1.First8AndLast2Mask()
                                                             , "NDLWFE_First8AndLast2Mask".ToCharArray())
      , new KeyValuePair<NoDefaultLongWithFlagsEnum?, char[]?>(NoDefaultLongWithFlagsEnum.NDLWFE_1.First8AndLast2MaskPlusUnnamed()
                                                             , "NDLWFE_First8AndLast2MaskPlusUnnamed".ToCharArray())
    ...
    public static readonly List<KeyValuePair<NoDefaultULongWithFlagsEnum?, ICharSequence?>> NullEnumULongNdWfNullStringBuilderMap = new()
    {
      ...
      , new KeyValuePair<NoDefaultULongWithFlagsEnum?, ICharSequence?>(NoDefaultULongWithFlagsEnum.NDUWFE_1.First8MinusFlag2Mask() , new CharArrayStringBuilder("NDUWFE_First8MinusFlag2Mask"))
      , new KeyValuePair<NoDefaultULongWithFlagsEnum?, ICharSequence?>(NoDefaultULongWithFlagsEnum.NDUWFE_1.First8AndLast2Mask(), new MutableString("NDUWFE_First8AndLast2Mask"))
      , new KeyValuePair<NoDefaultULongWithFlagsEnum?, ICharSequence?>(NoDefaultULongWithFlagsEnum.NDUWFE_1.First8AndLast2MaskPlusUnnamed() , new CharArrayStringBuilder("NDUWFE_First8AndLast2MaskPlusUnnamed"))
      , new KeyValuePair<NoDefaultULongWithFlagsEnum?, ICharSequence?>(NoDefaultULongWithFlagsEnum.NDUWFE_1.Default() , new CharArrayStringBuilder("Zero chance"))
      ...
      , new KeyValuePair<NoDefaultULongWithFlagsEnum?, ICharSequence?>(NoDefaultULongWithFlagsEnum.NDUWFE_13 , new CharArrayStringBuilder("NDLWFE_Lucky_Number"))
    ...
    public static readonly List<KeyValuePair<WithDefaultLongWithFlagsEnum?, MyOtherTypeClass?>> NullEnumLongWdWfNullStringMap = new()
    {
      ...
      , new KeyValuePair<WithDefaultLongWithFlagsEnum?, MyOtherTypeClass?>(WithDefaultLongWithFlagsEnum.WDLWFE_1.First8MinusFlag2Mask(), new MyOtherTypeClass("WDLWFE_First8MinusFlag2Mask") )
      , new KeyValuePair<WithDefaultLongWithFlagsEnum?, MyOtherTypeClass?>(WithDefaultLongWithFlagsEnum.WDLWFE_1.First8AndLast2Mask(), new MyOtherTypeClass("WDLWFE_First8AndLast2Mask") )
      , new KeyValuePair<WithDefaultLongWithFlagsEnum?, MyOtherTypeClass?>(WithDefaultLongWithFlagsEnum.WDLWFE_1.First8AndLast2MaskPlusUnnamed(), new MyOtherTypeClass("WDLWFE_First8AndLast2MaskPlusUnnamed") )
      , new KeyValuePair<WithDefaultLongWithFlagsEnum?, MyOtherTypeClass?>(WithDefaultLongWithFlagsEnum.Default, new MyOtherTypeClass("Zero chance"))
      , new KeyValuePair<WithDefaultLongWithFlagsEnum?, MyOtherTypeClass?>(WithDefaultLongWithFlagsEnum.WDLWFE_13
                                                                         , new MyOtherTypeClass("WDLWFE_Lucky_Number"))
    ...
    public static readonly Dictionary<WithDefaultULongWithFlagsEnum, MySpanFormattableStruct> EnumULongWdWfStringBuilderMap = new()
    {
      ...
      , { WithDefaultULongWithFlagsEnum.WDUWFE_1.First8AndLast2MaskPlusUnnamed(), new MySpanFormattableStruct("WDUWFE_First8AndLast2MaskPlusUnnamed") }
    ...
    {
        new KeyValuePair<WithDefaultULongWithFlagsEnum?, MySpanFormattableStruct?>(WithDefaultULongWithFlagsEnum.WDUWFE_4
                                                                                 , new MySpanFormattableStruct())
      , new KeyValuePair<WithDefaultULongWithFlagsEnum?, MySpanFormattableStruct?>(null, new MySpanFormattableStruct("\"Your contract is null AND void\", apparently not the same thing or why say both."))
      , new KeyValuePair<WithDefaultULongWithFlagsEnum?, MySpanFormattableStruct?>(WithDefaultULongWithFlagsEnum.WDUWFE_1.First8MinusFlag2Mask(), new MySpanFormattableStruct("WDUWFE_First8MinusFlag2Mask") )
      , new KeyValuePair<WithDefaultULongWithFlagsEnum?, MySpanFormattableStruct?>(WithDefaultULongWithFlagsEnum.WDUWFE_1.First8AndLast2Mask(), new MySpanFormattableStruct("WDUWFE_First8AndLast2Mask") )
      , new KeyValuePair<WithDefaultULongWithFlagsEnum?, MySpanFormattableStruct?>(WithDefaultULongWithFlagsEnum.WDUWFE_1.First8AndLast2MaskPlusUnnamed(), new MySpanFormattableStruct("WDUWFE_First8AndLast2MaskPlusUnnamed") )
      , new KeyValuePair<WithDefaultULongWithFlagsEnum?, MySpanFormattableStruct?>(WithDefaultULongWithFlagsEnum.Default, new MySpanFormattableStruct("Zero chance"))
      , new KeyValuePair<WithDefaultULongWithFlagsEnum?, MySpanFormattableStruct?>(WithDefaultULongWithFlagsEnum.WDUWFE_1, null)
      , new KeyValuePair<WithDefaultULongWithFlagsEnum?, MySpanFormattableStruct?>(WithDefaultULongWithFlagsEnum.WDUWFE_13
                                                                                 , new MySpanFormattableStruct("WDUWFE_Lucky_Number"))
