        ...
        allValueRevealerSubListFilteredKeyedCollectionExpectations ??=
            new PositionUpdatingList<IKeyedCollectionExpect>(typeof(ValueRevealerDictTestData))
            {
                ...
                new ValueRevealerKeyedSubListDictExpect<bool, int>
                    ([],() => TestDictionaries.Int_NegativeString_Reveal
                   , () => TestDictionaries.Bool_True_SubList, name: "Empty_Filtered")
                {
              ...
              , new ValueRevealerKeyedSubListDictExpect<bool, int>(null,() => TestDictionaries.Int_NegativeString_Reveal
                                                                       , () => TestDictionaries.Bool_False_SubList)
                {
                    { new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AlwaysWrites), "{}" }
              ...
              , new ValueRevealerKeyedSubListDictExpect<bool, int>
                    (TestDictionaries.BoolIntMap.ToList(), () => TestDictionaries.Int_NegativeString_Reveal, "{0[..1]}"
                   , name: "AllKeysSubList")
                {
                    {
              ...
              , new ValueRevealerKeyedSubListDictExpect<double, ICharSequence>
                    ([], () => TestDictionaries.CharSequenceMap_Pad50, "", name: "Empty_DoubleSubList")
                {
                    { new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan), "{}" }
                  , { new EK(AcceptsTypeAllButNullableStruct | AlwaysWrites | NonNullWrites), "{}" }
                  , { new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AlwaysWrites), "{}" }
              ...
              , new ValueRevealerKeyedSubListDictExpect<double, ICharSequence>
                    (null, () => TestDictionaries.CharSequenceMap_Pad50, "")
                {
                    { new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AlwaysWrites), "{}" }
                  , { new EK(AcceptsTypeAllButNullableStruct | AlwaysWrites), "null" }
                  , { new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AlwaysWrites), "{}" }
              ...
              , new ValueRevealerKeyedSubListDictExpect<double, ICharSequence>
                    (TestDictionaries.DoubleCharSequenceMap.ToList(), () => TestDictionaries.CharSequenceMap_Pad50
                   , "", () => TestDictionaries.Double_First_4_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog), 
                        """
              ...
              , new ValueRevealerKeyedSubListDictExpect<double, ICharSequence>
                    (TestDictionaries.DoubleCharSequenceMap.ToList(), () => TestDictionaries.CharSequenceMap_Pad50
                   , "{0,-17}", () => TestDictionaries.Double_Second_4_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
