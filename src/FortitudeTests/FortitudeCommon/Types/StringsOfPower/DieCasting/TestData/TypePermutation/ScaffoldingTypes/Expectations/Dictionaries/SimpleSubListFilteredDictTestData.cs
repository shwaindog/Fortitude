    ...
    public static PositionUpdatingList<IKeyedCollectionExpect> AllSubListFilteredDictExpectations =>
        allSubListFilteredSimpleKeyedCollectionExpectations ??=
            new PositionUpdatingList<IKeyedCollectionExpect>(typeof(SimpleDictTestData))
            {
                ...
                new KeyedSubListDictionaryExpect<bool, int>([], () => TestDictionaries.Bool_True_SubList, name: "Empty_Filtered")
                {
              ...
              , new KeyedSubListDictionaryExpect<bool, int>(null, () => TestDictionaries.Bool_False_SubList)
                {
                    { new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AlwaysWrites), "{}" }
                  , { new EK(AcceptsTypeAllButNullableStruct | AlwaysWrites), "null" }
                  , { new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AlwaysWrites), "{}" }
                }
              , new KeyedSubListDictionaryExpect<bool, int>(TestDictionaries.BoolIntMap.ToList(), "0x{0}", "{0[..1]}", name: "AllKeysSubList")
                {
                    {
              ...
              , new KeyedSubListDictionaryExpect<double, ICharSequence>([], () => TestDictionaries.Double_First_4_SubList
              ...
              , new KeyedSubListDictionaryExpect<double, ICharSequence>(null, () => TestDictionaries.Double_First_4_SubList)
                {
                    { new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AlwaysWrites), "{}" }
                  , { new EK(AcceptsTypeAllButNullableStruct | AlwaysWrites), "null" }
                  , { new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AlwaysWrites), "{}" }
                }
              , new KeyedSubListDictionaryExpect<double, ICharSequence>(TestDictionaries.DoubleCharSequenceMap.ToList(),
              ...
              , new KeyedSubListDictionaryExpect<double, ICharSequence>(TestDictionaries.DoubleCharSequenceMap.ToList(), "", "{0,-17}"
                                                                       , () => TestDictionaries.Double_Second_4_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
