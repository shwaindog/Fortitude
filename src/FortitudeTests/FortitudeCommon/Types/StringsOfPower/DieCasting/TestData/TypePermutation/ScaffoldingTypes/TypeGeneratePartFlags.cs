...
public static class ScaffoldingStringBuilderInvokeFlagsExtensions
{
    ...
    public static bool IsAcceptsAny(this ScaffoldingStringBuilderInvokeFlags flags)              => (flags & AcceptsAnyGeneric) == AcceptsAnyGeneric;
    public static bool IsNotAcceptsAny(this ScaffoldingStringBuilderInvokeFlags flags)           => !flags.HasAllOf(AcceptsAnyGeneric);
