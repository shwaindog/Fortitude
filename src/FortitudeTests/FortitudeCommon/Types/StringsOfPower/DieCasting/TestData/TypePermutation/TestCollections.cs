...
public static class TestCollections
{
    ...
    public static PalantírReveal<sbyte> SByteF0OrDefault42Revealer = (showMe, tos) => tos.StartSimpleValueType(showMe).AsValueOrDefault(showMe, 42, "F0");
    public static PalantírReveal<sbyte> SByteF2OrDefault42Revealer = (showMe, tos) => tos.StartSimpleValueType(showMe).AsValueOrDefault(showMe, "42.00,", "{0,15:F2}");

    public static PalantírReveal<sbyte> SByteF4OrDefault42Revealer = (showMe, tos) => tos.StartSimpleValueType(showMe).AsValueOrDefault(showMe, 42, "F4");
    ...
    [
      ...
      , new (4, 2, 25), new(8,3, 3, 3), new (0, 4), new (16, 0, 0),
        new(32,2563, 1000000, 1),
    ];
