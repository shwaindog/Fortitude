...
public class StandardSinglePropertyFieldClass : IStringBearer
{
    ...
    public StateExtractStringRange AlwaysRevealAll(ITheOneString tos)
    {
        ...
        ctb.Field.AlwaysAdd(nameof(HalfNanSingPropield), HalfNanSingPropield);
        ...
        ctb.Field.AlwaysAdd(nameof(NullHalfSingPropield), NullHalfSingPropield);
        ...
        ctb.Field.AlwaysAdd(nameof(HalfSetSingPropield), HalfSetSingPropield);
    ...
    public StateExtractStringRange WhenNonDefaultReveal(ITheOneString tos)
    {
        ...
        ctb.Field.WhenNonDefaultAdd(nameof(HalfSetSingPropield), HalfSetSingPropield);
        ctb.Field.WhenNonDefaultAdd(nameof(HalfNanSingPropield), HalfNanSingPropield);
        ...
        ctb.Field.WhenNonDefaultAdd(nameof(NullHalfSingPropield), NullHalfSingPropield);
    ...
    public StateExtractStringRange WhenNonNullReveal(ITheOneString tos)
    {
        ...
        ctb.Field.WhenNonNullAdd(nameof(HalfSetSingPropield), HalfSetSingPropield);
        ctb.Field.WhenNonNullAdd(nameof(HalfNanSingPropield), HalfNanSingPropield);
        ...
        ctb.Field.WhenNonNullAdd(nameof(NullHalfSingPropield), NullHalfSingPropield);
