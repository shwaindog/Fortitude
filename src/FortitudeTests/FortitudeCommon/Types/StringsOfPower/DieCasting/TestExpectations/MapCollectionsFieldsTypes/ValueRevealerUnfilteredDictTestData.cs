                      ...
                      , """
                        {
                         ...
                         "ComplexContentAsValueSpanFormattable<decimal> { SpanFormattableComplexContentAsValue: 27.183 }":
                         (FieldSpanFormattableAlwaysAddStringBearer<Uri>)       http://fourth-value.com/
                         }
                        """.RemoveLineEndings()
                    }
                   ,
