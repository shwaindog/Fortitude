        ...
        allBothRevealersUnfilteredKeyedCollectionExpectations ??=
            new PositionUpdatingList<IKeyedCollectionExpect>(typeof(BothRevealersDictTestData))
            {
                          ...
                          , """
                            {
                             ...
                             (MySpanFormattableStruct)    Fourth_SpanStruct: (MySpanFormattableClass) Fourth_SpanClass    ,
                             (MySpanFormattableStruct)     Fifth_SpanStruct: (MySpanFormattableClass) Fifth_SpanClass     ,
                             (MySpanFormattableStruct)     Sixth_SpanStruct: (MySpanFormattableClass) Sixth_SpanClass      
                            }
                            """.RemoveLineEndings()
                        }
                       ,
              ...
              , new BothRevealersDictExpect<MySpanFormattableStruct?, MySpanFormattableClass?, MySpanFormattableStruct?, MySpanFormattableClass?, MySpanFormattableStruct?, MySpanFormattableClass, MySpanFormattableStruct>
                   ...
                   , (Expression<Func<KeyValuePredicate<MySpanFormattableStruct?, MySpanFormattableClass?>>>?)null  )
                    {
                        {
                            new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                          , """
                          ...
                          , """
                            {
                             ...
                             (MySpanFormattableClass)     Second_SpanClass: (MySpanFormattableStruct) Second_SpanStruct   ,
                             (MySpanFormattableClass)      Third_SpanClass: (MySpanFormattableStruct) Third_SpanStruct    ,
              ...
              , new BothRevealersDictExpect<MySpanFormattableClass?, MySpanFormattableStruct?, MySpanFormattableClass?, MySpanFormattableStruct?, MySpanFormattableClass?, MySpanFormattableStruct, MySpanFormattableClass>
                   ...
                   , () => MySpanFormattableStruct_Reveal_Pad20
                   , () => MySpanFormattableClass_Reveal_PadMinus20
                   , (Expression<Func<KeyValuePredicate<MySpanFormattableClass?, MySpanFormattableStruct?>>>?)null)
                    {
                        {
                            new EK(AcceptsNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                          , """
                            {
                             ...
                             (MySpanFormattableClass) Third_SpanClass     : (MySpanFormattableStruct)     Third_SpanStruct,
                             (MySpanFormattableClass) Fourth_SpanClass    : null,
                             null: null
                             }
                            """.RemoveLineEndings()
                        }
                    ...
                    {
                        {
                          ...
                          , """
                            {
                             (ComplexStructContentAsValueSpanFormattable<decimal>) 3.142:
                             (FieldSpanFormattableAlwaysAddStructStringBearer<Uri>)
                                    http://first-value.com/,
                             (ComplexStructContentAsValueSpanFormattable<decimal>) 2.718:
                             (FieldSpanFormattableAlwaysAddStructStringBearer<Uri>)
                                   http://second-value.com/,
                             (ComplexStructContentAsValueSpanFormattable<decimal>) 31.416:
                             (FieldSpanFormattableAlwaysAddStructStringBearer<Uri>)
                                    http://third-value.com/,
                             (ComplexStructContentAsValueSpanFormattable<decimal>) 27.183:
                             (FieldSpanFormattableAlwaysAddStructStringBearer<Uri>)
                                   http://fourth-value.com/
                             }
                            """.RemoveLineEndings()
                        }
                       ,
                          ...
                          , """
                            {
                              ...
                              (ComplexStructContentAsValueSpanFormattable<decimal>) 27.183: (FieldSpanFormattableAlwaysAddStructStringBearer<Uri>)       http://fourth-value.com/
                            }
                            """.Dos2Unix()
                        }
                       ,
                          ...
                          , """
                            {
                             ...
                             (ComplexStructContentAsValueSpanFormattable<decimal>) 27.183: null,
                             null: null 
                            }
                            """.RemoveLineEndings()
                        }
                          ...
                          , """
                            {
                             ...
                             (ComplexContentAsValueSpanFormattable<decimal>) 31.416: (FieldSpanFormattableAlwaysAddStringBearer<Uri>)
                                    http://third-value.com/,
                             (ComplexContentAsValueSpanFormattable<decimal>) 27.183: (FieldSpanFormattableAlwaysAddStringBearer<Uri>)
                                   http://fourth-value.com/
                             }
                            """.RemoveLineEndings()
                        }
                          ...
                          , """
                            {
                              ...
                              (ComplexContentAsValueSpanFormattable<decimal>) 27.183: (FieldSpanFormattableAlwaysAddStringBearer<Uri>)       http://fourth-value.com/
                            }
                            """.Dos2Unix()
                        }
                       ,
              ...
              , new BothRevealersDictExpect<ComplexContentAsValueSpanFormattable<decimal>?
                   ...
                   , () => StructBearer_Reveal_Pad30
                   , () => ClassBearerDecimal_Reveal_N3
                   , (Expression<Func<KeyValuePredicate<ComplexContentAsValueSpanFormattable<decimal>?
                       , FieldSpanFormattableAlwaysAddStructStringBearer<Uri>?>>>?)null)
                    {
                        {
                            new EK(AcceptsNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                          , """
                            {
                             ...
                             (FieldSpanFormattableAlwaysAddStructStringBearer<Uri>)        http://third-value.com/,
                             (ComplexContentAsValueSpanFormattable<decimal>) 27.183: null,
                             null: null 
                            }
                            """.RemoveLineEndings()
                        }
