...
using static FortitudeTests.FortitudeCommon.Types.StringsOfPower.DieCasting.Scenarios.CompareToSystemTextJson.TypePermutation.TestDictionaries;
...
{
    private static PositionUpdatingList<IKeyedCollectionExpect>? allValueRevealerSubListFilteredKeyedCollectionExpectations;

    public static PositionUpdatingList<IKeyedCollectionExpect> AllValueRevealerSubListFilteredDictExpectations =>
        allValueRevealerSubListFilteredKeyedCollectionExpectations ??=
            new PositionUpdatingList<IKeyedCollectionExpect>(typeof(ValueRevealerDictTestData))
            {
                ...
                new ValueRevealerKeyedSubListDictExpect<bool, int>
                    ([],() => Int_NegativeString_Reveal
                   , () => Bool_True_SubList, name: "Empty_Filtered")
                {
                    { new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AlwaysWrites | NonNullWrites), "{}" }
                }
              , new ValueRevealerKeyedSubListDictExpect<bool, int>(null,() => Int_NegativeString_Reveal
                                                                       , () => Bool_False_SubList)
                {
              ...
              , new ValueRevealerKeyedSubListDictExpect<bool, int>
                    (BoolIntMap.ToList(), () => Int_NegativeString_Reveal, "{0[..1]}"
                   , name: "AllKeysSubList")
                {
                    {
              ...
              , new ValueRevealerKeyedSubListDictExpect<double, ICharSequence>
                    ([], () => CharSequenceMap_Pad50, "", name: "Empty_DoubleSubList")
                {
                    { new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AlwaysWrites | NonNullWrites), "{}" }
                }
              , new ValueRevealerKeyedSubListDictExpect<double, ICharSequence>
                    (null, () => CharSequenceMap_Pad50, "")
                {
                    { new EK(IsKeyedCollectionType | AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan), "{}" }
                  , { new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AlwaysWrites), "null" }
                }
              ...
              , new ValueRevealerKeyedSubListDictExpect<UInt128, BigInteger>
                    (VeryULongBigIntegerMap.ToList()
                   , () => BigInteger_Separators
                   , "'{0}'", () => VeryULong_First_3_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new NullStructValueRevealerKeyedSubListDictExpect<UInt128, BigInteger>
                    (NullVeryULongBigIntegerMap
                   , () => BigInteger_Reveal_Pad45, "\"{0,-45}\"" , () => VeryULong_Second_3_SubList)
                {
                    {
              ...
              , new ValueRevealerKeyedSubListDictExpect<IPAddress, Uri>
              ...
              , new  NullClassValueRevealerKeyedSubListDictExpect<IPAddress, Uri>
                    (IPAddressNullUriMap,
                     () => Uri_Reveal_RightArrow, "{0,18}")
                {
                    {
              ...
              , new ValueRevealerKeyedSubListDictExpect<MySpanFormattableStruct, MySpanFormattableClass>
                    (MySpanFormattableStructClassMap.ToList()
                   , () => MySpanFormattableClass_Reveal_PadMinus20, "{0,20}", () => MySpanFormattableStruct_First_3_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new NullClassValueRevealerKeyedSubListDictExpect<MySpanFormattableStruct, MySpanFormattableClass>
                    (MySpanFormattableStructNullClassMap
                   , () => MySpanFormattableClass_Reveal_Pad20, "{0,-20}", () => MySpanFormattableStruct_Second_3_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new ValueRevealerKeyedSubListDictExpect<MySpanFormattableClass, MySpanFormattableStruct>
                    (MySpanFormattableClassStructMap.ToList()
                   , () => MySpanFormattableStruct_Reveal_PadMinus20, "{0,20}", () => MySpanFormattableClass_Second_3_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new NullStructValueRevealerKeyedSubListDictExpect<MySpanFormattableClass, MySpanFormattableStruct>
                    (MySpanFormattableNullClassStructMap.ToList(), 
                     () => MySpanFormattableStruct_Reveal_Pad20, "{0,-20}", () => MySpanFormattableClass_First_3_SubList)
                {
                    {
                        new EK(AcceptsNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new ValueRevealerKeyedSubListDictExpect<ComplexStructContentAsValueSpanFormattable<decimal>
                      , FieldSpanFormattableAlwaysAddStructStringBearer<Uri>>
                    (StructBearerToComplexBearerMap.ToList()
                   , () => StructBearer_Reveal_Pad30, "N3", () => StructBearer_Second_3_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
                        {
                         ...
                         SpanFormattableComplexStructContentAsValue: 27.183 }: FieldSpanFormattableAlwaysAddStructStringBearer<Uri>= ComplexTypeFieldAlwaysAddSpanFormattableFromStruct: http://fourth-value.com/ 
                        }
                        """.RemoveLineEndings()
                    }
                   ,
              ...
              , new NullStructValueRevealerKeyedSubListDictExpect<ComplexStructContentAsValueSpanFormattable<decimal>
                      , FieldSpanFormattableAlwaysAddStructStringBearer<Uri>>
                    (StructBearerToNullComplexStructBearerMap
                   , () => StructBearer_Reveal_Pad30, "N3", () => StructBearer_First_3_SubList)
                {
                    {
                        new EK(AcceptsNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new ValueRevealerKeyedSubListDictExpect<ComplexContentAsValueSpanFormattable<decimal>
                      , FieldSpanFormattableAlwaysAddStringBearer<Uri>>(ClassBearerToComplexBearerMap.ToList()
                   , () => ClassBearer_Reveal_Pad30, "N3", () => ClassBearer_First_3_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new NullStructValueRevealerKeyedSubListDictExpect<ComplexContentAsValueSpanFormattable<decimal>
                      , FieldSpanFormattableAlwaysAddStructStringBearer<Uri>>
                    (ClassBearerToNullStructComplexBearerMap, 
                     () => StructBearer_Reveal_Pad30, "N3", () => ClassBearer_First_3_SubList)
                {
                    {
                        new EK(AcceptsNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new ValueRevealerKeyedSubListDictExpect<NoDefaultLongNoFlagsEnum, WithDefaultLongWithFlagsEnum>
                    (EnumLongNdNfToWdWfMap.ToList(),
                     () => WithDefaultLongWithFlags_Reveal, null, () => EnumLongNdNfToWdWf_Second_3_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new NullStructValueRevealerKeyedSubListDictExpect<NoDefaultLongNoFlagsEnum, WithDefaultLongWithFlagsEnum>
              ...
              , new ValueRevealerKeyedSubListDictExpect<NoDefaultULongNoFlagsEnum, WithDefaultULongWithFlagsEnum>
                    (EnumULongNdNfToWdwfMap.ToList()
                   , () => WithDefaultULongWithFlags_Reveal
                   , null, () => EnumULongNdNfDateTime_First_3_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new NullStructValueRevealerKeyedSubListDictExpect<NoDefaultULongNoFlagsEnum, WithDefaultULongWithFlagsEnum>
              ...
              , new ValueRevealerKeyedSubListDictExpect<WithDefaultLongNoFlagsEnum, NoDefaultLongWithFlagsEnum>
                    (EnumLongWdNfToNdWfMap.ToList()
                   , () => NoDefaultLongWithFlags_Reveal
                   , null, () => EnumLongWdNfToNdWf_Second_3_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new NullStructValueRevealerKeyedSubListDictExpect<WithDefaultLongNoFlagsEnum, NoDefaultLongWithFlagsEnum>
              ...
              , new ValueRevealerKeyedSubListDictExpect<WithDefaultULongNoFlagsEnum, NoDefaultULongWithFlagsEnum>
                    (EnumULongWdNfToNdWfMap.ToList()
                   , () => NoDefaultULongWithFlags_Reveal
                   , null, () => EnumULongWdNfToNdWf_First_3_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new NullStructValueRevealerKeyedSubListDictExpect<WithDefaultULongNoFlagsEnum, NoDefaultULongWithFlagsEnum>
                    (EnumULongWdNfToNullNdWfMap
                   , () =>  NoDefaultULongWithFlags_Reveal
                   , null, () => EnumULongWdNfToNdWf_Second_3_SubList)
                {
                    {
                        new EK(AcceptsNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new ValueRevealerKeyedSubListDictExpect<NoDefaultLongWithFlagsEnum, WithDefaultLongNoFlagsEnum>
                    (EnumLongNdWfToWdNfMap.ToList()
                   , () =>  WithDefaultLongNoFlags_Reveal
                   , null, () => EnumLongNdWfToWdNf_First_3_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new NullStructValueRevealerKeyedSubListDictExpect<NoDefaultLongWithFlagsEnum, WithDefaultLongNoFlagsEnum>
                    (EnumLongNdWfToNullWdNfMap
                   , () =>  WithDefaultLongNoFlags_Reveal
                   , null, () => EnumLongNdWfToWdNf_Second_3_SubList)
                {
                    {
                        new EK(AcceptsNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new ValueRevealerKeyedSubListDictExpect<NoDefaultULongWithFlagsEnum, WithDefaultULongNoFlagsEnum>
                    (EnumULongNdWfToWdNfMap.ToList()
                   , () =>  WithDefaultULongNoFlags_Reveal
                   , null, () => EnumULongNdWfToWdNf_First_3_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new NullStructValueRevealerKeyedSubListDictExpect<NoDefaultULongWithFlagsEnum, WithDefaultULongNoFlagsEnum>
              ...
              , new ValueRevealerKeyedSubListDictExpect<WithDefaultLongWithFlagsEnum, NoDefaultLongNoFlagsEnum>
                    (EnumLongWdWfToNdNfMap.ToList()
                   , () =>  NoDefaultLongNoFlags_Reveal
                   , null, () => EnumLongWdWfToNdNf_Second_3_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new NullStructValueRevealerKeyedSubListDictExpect<WithDefaultLongWithFlagsEnum, NoDefaultLongNoFlagsEnum>
                    (EnumLongWdWfToNullNdNfMap
                   , () =>  NoDefaultLongNoFlags_Reveal
                   , null, () => EnumLongWdWfToNdNf_First_3_SubList)
                {
                    {
                        new EK(AcceptsNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new ValueRevealerKeyedSubListDictExpect<WithDefaultULongWithFlagsEnum, NoDefaultULongNoFlagsEnum>
                    (EnumULongWdWfToNdNfMap.ToList()
                   , () =>  NoDefaultULongNoFlags_Reveal
                   , null, () => EnumULongWdWfToNdNf_Second_3_SubList)
                {
                    {
                        new EK(AcceptsTypeAllButNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
              ...
              , new NullStructValueRevealerKeyedSubListDictExpect<WithDefaultULongWithFlagsEnum, NoDefaultULongNoFlagsEnum>
                    (EnumULongWdWfToNullNdNfMap
                   , () =>  NoDefaultULongNoFlags_Reveal
                   , null, () => EnumULongWdWfToNdNf_First_3_SubList)
                {
                    {
                        new EK(AcceptsNullableStruct | CallsAsSpan | CallsAsReadOnlySpan | AllOutputConditionsMask, CompactLog)
                      , """
