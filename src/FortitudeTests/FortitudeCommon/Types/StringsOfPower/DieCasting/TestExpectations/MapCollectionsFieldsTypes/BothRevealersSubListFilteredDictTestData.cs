                ...
                {
                    {
                      ...
                      , """
                        {
                         ComplexContentAsValueSpanFormattable<decimal>= 3.142: null,
                         ComplexContentAsValueSpanFormattable<decimal>= 2.718: FieldSpanFormattableAlwaysAddStructStringBearer<Uri>=
                               http://second-value.com/,
                         ComplexContentAsValueSpanFormattable<decimal>= 31.416: FieldSpanFormattableAlwaysAddStructStringBearer<Uri>=
                                http://third-value.com/
                         }
                        """.RemoveLineEndings()
                    }
