        ...
        new PositionUpdatingList<IStringLikeExpectation>(typeof(StringBuilderTestData))
        {
                ...
                (new StringBuilder(""), "", true, new StringBuilder("0"))
            {
              ...
              , { new EK(IsContentType | CallsViaMatch | DefaultTreatedAsStringOut), "\"\"" }
               ,
                {
                    new EK(IsContentType | AcceptsChars | AcceptsStringBuilder | DefaultTreatedAsValueOut | DefaultBecomesZero
                         | DefaultBecomesFallbackValue)
                  , "0"
                }
               ,
                {
                    new EK(IsContentType | AcceptsChars | AcceptsStringBuilder | DefaultTreatedAsValueOut | DefaultTreatedAsStringOut
                         | EmptyBecomesNull | DefaultBecomesNull)
                  , "null"
                }
               ,
                {
                    new EK(IsContentType | AcceptsChars | AcceptsStringBuilder | DefaultTreatedAsStringOut | DefaultBecomesZero
                         | DefaultBecomesFallbackValue)
                  , "\"0\""
                }
               ,
                {
                    new EK(IsContentType | AcceptsChars | AcceptsStringBuilder | DefaultTreatedAsStringOut | DefaultBecomesEmpty)
                  , "\"\""
                }
              , { new EK(IsContentType | AcceptsChars | AcceptsStringBuilder | DefaultTreatedAsValueOut), "" }
               ,
                {
                    new EK(IsContentType | AcceptsChars | AcceptsStringBuilder | DefaultTreatedAsStringOut)
                  , "\"\""
                }

               ,
                {
                    new EK(IsComplexType | AcceptsChars | AcceptsStringBuilder | AlwaysWrites | NonDefaultWrites
                         | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites)
                  , "\"\""
                }
              , { new EK(IsComplexType | AcceptsChars | AcceptsStringBuilder | AlwaysWrites | NonDefaultWrites), "null" }
            }
          , new StringLikeExpect<StringBuilder, StringBuilder>
                (null, "", true, new StringBuilder(""))
            {
              ...
              , { new EK(IsContentType | CallsViaMatch | DefaultTreatedAsValueOut | DefaultTreatedAsStringOut), "null" }
               ,
                {
          ...
          , new StringLikeExpect<StringBuilder>(new StringBuilder("with"), "\"{0[8..10]}\"")
            {
                { new EK(IsContentType | CallsViaMatch | AcceptsStringBuilder, Log | Compact | Pretty), "\"\"" }
              , { new EK(IsContentType | CallsViaMatch | AcceptsStringBuilder | DefaultBecomesFallbackValue | DefaultTreatedAsValueOut), "\"\"" }
              , { new EK(IsContentType | CallsViaMatch | AcceptsStringBuilder | DefaultBecomesFallbackValue), "\"\\u0022\\u0022\"" }
              , { new EK(IsContentType | AcceptsChars | AcceptsStringBuilder, Log | Compact | Pretty), "\"\"" }
              , { new EK(IsContentType | AcceptsChars | AcceptsStringBuilder | DefaultTreatedAsValueOut), "\"\"" }
               ,
                {
                    new EK(IsContentType | AcceptsChars | AcceptsStringBuilder)
                  , "\"\\u0022\\u0022\""
                }
