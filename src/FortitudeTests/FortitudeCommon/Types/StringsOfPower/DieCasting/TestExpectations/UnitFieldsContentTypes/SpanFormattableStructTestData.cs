    ...
    public static PositionUpdatingList<ISingleFieldExpectation> SpanFormattableStructExpectations => spanFormattableStructExpectations ??=
        new PositionUpdatingList<ISingleFieldExpectation>(typeof(SpanFormattableStructTestData))
        {
            ...
            new FieldExpect<DateTime>(DateTime.MinValue, "O")
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"0001-01-01T00:00:00.0000000\"" }
               ,
                {
          ...
          , new FieldExpect<DateTime>(new DateTime(2000, 1, 1, 1, 1, 1).AddTicks(1111111), "o")
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"2000-01-01T01:01:01.1111111\"" }
               ,
                {
          ...
          , new FieldExpect<DateTime>(new DateTime(2020, 2, 2)
                                    ...
                                    , new DateTime(2020, 2, 2).AddTicks(2222222))
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"2020-02-02T00:00:00\"" }
          ...
          , new FieldExpect<DateTime>(DateTime.MaxValue, "'{0:u}'")
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"'9999-12-31 23:59:59Z'\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
                         , Log | Compact | Pretty)
          ...
          , new FieldExpect<DateTime>(DateTime.MinValue, "\"{0,30:u}\"", true, new DateTime(2020, 1, 1))
            {
                { new EK(IsContentType | AcceptsSpanFormattable, Log | Compact | Pretty), "\"          0001-01-01 00:00:00Z\"" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut), "\"          0001-01-01 00:00:00Z\"" }
               ,
                {
          ...
          , new FieldExpect<DateTime>(new DateTime(1980, 7, 31, 11, 48, 13), "'{0:yyyy-MM-dd HH:mm:ss}'")
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"'1980-07-31 11:48:13'\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
                         , Log | Compact | Pretty)
          ...
          , new FieldExpect<DateTime>(new DateTime(2009, 11, 12, 19, 49, 0), "\"{0,-30:O}\"")
            {
                { new EK(IsContentType | AcceptsSpanFormattable, Log | Compact | Pretty), "\"2009-11-12T19:49:00.0000000   \"" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut), "\"2009-11-12T19:49:00.0000000   \"" }
               ,
                {
                    new EK(IsContentType | AcceptsSpanFormattable)
                  , """
          ...
          , new FieldExpect<DateTime?>(null, "yyyy-MM-ddTHH:mm:ss", true)
            {
               ...
               ,
                {
                    new EK(IsContentType | CallsViaMatch | DefaultTreatedAsValueOut |  DefaultBecomesFallbackString 
                         | DefaultBecomesFallbackValue, Log | Compact | Pretty), "0001-01-01T00:00:00"
                }
              , { new EK(IsContentType | CallsViaMatch), "\"0001-01-01T00:00:00\"" }
             , {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultBecomesZero |  DefaultBecomesFallbackString 
                       | DefaultBecomesFallbackValue), "\"0001-01-01T00:00:00\"" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultBecomesNull), "null" }
              ,
                {
          ...
          , new FieldExpect<TimeSpan>(TimeSpan.Zero, "!nV^1LD")
            {
                { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Log | Compact | Pretty), "00:00:00" }
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"00:00:00\"" }
          ...
          , new FieldExpect<TimeSpan>(new TimeSpan(1, 1, 1, 1, 111, 111), "c")
            {
                { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Log | Compact | Pretty), "1.01:01:01.1111110" }
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"1.01:01:01.1111110\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
                         , Log | Compact | Pretty)
               ...
               , new TimeSpan(-2, -22, -22, -22, -222, -222))
                {
                  ...
                  , { new EK(IsContentType | AcceptsSpanFormattable), "\"-2:22:22:22.2222220\"" }
          ...
          , new FieldExpect<TimeSpan>(TimeSpan.MaxValue, "'{0:G}'")
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"'10675199:02:48:05.4775807'\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
                         , Log | Compact | Pretty)
          ...
          , new FieldExpect<TimeSpan>(TimeSpan.MinValue, "\"{0,30:c}\"", true, TimeSpan.Zero)
            {
                { new EK(IsContentType | AcceptsSpanFormattable, Log | Compact | Pretty), "\"    -10675199.02:48:05.4775808\"" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut), "\"    -10675199.02:48:05.4775808\"" }
               ,
                {
                    new EK(IsContentType | AcceptsSpanFormattable)
                  , """
          ...
          , new FieldExpect<TimeSpan>(new TimeSpan(3, 3, 33, 33, 333, 333),
                                      "'{0:dd\\-hh\\-mm\\-ss\\.fff}'")
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"'03-03-33-33.333'\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
                         , Log | Compact | Pretty)
          ...
          , new FieldExpect<TimeSpan>(new TimeSpan(-4, -4, -44, -44, -444, -444), "\"{0,-30:G}\"")
            {
                { new EK(IsContentType | AcceptsSpanFormattable, Log | Compact | Pretty), "\"-4:04:44:44.4444440           \"" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut), "\"-4:04:44:44.4444440           \"" }
               ,
                {
                    new EK(IsContentType | AcceptsSpanFormattable)
                  , """
          ...
          , new FieldExpect<TimeSpan?>(null, "", true)
            {
              ...
              , { new EK(IsContentType | CallsViaMatch |  DefaultBecomesFallbackString | DefaultBecomesFallbackValue), "\"00:00:00\"" }
               ,
                {
                    new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut | DefaultBecomesZero
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable |  DefaultBecomesFallbackString 
          ...
          , new FieldExpect<TimeSpan?>(new TimeSpan(-2, -22, -22, -22, -222, -222), "G", true
                                     , new TimeSpan(-2, -22, -22, -22, -222, -222))
            {
                { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Log | Compact | Pretty), "-2:22:22:22.2222220" }
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"-2:22:22:22.2222220\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonNullWrites, Log | Compact | Pretty)
          ...
          , new FieldExpect<TimeSpan?>(TimeSpan.MaxValue, "'{0:G}'")
            {
                { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Log | Compact | Pretty), "'10675199:02:48:05.4775807'" }
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"'10675199:02:48:05.4775807'\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
          ...
          , new FieldExpect<TimeSpan?>(new TimeSpan(3, 3, 33, 33, 333, 333),
                                       "'{0:dd\\-hh\\-mm\\-ss\\.fff}'")
            {
                { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Log | Compact | Pretty), "'03-03-33-33.333'" }
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"'03-03-33-33.333'\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
          ...
          , new FieldExpect<DateOnly>(DateOnly.MinValue, "o")
            {
                { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Log | Compact | Pretty), "0001-01-01" }
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"0001-01-01\"" }
          ...
          , new FieldExpect<DateOnly>(new DateOnly(2000, 1, 1), "o")
            {
                { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Log | Compact | Pretty), "2000-01-01" }
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"2000-01-01\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
                         , Log | Compact | Pretty)
          ...
          , new FieldExpect<DateOnly>(new DateOnly(2020, 2, 2), "o", true
            ...
            {
                { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Log | Compact | Pretty), "2020-02-02" }
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"2020-02-02\"" }
          ...
          , new FieldExpect<DateOnly>(DateOnly.MaxValue, "'{0:o}'")
            {
                { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Log | Compact | Pretty), "'9999-12-31'" }
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"'9999-12-31'\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
                         , Log | Compact | Pretty)
          ...
          , new FieldExpect<DateOnly>(DateOnly.MinValue, "\"{0,30:o}\"", true
            ...
            {
                { new EK(IsContentType | AcceptsSpanFormattable, Log | Compact | Pretty), "\"                    0001-01-01\"" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut), "\"                    0001-01-01\"" }
               ,
                {
                    new EK(IsContentType | AcceptsSpanFormattable)
                  , """
          ...
          , new FieldExpect<DateOnly>(new DateOnly(1980, 7, 31), "'{0:yyyy\\\\MM\\\\dd}'")
            {
                { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Log | Compact | Pretty), "'1980\\07\\31'" }
               ,
                {
                    new EK(IsContentType | AcceptsSpanFormattable, Log | Compact | Pretty)
                  , """
          ...
          , new FieldExpect<DateOnly>(new DateOnly(2009, 11, 12), "\"{0,-30:o}\"")
            {
                { new EK(IsContentType | AcceptsSpanFormattable, Log | Compact | Pretty), "\"2009-11-12                    \"" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut), "\"2009-11-12                    \"" }
               ,
                {
                    new EK(IsContentType | AcceptsSpanFormattable)
                  , """
          ...
          , new FieldExpect<DateOnly?>(null, "yyyy-MM-dd", true)
            {
              ...
              , { new EK(IsContentType | CallsViaMatch), "\"0001-01-01\"" }
               ,
                {
                    new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut | DefaultBecomesZero 
          ...
          , new FieldExpect<DateOnly?>(new DateOnly(1980, 7, 31), "'{0:yyyy\\\\MM\\\\dd}'")
            {
                { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Log | Compact | Pretty), "'1980\\07\\31'" }
              , { new EK(IsContentType | AcceptsSpanFormattable, Log | Compact | Pretty), "\"'1980\\07\\31'\"" }
               ,
                {
                    new EK(IsContentType | AcceptsSpanFormattable)
                  , """
          ...
          , new FieldExpect<TimeOnly>(new TimeOnly(1, 1, 1, 111, 111), "o")
            {
                { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Log | Compact | Pretty), "01:01:01.1111110" }
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"01:01:01.1111110\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
                         , Log | Compact | Pretty)
          ...
          , new FieldExpect<TimeOnly>(new TimeOnly(22, 22, 22, 222, 222), "O", true
            ...
            {
                { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Log | Compact | Pretty), "22:22:22.2222220" }
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"22:22:22.2222220\"" }
          ...
          , new FieldExpect<TimeOnly>(TimeOnly.MaxValue, "'{0:o}'")
            {
                { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Log | Compact | Pretty), "'23:59:59.9999999'" }
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"'23:59:59.9999999'\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
                         , Log | Compact | Pretty)
          ...
          , new FieldExpect<TimeOnly>(TimeOnly.MinValue, "\"{0,30:r}\"", true
            ...
            {
                { new EK(IsContentType | AcceptsSpanFormattable, Log | Compact | Pretty), "\"                      00:00:00\"" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut), "\"                      00:00:00\"" }
               ,
                {
                    new EK(IsContentType | AcceptsSpanFormattable), """
                                                                 "\u0022                      00:00:00\u0022"
          ...
          , new FieldExpect<TimeOnly>(new TimeOnly(3, 33, 33, 333, 333),
                                      "'{0:hh\\-mm\\-ss\\.fff}'")
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"'03-33-33.333'\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
                         , Log | Compact | Pretty)
          ...
          , new FieldExpect<TimeOnly>(new TimeOnly(4, 44, 44, 444, 444), "\"{0,-30:O}\"")
            {
                { new EK(IsContentType | AcceptsSpanFormattable, Log | Compact | Pretty), "\"04:44:44.4444440              \"" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut), "\"04:44:44.4444440              \"" }
               ,
                {
                    new EK(IsContentType | AcceptsSpanFormattable), """
                                                                 "\u002204:44:44.4444440              \u0022"
          ...
          , new FieldExpect<TimeOnly?>(null, "HH:mm:ss.FFFFFFF", true)
            {
              ...
              , { new EK(IsContentType | CallsViaMatch), "\"00:00:00\"" }
              , {
          ...
          , new FieldExpect<Rune>(Rune.GetRuneAt("𝄞", 0))
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsStringOut, AnyLog), "\"𝄞\"" }
              , { new EK(IsContentType | AcceptsSpanFormattable) 
                  , """
                    "\ud834\udd1e"
                    """
          ...
          , new FieldExpect<Rune>(Rune.GetRuneAt("𝅘𝅥𝅮", 0), "\"{0,-20}\"")
            {
               ...
               ,
                {
                    new EK(IsContentType | AcceptsSpanFormattable, AnyJson)
                  , """
                    "\u0022\ud834\udd60                  \u0022"
                    """
                }
          ...
          , new FieldExpect<Guid>(Guid.Empty)
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsStringOut), "\"00000000-0000-0000-0000-000000000000\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonNullWrites, Log | Compact | Pretty)
                  , "00000000-0000-0000-0000-000000000000"
          ...
          , new FieldExpect<Guid>(Guid.ParseExact("BEEFCA4E-BEEF-CA4E-BEEF-C0FFEEBABE51", "D"))
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsStringOut), "\"beefca4e-beef-ca4e-beef-c0ffeebabe51\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
          ...
          , new FieldExpect<Guid>(Guid.ParseExact("C0FFEEFE-BEEF-CA4E-BEEF-C0FFEEBABE51", "D")
                                , "'{0}'")
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"'c0ffeefe-beef-ca4e-beef-c0ffeebabe51'\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
                         , Log | Compact | Pretty)
          ...
          , new FieldExpect<Guid>(Guid.ParseExact("BEEEEEEF-BEEF-BEEF-BEEF-CAAAAAAAAA4E", "D"), "\"{0,40}\"")
            {
                { new EK(IsContentType | AcceptsSpanFormattable, Log | Compact | Pretty), "\"    beeeeeef-beef-beef-beef-caaaaaaaaa4e\"" }
               ,
                {
                    new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Json | Compact | Pretty)
          ...
          , new FieldExpect<Guid?>(null, "", true)
            {
              ...
              , { new EK(IsContentType | CallsViaMatch), "\"00000000-0000-0000-0000-000000000000\"" }
              , {
                    new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut 
                         | DefaultBecomesFallbackValue | DefaultBecomesNull, Log | Compact | Pretty)
                  , "00000000-0000-0000-0000-000000000000"
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultBecomesNull), "null" }
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"00000000-0000-0000-0000-000000000000\"" }
          ...
          , new FieldExpect<Guid?>(Guid.ParseExact("BEEFCA4E-BEEF-CA4E-BEEF-C0FFEEBABE51", "D"))
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"beefca4e-beef-ca4e-beef-c0ffeebabe51\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
                         , Log | Compact | Pretty)
          ...
          , new FieldExpect<Guid?>(Guid.ParseExact("C0FFEEFE-BEEF-CA4E-BEEF-C0FFEEBABE51", "D"), "'{0}'")
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsStringOut), "\"'c0ffeefe-beef-ca4e-beef-c0ffeebabe51'\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
                         , Log | Compact | Pretty)
          ...
          , new FieldExpect<IPNetwork>(new IPNetwork())
            {
                { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Log | Compact | Pretty), "0.0.0.0/0" }
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"0.0.0.0/0\"" }
          ...
          , new FieldExpect<IPNetwork>(new IPNetwork(IPAddress.Loopback, 32))
            {
                { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut, Log | Compact | Pretty), "127.0.0.1/32" }
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"127.0.0.1/32\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
                         , Log | Compact | Pretty)
          ...
          , new FieldExpect<IPNetwork>(IPNetwork.Parse("255.255.255.254/31"), "'{0}'")
            {
              ...
              , { new EK(IsContentType | AcceptsSpanFormattable), "\"'255.255.255.254/31'\"" }
               ,
                {
                    new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
                         , Log | Compact | Pretty)
          ...
          , new FieldExpect<IPNetwork>(IPNetwork.Parse("255.255.0.0/16"), "\"{0,17}\"")
            {
                { new EK(IsContentType | AcceptsSpanFormattable, Log | Compact | Pretty), "\"   255.255.0.0/16\"" }
              , { new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut), "\"   255.255.0.0/16\"" }
               ,
                {
                    new EK(IsContentType | AcceptsSpanFormattable)
                  , """
          ...
          , new FieldExpect<IPNetwork?>(null, "", true)
            {
              ...
              , { new EK(IsContentType | CallsViaMatch), "\"0.0.0.0/0\"" }
             ,  {
                    new EK(IsContentType | AcceptsSpanFormattable | DefaultTreatedAsValueOut 
                        |  DefaultBecomesFallbackString | DefaultBecomesFallbackValue, Log | Compact | Pretty)
                  , "0.0.0.0/0"
