...
public static class CloakedBearerTestData
{
    ...
    public static PositionUpdatingList<ISingleFieldExpectation> AllCloakedBearerExpectations => allCloakedBearerExpectations ??=
      ...
      , new CloakedBearerExpect<byte?, FieldNullableSpanFormattableAlwaysAddStructStringBearer<byte>>
            ...
            { { new EK(AcceptsSpanFormattable | AlwaysWrites | NonNullWrites), "0" } }
      , new CloakedBearerExpect<byte?, FieldNullableSpanFormattableAlwaysAddStringBearer<byte>>
            (null, "null",  true) // thus default string is ""
            {
                { new EK(IsContentType| AcceptsSpanFormattable | DefaultTreatedAsValueOut | DefaultBecomesEmpty), "" }
              , { new EK(IsContentType| AcceptsSpanFormattable | DefaultTreatedAsValueOut | DefaultBecomesFallbackValue | DefaultBecomesZero ), "0" }
              , { new EK(IsContentType| AcceptsSpanFormattable | DefaultTreatedAsStringOut | DefaultBecomesEmpty), "\"\"" }
              , { new EK(IsContentType| AcceptsSpanFormattable | DefaultTreatedAsStringOut | DefaultBecomesFallbackValue | DefaultBecomesZero ), "\"0\"" }
      ...
      , new CloakedBearerExpect<byte?, FieldSpanFormattableAlwaysAddStringBearer<byte>>
            ...
            {
                { new EK(IsContentType| AcceptsSpanFormattable | DefaultTreatedAsValueOut | DefaultBecomesEmpty), "" }
              , { new EK(IsContentType| AcceptsSpanFormattable | DefaultTreatedAsValueOut | DefaultBecomesFallbackValue | DefaultBecomesZero)
                  , "0" }
              , { new EK(IsContentType| AcceptsSpanFormattable | DefaultTreatedAsStringOut | DefaultBecomesEmpty), "\"\"" }
              , { new EK(IsContentType| AcceptsSpanFormattable | DefaultTreatedAsStringOut | DefaultBecomesFallbackValue | DefaultBecomesZero) 
                  , "\"0\"" }
              , { new EK(IsContentType| AcceptsSpanFormattable | DefaultBecomesNull), "null" }
              , { new EK(AcceptsSpanFormattable | AlwaysWrites | NonDefaultWrites), "null" }
            }
      ...
      , new CloakedBearerExpect<DateTime?, FieldNullableSpanFormattableAlwaysAddStringBearer<DateTime>>
            (null, "yyyy-MM-ddTHH:mm:ss", true) // thus default string is "1/1/0001 12:00:00 AM"
            {
              ...
              , { new EK(IsContentType| AcceptsAnyNullableStruct | DefaultTreatedAsStringOut | DefaultBecomesFallbackValue )
                  , "\"1/1/0001 12:00:00 AM\"" }
              , { new EK(IsContentType| AcceptsAnyNullableStruct | DefaultBecomesNull), "null" }
      ...
      , new CloakedBearerExpect<TimeSpan?, FieldNullableSpanFormattableAlwaysAddStringBearer<TimeSpan>>
            (null, "") // thus default string is "00:00:00"
            {
                { new EK(IsContentType| AcceptsAnyNullableStruct | DefaultTreatedAsValueOut | DefaultBecomesEmpty), "" }
              , { new EK(IsContentType| AcceptsAnyNullableStruct | DefaultTreatedAsValueOut | DefaultBecomesZero), "0" }
      ...
      , new CloakedBearerExpect<TimeSpan?, FieldNullableSpanFormattableAlwaysAddStringBearer<TimeSpan>>
            ...
            {
                {
                    new EK(AcceptsAnyNullableStruct | AlwaysWrites | NonDefaultWrites | NonNullWrites | NonNullAndPopulatedWrites
                         , Log | Compact | Pretty)
                  , "1.01:01:01.1111110"
                }
               ,
      ...
      , new CloakedBearerExpect<IPAddress, FieldSpanFormattableAlwaysAddStructStringBearer<IPAddress>>(null, "")
        {
         ...
         ,  { new EK(IsContentType | AcceptsAnyExceptNullableStruct | DefaultBecomesFallbackValue  | DefaultBecomesFallbackString
          ...
          , { new EK(AcceptsAnyExceptNullableStruct | AlwaysWrites), "null" }
        }
