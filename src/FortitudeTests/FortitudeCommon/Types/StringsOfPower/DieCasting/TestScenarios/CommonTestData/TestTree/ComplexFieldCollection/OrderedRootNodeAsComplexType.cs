...
public class OrderedRootNodeAsField : OrderedParentNodeAsField<IChildNode?>
{
    ...
    public OrderedRootNodeAsField()
    {
        NodeType           = NodeType.RootNode;
        RootInstanceId = Interlocked.Increment(ref RootNodeInstanceId);
    }

    public OrderedRootNodeAsField(List<IChildNode?> childNodes) : this()
    {
        ChildNodes         = childNodes;
        RootInstanceId = Interlocked.Increment(ref RootNodeInstanceId);
    }

    public OrderedRootNodeAsField(List<IChildNode?> childNodes, string name, int? instId = null) : base(childNodes, name, instId)
    {
        NodeType           = NodeType.RootNode;
        RootInstanceId = Interlocked.Increment(ref RootNodeInstanceId);
    }
