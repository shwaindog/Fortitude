...
public class JsonScenarios
{
    ...
    [TestMethod]
    public void JsonStringPropertyClassUnicodeDefaultEscapingTextJsonCompactSerializeMatchesTheOneString()
    {
        var singlePropertyFieldClass = new StandardSinglePropertyFieldClass();
    ...
    [TestMethod]
    public void JsonStringPropertyClassMinimalEscapingTheOneStringCompactJsonSerializeMatchesTextJson()
    {
        var singlePropertyFieldClass = new StandardSinglePropertyFieldClass();
