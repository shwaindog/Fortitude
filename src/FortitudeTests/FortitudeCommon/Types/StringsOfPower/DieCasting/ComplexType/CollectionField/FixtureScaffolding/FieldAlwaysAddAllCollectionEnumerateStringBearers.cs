...
public class FieldBoolEnumerableAlwaysAddAllStringBearer : FormattedCollectionFieldMoldScaffold<bool, IEnumerable<bool>>
{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllEnumerateBool
...

{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllEnumerateNullableBool
    ...
    where TFmt : ISpanFormattable?
{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllEnumerate<IEnumerable<TFmt>?, TFmt>
    ...
    where TFmtStruct : struct, ISpanFormattable
{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllEnumerateNullable<IEnumerable<TFmtStruct?>?, TFmtStruct>
    ...
    where TRevealBase : notnull
{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysRevealAllEnumerate<IEnumerable<TCloaked>?, TCloaked, TRevealBase>
    ...
    where TCloakedStruct : struct
{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysRevealAllEnumerateNullable
    ...
    where TBearer : IStringBearer?
{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysRevealAllEnumerate<IEnumerable<TBearer>?, TBearer>
    ...
    where TBearerStruct : struct, IStringBearer
{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysRevealAllEnumerateNullable<IEnumerable<TBearerStruct?>?, TBearerStruct>
...

{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllStringEnumerateString
    ...
    where TCharSeq : ICharSequence?
{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllEnumerateCharSeq<IEnumerable<TCharSeq>?, TCharSeq>
...

{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllEnumerateStringBuilder
...

{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllEnumerateMatch<IEnumerable<TAny>?, TAny>
...

{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllEnumerateObject
...
public class FieldBoolEnumeratorAlwaysAddAllStringBearer : FormattedEnumeratorFieldMoldScaffold<bool, IEnumerator<bool>>
{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllIterateBool
...

{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllIterateNullableBool
    ...
    where TFmt : ISpanFormattable?
{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllIterate<IEnumerator<TFmt>?, TFmt>
    ...
    where TFmtStruct : struct, ISpanFormattable
{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllIterateNullable<IEnumerator<TFmtStruct?>?, TFmtStruct>
    ...
    where TRevealBase : notnull
{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysRevealAllIterate<IEnumerator<TCloaked>?, TCloaked, TRevealBase>
    ...
    where TCloakedStruct : struct
{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysRevealAllIterateNullable
    ...
    where TBearer : IStringBearer?
{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysRevealAllIterate<IEnumerator<TBearer>?, TBearer>
    ...
    where TBearerStruct : struct, IStringBearer
{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysRevealAllIterateNullable<IEnumerator<TBearerStruct?>?, TBearerStruct>
...

{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllIterateString
    ...
    where TCharSeq : ICharSequence?
{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllIterateCharSeq<IEnumerator<TCharSeq>?, TCharSeq>
...

{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllIterateStringBuilder
...

{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllIterateMatch<IEnumerator<TAny>?, TAny>
...

{
    ...
    public override AppendSummary RevealState(ITheOneString tos) =>
        tos.StartComplexType(this)
           .CollectionField.AlwaysAddAllIterateObject
