...
public class SchoolForUnrelatedStudies
{
    public static StringBuildingStyle DefaultStyle = StringBuildingStyle.Json;
    ...
    public SchoolForUnrelatedStudies()
    {
        Populate();
    }
...
public class Person : IStyledToStringObject
{
...
public abstract class Faculty : IStyledToStringObject
{
    protected Faculty()
    {
    ...
    public abstract StyledTypeBuildResult ToString(IStyledTypeStringAppender stsa);
}
...
public struct SubRestrictions()
{
    ...
    public static CustomTypeStyler<SubRestrictions> Styler { get; } =
        (subRest, stsa) =>
