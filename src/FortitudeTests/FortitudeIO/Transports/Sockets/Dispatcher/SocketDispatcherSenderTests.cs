...
namespace FortitudeTests.FortitudeIO.Transports.Sockets.Dispatcher
{
    ...
    public class SocketDispatcherSenderTests
    {
        ...
        private SocketDispatcherSender socketDispatcherSender;
        private ThreadStart rootMethod;
        private Mock<ISyncLock> moqSyncLock;
        private Mock<IDictionary<long, ISocketSessionConnection>> moqToWrite;
        private bool inSyncLock;
        private Mock<IIntraOSThreadSignal> moqInterOSThreadSignal;
        private IDictionary<long, ISocketSessionConnection> originalToWrite;
        ...
        public void ToWriteHasSocketSessionConnection_Send_CallsSendDataAndClearsWriting()
        {
            ...
            Assert.IsTrue(writingEndOfSend.IsNullOrEmpty());
        }
