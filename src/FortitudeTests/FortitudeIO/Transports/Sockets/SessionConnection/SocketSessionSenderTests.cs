...
namespace FortitudeTests.FortitudeIO.Transports.Sockets.SessionConnection
{
    ...
    public class SocketSessionSenderTests
    {
        ...
        private Mock<IBinarySerializer> moqBinMock;
        private Func<IntPtr, byte[], int, SocketFlags, int> sendCallBack;
        private DirectOSNetworkingStub directOSNetworkingStub;
        private SocketSessionSender socketSessionSender;
        ...
        public void NewSessionSender_Enqueue_QueuesItemForSendDuringSyncLock()
        {
            ...
            moqSyncLock.Setup(sl => sl.Acquire()).Callback(() =>
            {
                sendLockCalled++;
            }).Verifiable();
