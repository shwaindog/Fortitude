...
namespace FortitudeTests.FortitudeIO.Transports.Sockets.Publishing
{
    ...
    {
        private DummyTcpSocketPublisher dummyTcpSocketPublisher;
        ...
        private Mock<ISyncLock> moqClientsLock;
        private Mock<ISyncLock> moqConnLock;
        ...
        private Mock<ISocketSubscriber> moqSocketSubscriber;
        private int port;
        ...
        public void ConnectedRegisteredMessage_Send_EnquesMessageWithSerializer()
        {
            ...
            dummyTcpSocketPublisher.RegisterSerializer<IPQLevel0Quote>(toBeSentToCx.MessageId);
        ...
        public void TwoConnectedClientsServer_Broadcast_SyncTwoEnqueingForBroadcast()
        {
            ...
            moqBinSerialFac.Setup(d => d.GetSerializer<IPQLevel0Quote>(message.MessageId)).Returns(moqBinSerializer.Object);
            dummyTcpSocketPublisher.RegisterSerializer<IPQLevel0Quote>(message.MessageId);
