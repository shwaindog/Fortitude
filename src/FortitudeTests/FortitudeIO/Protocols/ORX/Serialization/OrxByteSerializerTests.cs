...
namespace FortitudeTests.FortitudeIO.Protocols.ORX.Serialization
{
    ...
    public class OrxByteSerializerTests
    {
        ...
        public void LongsType_Serializes_DeserializesIsSame()
        {
            ...
            {
                FirstLong = long.MaxValue,
                SecondLong = long.MinValue,
                ThirdLong = long.MaxValue/2,
        ...
        {
            [OrxMandatoryField(0)]
            public string[] FirstStringArray { get; set; } 
            [OrxOptionalField(1)]
            public string[] SecondStringArray { get; set; } 
        }
        ...
        public class Longs
        {
            ...
            [OrxOptionalField(2)]
            public long FourthLong { get; set; } 
        }
        ...
        {
            [OrxMandatoryField(0)]
            public MutableString FirstString { get; set; } 
            [OrxMandatoryField(1)]
            public MutableString SecondString { get; set; } 
            [OrxOptionalField(1)]
            public MutableString ThirdString { get; set; } 
            [OrxOptionalField(2)]
            public MutableString FourthString { get; set; } 
        }
    }
}