...
public class PQServerHeartBeatSenderTests
{
    ...
    private Mock<IDoublyLinkedList<IPQPublishableTickInstant>> moqQuotesList = null!;
    ...
    public void SetUp()
    {
        ...
        moqQuotesList   = new Mock<IDoublyLinkedList<IPQPublishableTickInstant>>();
    ...
    public void StartedHeartBeatSender_CheckPublishHeartBeats_PublishesHeartBeatToTwoQuotesOverTolerance()
    {
        ...
        try
        {
            ...
            var realQuoteList = new DoublyLinkedList<IPQPublishableTickInstant>();
    ...
    public void StartedHeartBeatSenderDisconnectedUpdateServer_CheckPublishHeartBeats_PublishesNothing()
    {
        ...
        try
        {
            ...
            var realTickInstantList = new DoublyLinkedList<IPQPublishableTickInstant>();
    ...
    public void StartedHeartBeatSender_CheckPublishHeartBeats_ProtectsUpdatesToQuotesList()
    {
        ...
        try
        {
            ...
            var moqTickInstantQuote = new Mock<IPQPublishableTickInstant>();
    ...
    public void StartedHeartBeatSender_CheckPublishHeartBeats_RecoversAfterExceptionToPublish()
    {
        ...
        try
        {
            ...
            var moqTickInstant = new Mock<IPQPublishableTickInstant>();
