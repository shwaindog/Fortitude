...
public class PQHeartbeatSerializerTests
{
    ...
    public void SetUp()
    {
        ...
        firstBatchOfQuotes
            = new PQHeartBeatQuotesMessage([firstQuote, secondQuote, thirdQuote]);
        secondBatchOfQuotes = new PQHeartBeatQuotesMessage([thirdQuote, fourthQuote]);
    ...
    public unsafe void TwoQuotesBatchToHeartBeat_Serialize_SetTheExpectedBytesToBuffer()
    {
        ...
        foreach (var firstBatchOfQuote in firstBatchOfQuotes)
        {
            ...
            Assert.AreEqual(sourceTickerId, firstBatchOfQuote.StreamId);
