...
public class PQMarketAggregateTests
{
    ...
    public void PopulatedMaWithAllUpdates_GetDeltaUpdateFieldsAsUpdate_ReturnsAllOiFields()
    {
        ...
        AssertContainsAllOpenInterestFields(pqFieldUpdates, PQQuoteFields.ParentContextRemapped, populatedMarketAggregate);
    }
    ...
    (
        ...
        PQQuoteFields expectedFinalField = PQQuoteFields.OpenInterestTotal,
    ...
    )
    {
        ...
        if (l2QNotNull)
        {
            ...
            var foundAgg =
                (expectedFinalField switch
                 {
                     PQQuoteFields.OpenInterestTotal => newEmpty.OrderBook.OpenInterest
        ...
        if (bkNotNull)
        {
            ...
            var foundAgg =
                (expectedFinalField switch
                 {
                     PQQuoteFields.OpenInterestTotal => newEmpty.OpenInterest
                   , PQQuoteFields.OpenInterestSided => orderBookSide?.BookSide == BookSide.AskBook
