...
public class PQLastTraderPaidGivenTradeTests
{
    ...
    public void EmptyLt_TraderNameChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
    {
        ...
        var expectedFieldUpdate = new PQFieldUpdate(PQQuoteFields.LastTradedTickTrades, PQTradingSubFieldKeys.LastTradedTraderNameId, emptyLt.TraderId);
        ...
        expectedFieldUpdate = new PQFieldUpdate(PQQuoteFields.LastTradedTickTrades, PQTradingSubFieldKeys.LastTradedTraderNameId, emptyLt.TraderId);
        Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
        ...
        sourceUpdates = (from update in emptyLt.GetDeltaUpdateFields(testDateTime, StorageFlags.Snapshot)
            where update.TradingSubId == PQTradingSubFieldKeys.LastTradedTraderNameId
        ...
        IPQLastTraderPaidGivenTrade lt)
    {
        ...
        Assert.AreEqual(new PQFieldUpdate(PQQuoteFields.LastTradedTickTrades, PQTradingSubFieldKeys.LastTradedTraderNameId, lt.TraderId),
                        PQTickInstantTests.ExtractFieldUpdateWithId
                            (checkFieldUpdates, PQQuoteFields.LastTradedTickTrades, PQTradingSubFieldKeys.LastTradedTraderNameId), $"For asklayer {lt.GetType().Name}");
    }
