...
namespace FortitudeTests.FortitudeMarkets.Pricing.PQ.Messages.FeedEvents.DictionaryCompression;
...
public class PQNameIdLookupGeneratorTests
{
    ...
    public void NoNewlyPopulatedLookups_AddNewEntry_MarksNewEntryForStringUpdate()
    {
        ...
        {
            Field = new PQFieldUpdate(PQFeedFields.QuoteLayerSourceId, CrudCommand.Upsert.ToPQSubFieldId(), 0u), StringUpdate = new PQStringUpdate
            {
    ...
    public void PerDictionaryIdSubDictId_GetStringUpdates_PlacesDictionaryAndSubDictIdsInCorrectUpdateField()
    {
        var expectedStringUpdates = new PQFieldStringUpdate
        {
            Field = new PQFieldUpdate(PQFeedFields.SourceTickerId, CrudCommand.Upsert.ToPQSubFieldId(), 0u), StringUpdate = new PQStringUpdate
            {
    ...
    public void NoNewlyPopulatedLookups_GetStringUpdatesAsFullSnapshot_ReturnsAllEntries()
    {
        ...
        var newEmptyFirstDictSubKey1 = new PQNameIdLookupGenerator(PQFeedFields.QuoteLayerSourceId);
    ...
    public void NonUpdateInsertAttempt_UpdateFieldString_IgnoresRequest()
    {
        ...
        {
            Field = new PQFieldUpdate(PQFeedFields.SourceTickerId, (ushort)CrudCommand.Upsert, 0u), StringUpdate = new PQStringUpdate
            {
    ...
    {
        var empty = new PQNameIdLookupGenerator(PQFeedFields.QuoteLayerSourceId);
    ...
    public void UpdatedDicttionary_CopyFromOnlyUpdated_OnlyChangesCopiedAcross()
    {
        firstGeneratorSubKey1.HasUpdates = false;
        Assert.IsFalse(firstGeneratorSubKey1.GetStringUpdates(snapshotTime, PQMessageFlags.Update).Any());
        var empty = new PQNameIdLookupGenerator(PQFeedFields.SourceTickerId);
        ...
        empty = new PQNameIdLookupGenerator(PQFeedFields.SourceTickerId);
    ...
    public void UpdatedPQLookupGenerator_CopyFrom_CopyKeepsUpdatedTracking()
    {
        ...
        empty = new PQNameIdLookupGenerator(PQFeedFields.QuoteLayerSourceId);
        empty.CopyFrom((INameIdLookup)firstGeneratorSubKey1, CopyMergeFlags.FullReplace);
    ...
    public void DifferingPqDictsNumAndSubNumber_AreEquivalent_ReturnsExpected()
    {
        ...
        var subFirstSubKey1 = new PQNameIdLookupGenerator(PQFeedFields.SourceTickerId);
        ...
        var subFirstSubKey2 = new PQNameIdLookupGenerator(PQFeedFields.SourceTickerId);
    ...
    public void FullyPopulatedPQNameLookupGenerator_ToString_ReturnsNameAndValues()
    {
        ...
        Assert.IsTrue(toString.Contains($"dictionaryFieldKey: {PQFeedFields.QuoteLayerSourceId.ToString()}"));
    }
