...
public class PQLastTraderPaidGivenTradeTests
{
    ...
    public void EmptyLt_TraderNameChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
    {
        ...
        var expectedFieldUpdate = new PQFieldUpdate(PQFeedFields.LastTradedTickTrades, PQTradingSubFieldKeys.LastTradedTraderNameId, emptyLt.TraderId);
        ...
        expectedFieldUpdate = new PQFieldUpdate(PQFeedFields.LastTradedTickTrades, PQTradingSubFieldKeys.LastTradedTraderNameId, emptyLt.TraderId);
        Assert.AreEqual(expectedFieldUpdate, sourceUpdates[0]);
        ...
        IPQLastTraderPaidGivenTrade lt)
    {
        ...
        Assert.AreEqual(new PQFieldUpdate(PQFeedFields.LastTradedTickTrades, PQTradingSubFieldKeys.LastTradedTraderNameId, lt.TraderId),
                        PQTickInstantTests.ExtractFieldUpdateWithId
                            (checkFieldUpdates, PQFeedFields.LastTradedTickTrades, PQTradingSubFieldKeys.LastTradedTraderNameId), $"For asklayer {lt.GetType().Name}");
    }
