...
using static FortitudeMarkets.Pricing.PQ.Messages.FeedEvents.DeltaUpdates.PQBooleanValues;
...
public class PQLevel1QuoteTests
{
    ...
    public void EmptyQuote_AdapterSentTimeChanged_ExpectedPropertiesUpdatedDeltaUpdatesAffected()
    {
        ...
        var adapterSentUpdates = emptyQuote.GetDeltaUpdateFields(expectedSetTime, StorageFlags.Update, emptyQuote.SourceTickerInfo).ToList();
        ...
        Assert.AreEqual(expectedSub2Min, adapterSentUpdates[0]);
    ...
    public void EmptyQuote_BidPriceTopChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
    {
        ...
        var checkDeltaUpdates = emptyQuote.GetDeltaUpdateFields(testDateTime, StorageFlags.Update).ToList();
    ...
    public void EmptyQuote_AskPriceTopChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
    {
        ...
        emptyQuote.IsAdapterSentTimeSub2MinUpdated = false;
        Assert.IsFalse(emptyQuote.HasUpdates);
        var checkNoUpdates = emptyQuote.GetDeltaUpdateFields(testDateTime, StorageFlags.Update).ToList();
    ...
    public void EmptyQuote_ExecutableChanged_ExpectedPropertyUpdatedDeltaUpdatesAffected()
    {
        ...
        expectedFieldUpdate = new PQFieldUpdate
            (PQFeedFields.QuoteBooleanFlags, (uint)(IsExecutableUpdatedFlag | IsExecutableSetFlag | PQBooleanValuesExtensions.AllUpdated));
