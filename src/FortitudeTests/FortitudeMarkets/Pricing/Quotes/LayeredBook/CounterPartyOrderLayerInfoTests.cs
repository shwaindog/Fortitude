...
public class CounterPartyOrderLayerInfoTests
{
    ...
    public void NewCpoli_SetsValues_PropertiesInitializedAsExpected()
    {
        ...
        Assert.IsNull(emptyCpoli.CounterPartyName);
        Assert.IsNull(emptyCpoli.TraderName);
    }
    ...
    public void NewCpoli_NewFromCloneInstance_PropertiesInitializedAsExpected()
    {
        ...
        Assert.AreEqual(CounterPartyName, fromPopulatedInstance.CounterPartyName);
        Assert.AreEqual(TraderName, fromPopulatedInstance.TraderName);
        ...
        Assert.IsNull(newEmptyCpoli.CounterPartyName);
        Assert.IsNull(newEmptyCpoli.TraderName);
        ...
        Assert.IsNull(newFromPqEmptyCpoli.CounterPartyName);
        Assert.IsNull(newFromPqEmptyCpoli.TraderName);
    }
    ...
    public void PopulatedCpoli_Reset_ReturnsReturnsLayerToEmpty()
    {
        ...
        Assert.IsNotNull(populatedCpoli.CounterPartyName);
        Assert.IsNotNull(populatedCpoli.TraderName);
        Assert.IsFalse(populatedCpoli.IsEmpty);
        ...
        ILevel2Quote? changingQuote = null)
    {
        ...
        changingTraderLayerInfo.CounterPartyName = "TestChangedCounterPartyName";
        ...
        changingTraderLayerInfo.CounterPartyName = original.CounterPartyName;
