...
public class PricePeriodSummaryExtensionsTests
{
    ...
    public void UnknownTimeFrameVariousStartEndTimes_TimeFrame_CalculatedCorrectly()
    {
        ...
        var calculatePeriodSummary = new PricePeriodSummary(TimeBoundaryPeriod.Tick, t, t.AddSeconds(1));
        Assert.AreEqual(TimeBoundaryPeriod.OneSecond, calculatePeriodSummary.CalcTimeFrame());
        calculatePeriodSummary = new PricePeriodSummary(TimeBoundaryPeriod.Tick, t, t.AddMinutes(1));
        Assert.AreEqual(TimeBoundaryPeriod.OneMinute, calculatePeriodSummary.CalcTimeFrame());
        calculatePeriodSummary = new PricePeriodSummary(TimeBoundaryPeriod.Tick, t, t.AddMinutes(5));
        Assert.AreEqual(TimeBoundaryPeriod.FiveMinutes, calculatePeriodSummary.CalcTimeFrame());
        calculatePeriodSummary = new PricePeriodSummary(TimeBoundaryPeriod.Tick, t, t.AddMinutes(10));
        Assert.AreEqual(TimeBoundaryPeriod.TenMinutes, calculatePeriodSummary.CalcTimeFrame());
        calculatePeriodSummary = new PricePeriodSummary(TimeBoundaryPeriod.Tick, t, t.AddMinutes(15));
        Assert.AreEqual(TimeBoundaryPeriod.FifteenMinutes, calculatePeriodSummary.CalcTimeFrame());
        calculatePeriodSummary = new PricePeriodSummary(TimeBoundaryPeriod.Tick, t, t.AddMinutes(30));
        Assert.AreEqual(TimeBoundaryPeriod.ThirtyMinutes, calculatePeriodSummary.CalcTimeFrame());
        calculatePeriodSummary = new PricePeriodSummary(TimeBoundaryPeriod.Tick, t, t.AddHours(1));
        Assert.AreEqual(TimeBoundaryPeriod.OneHour, calculatePeriodSummary.CalcTimeFrame());
        calculatePeriodSummary = new PricePeriodSummary(TimeBoundaryPeriod.Tick, t, t.AddHours(4));
        Assert.AreEqual(TimeBoundaryPeriod.FourHours, calculatePeriodSummary.CalcTimeFrame());
        calculatePeriodSummary = new PricePeriodSummary(TimeBoundaryPeriod.Tick, t, t.AddDays(1));
        Assert.AreEqual(TimeBoundaryPeriod.OneDay, calculatePeriodSummary.CalcTimeFrame());
        calculatePeriodSummary = new PricePeriodSummary(TimeBoundaryPeriod.Tick, t, t.AddDays(7));
        Assert.AreEqual(TimeBoundaryPeriod.OneWeek, calculatePeriodSummary.CalcTimeFrame());
        calculatePeriodSummary = new PricePeriodSummary(TimeBoundaryPeriod.Tick, t, t.AddDays(28));
        Assert.AreEqual(TimeBoundaryPeriod.OneMonth, calculatePeriodSummary.CalcTimeFrame());
        calculatePeriodSummary = new PricePeriodSummary(TimeBoundaryPeriod.Tick, t, t.AddDays(30));
        Assert.AreEqual(TimeBoundaryPeriod.OneMonth, calculatePeriodSummary.CalcTimeFrame());
        calculatePeriodSummary = new PricePeriodSummary(TimeBoundaryPeriod.Tick, t, t.AddSeconds(2));
        Assert.AreEqual(TimeBoundaryPeriod.Tick, calculatePeriodSummary.CalcTimeFrame());
