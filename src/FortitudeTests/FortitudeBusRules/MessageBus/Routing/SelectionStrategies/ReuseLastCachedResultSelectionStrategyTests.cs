...
public class ReuseLastCachedResultSelectionStrategyTests
{
    ...
    private Mock<IEventQueueGroupContainer> allQueues = null!;
    ...
    private Mock<IEventQueue> firstQueue = null!;
    ...
    private Mock<IEventQueue> secondQueue = null!;
    ...
    public void Setup()
    {
        ...
        firstQueue = new Mock<IEventQueue>();
        secondQueue = new Mock<IEventQueue>();
        allQueues = new Mock<IEventQueueGroupContainer>();
