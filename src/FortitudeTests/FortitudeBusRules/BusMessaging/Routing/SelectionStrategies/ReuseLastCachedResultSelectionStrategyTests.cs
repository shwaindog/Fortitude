...
public class ReuseLastCachedResultSelectionStrategyTests
{
    ...
    public void Setup()
    {
        ...
        initialRouteSelectionResult = new RouteSelectionResult
            (firstQueue.Object, InitialInsertStrategyName, RoutingFlags.None, resultRule);
        firstDispatchSelectionResultSet.Add(initialRouteSelectionResult);
        differentRouteSelectionResult = new RouteSelectionResult
            (secondQueue.Object, AnotherStrategyName, RoutingFlags.None, resultRule);
    ...
    public void DispatchDefaultPublishPreviouslyCachedResultIsReturnedUntilExpiredAfter100Requests()
    {
        ...
        deployDispatchDestinationCache
            .Save(sendingRule, dispatchOptions, DestinationAddress, firstDispatchSelectionResultSet);

        for (var i = 0; i < OneHundred; i++)
        {
            var selectionResultSet = reuseLastCachedResultSelectionStrategy
                .Select(allQueues.Object, sendingRule, dispatchOptions, DestinationAddress);
            selectionResultSet.AssertSingleResultIsExpected
                (eventGroupType, firstQueue.Object, routingFlags, StrategyName, resultRule);
        }

        var noSelectionResultSet = reuseLastCachedResultSelectionStrategy
            .Select(allQueues.Object, sendingRule, dispatchOptions, DestinationAddress);
    ...
    public void DispatchDefaultPublishPreviouslyCachedResultIsReturnedUntilExpiredAfter1Min()
    {
        ...
        {
            var selectionResultSet = reuseLastCachedResultSelectionStrategy.Select
                (allQueues.Object, sendingRule, dispatchOptions, DestinationAddress);
            selectionResultSet.AssertSingleResultIsExpected
                (eventGroupType, firstQueue.Object, routingFlags, StrategyName, resultRule);
        }
    ...
    public void DispatchPublishNoExpiryPreviouslyCachedResultIsReturnedUnlessRecalculateCacheIsSent()
    {
        ...
        var recalculateCacheFlags =
            RoutingFlags.RecalculateCache | RoutingFlags.SendToAll | RoutingFlags.DestinationCacheLast | RoutingFlags.UseLastCacheEntry;

        var noResultSet = reuseLastCachedResultSelectionStrategy
            .Select(allQueues.Object, sendingRule, new DispatchOptions(recalculateCacheFlags, eventGroupType), DestinationAddress);
    ...
    public void DispatchDefaultRequestResponseWithDifferingSendersRetainsCachedResultForEachSender()
    {
        ...
        differentRouteSelectionResult = new RouteSelectionResult
            (secondQueue.Object, AnotherStrategyName, routingFlags, differentDeployRule);
        differentDispatchSelectionResultSet.DispatchOptions = dispatchOptions;
        differentDispatchSelectionResultSet.Clear();
        differentDispatchSelectionResultSet.Add(differentRouteSelectionResult);
        deployDispatchDestinationCache
            .Save(differentSendingRule, dispatchOptions, DestinationAddress, differentDispatchSelectionResultSet);
        stubTime.UtcNow = oneMinOneSecondAfterCreateResultTime;
        selectionResultSet = reuseLastCachedResultSelectionStrategy
            .Select(allQueues.Object, differentSendingRule, dispatchOptions, DestinationAddress);
        selectionResultSet.AssertSingleResultIsExpected
            (Worker, secondQueue.Object, routingFlags, StrategyName, differentDeployRule);
    ...
    public void DispatchDefaultRequestResponseDiffDestinationAddressCachesResultForEachDestination()
    {
        ...
        differentDispatchSelectionResultSet.Clear();
        differentDispatchSelectionResultSet.Add(differentRouteSelectionResult);
        deployDispatchDestinationCache.Save
            (sendingRule, dispatchOptions, AnotherDestinationAddress, differentDispatchSelectionResultSet);
        stubTime.UtcNow = oneMinOneSecondAfterCreateResultTime;
        selectionResultSet = reuseLastCachedResultSelectionStrategy
            .Select(allQueues.Object, sendingRule, dispatchOptions, AnotherDestinationAddress);
        selectionResultSet.AssertSingleResultIsExpected
            (Worker, secondQueue.Object, routingFlags, StrategyName, differentDeployRule);
    ...
    public void DefaultDeployPreviouslyCachedResultIsReturnedIndefinitely()
    {
        ...
        {
            var selectionResultSet = reuseLastCachedResultSelectionStrategy
                .Select(allQueues.Object, sendingRule, deployRule, deploymentOptions);
            selectionResultSet.AssertIsExpected
                (eventGroupType, firstQueue.Object, routingFlags, StrategyName, deployRule);
        }
    }
    ...
    public void DefaultDeployWithDifferingQueuesGroupsRetainPreviousCacheStatus()
    {
        ...
        stubTime.UtcNow = oneMinOneSecondAfterCreateResultTime;
        selectionResultSet = reuseLastCachedResultSelectionStrategy
            .Select(allQueues.Object, sendingRule, differentDeployRule, justEventDeploymentOps);
        selectionResultSet.AssertIsExpected
            (Event, secondQueue.Object, routingFlags, StrategyName, differentDeployRule);
    ...
    public void DeployWithExpiryAfter100ReadsPreviouslyCachedResultIsReturnedUntilItExpires()
    {
        ...
        for (var i = 0; i < OneHundred; i++)
        {
            var routingSelectionResult = reuseLastCachedResultSelectionStrategy
                .Select(allQueues.Object, sendingRule, deployRule, deploymentOptions);
            routingSelectionResult.AssertIsExpected
                (eventGroupType, firstQueue.Object, routingFlags, StrategyName, deployRule);
        }

        var noSelectionResult = reuseLastCachedResultSelectionStrategy
            .Select(allQueues.Object, sendingRule, deployRule, deploymentOptions);
